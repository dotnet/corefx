...
namespace System.Net.Primitives.Functional.Tests
{
    public partial class CookieContainerTest
    {
        ...
        private static CookieContainer Count11Container()
        {
        ...
        public static void Capacity_ShrinkNoneExpired_RemovesAll()
        {
            ...
            Cookie c2 = new Cookie("name1", "value", "", ".url2.com");
            Cookie c3 = new Cookie("name1", "value", "", ".url3.com");
            Cookie c4 = new Cookie("name1", "value", "", ".url4.com");
        ...
        {
            CookieContainer cc = Count11Container();
        ...
        [Fact]
        public static void Add_ReachedMaxCountWithExpiredCookies_Added()
        {
            ...
            Thread.Sleep(2000); // Sleep for 2 seconds to wait for the cookie to expire
            cc.Add(c3);
        ...
        private static IEnumerable<object[]> GetCookieHeaderData()
        {
            ...
            yield return new object[] { u5, "name10=value; $Version=1; name11=value; $Path=/; $Port=\"80, 90, 100\"" };
        ...
        [Fact]
        public static void GetCookies_RemovesExpired_Cookies()
        {
            Cookie c1 = new Cookie("name1", "value", "", ".url1.com");
            ...
            Thread.Sleep(2000); // Let the thread sleep for 2 seconds, until the cookie is expired
