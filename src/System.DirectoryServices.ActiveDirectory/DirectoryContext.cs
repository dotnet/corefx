//------------------------------------------------------------------------------
// <copyright file="DirectoryContext.cs" company="Microsoft">
...
namespace System.DirectoryServices.ActiveDirectory {
    ...
    using System.IO;
       ...
       public class DirectoryContext {
		...
		private bool contextIsValid = false;
		...
		internal bool isCurrentForest() {
			...
			DomainControllerInfo domainControllerInfo = Locator.GetDomainControllerInfo(null, name, null, (long)(PrivateLocatorFlags.DirectoryServicesRequired |PrivateLocatorFlags.ReturnDNSName));
