...
namespace System.DirectoryServices.ActiveDirectory {
	...
	internal sealed class Utils
	{
	       private static int LOGON32_LOGON_NEW_CREDENTIALS = 9;
              ...
              private static int POLICY_VIEW_LOCAL_INFORMATION = 0x00000001;              
              private static uint STANDARD_RIGHTS_REQUIRED = 0x000F0000;
              private static uint SYNCHRONIZE = 0x00100000;
		...
		*/
		private static uint LANG_ENGLISH = 0x09;
		private static uint SUBLANG_ENGLISH_US = 0x01;
		private static uint SORT_DEFAULT = 0x0;
		private static uint LANGID = ((uint)((((ushort)(SUBLANG_ENGLISH_US)) << 10) | (ushort)(LANG_ENGLISH)));
		private static uint LCID = ((uint)((((uint)((ushort)(SORT_DEFAULT))) << 16) | ((uint)((ushort)(LANGID)))));
		...
		internal static string GetNtAuthorityString()
		{
			if (NTAuthorityString == null)
			{
				...
				NTAuthorityString = ntLocalSystem.Value.Substring(0, index);
			}
