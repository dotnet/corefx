//------------------------------------------------------------------------------
// <copyright file="ReplicationConnection.cs" company="Microsoft">
 ...
 */
 ...
 namespace System.DirectoryServices.ActiveDirectory {
    ...
    public class ReplicationConnection :IDisposable {
        ...
        string destinationServerName = null;
        ActiveDirectoryTransportType transport = ActiveDirectoryTransportType.Rpc;               
        

        const string ADAMGuid = "1.2.840.113556.1.4.1851";
            ...
            get {
                ...
                {  
                    ...
                    {  
                        ...
                        if(portnumber != 389)
                        {
                            sourceServerName = tmpServerName + ":" + portnumber;
                        }
                    }
                    else
                    {
                        sourceServerName = (string) PropertyManager.GetPropertyValue(context, de.Parent, PropertyManager.DnsHostName);
                    }
                }
            ...
            get {
                ...
                {               
                    ...
                    {                            
                        ...
                        if(portnumber != 389)
                        {
                            destinationServerName = hostName + ":" + portnumber;
                        }  
                        else
                            destinationServerName = hostName;
                    }
                    else
                            destinationServerName = hostName;
        ...
        public NotificationStatus ChangeNotificationStatus {
            get { 
                ...
                int overrideNotify = options & 0x4;
                int userNotify = options & 0x8;                    
