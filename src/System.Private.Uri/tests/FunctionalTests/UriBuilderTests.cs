...
namespace System.PrivateUri.Tests
{
    public class UriBuilderTests
    {
        ...
        {
            AssertExtensions.Throws<ArgumentException>("extraValue", () => new UriBuilder("scheme", "host", 80, "path", extraValue));
        }
        ...
        {
            AssertExtensions.Throws<ArgumentException>("value", () => new UriBuilder(schemeName, "host"));
            AssertExtensions.Throws<ArgumentException>("value", () => new UriBuilder(schemeName, "host", 80));
            AssertExtensions.Throws<ArgumentException>("value", () => new UriBuilder(schemeName, "host", 80, "path"));
            AssertExtensions.Throws<ArgumentException>("value", () => new UriBuilder(schemeName, "host", 80, "?query#fragment"));

            AssertExtensions.Throws<ArgumentException>("value", () => new UriBuilder().Scheme = schemeName);
        }
