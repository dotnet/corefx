...
{
    internal sealed class DocumentXPathNavigator : XPathNavigator
    {
        ...
        public override string LocalName
        {
            get
            {
                // Simulating behavior of virtual property: XmlNode.XPLocalName
                switch (_source.NodeType)
                {
                    case XmlNodeType.Attribute:
                        {
                            XmlAttribute srcAsXmlAttribute = _source as XmlAttribute;
                            if (srcAsXmlAttribute != null)
                            {
                                if (srcAsXmlAttribute.Prefix.Length == 0 && srcAsXmlAttribute.LocalName == XmlConst.NsXmlNs) return string.Empty;
                                return srcAsXmlAttribute.LocalName;
                            }
                            break;
                        }
                    case XmlNodeType.Element:
                        {
                            XmlElement srcAsXmlElement = _source as XmlElement;
                            if (srcAsXmlElement != null)
                            {
                                return srcAsXmlElement.LocalName;
                            }
                            break;
                        }
                    case XmlNodeType.ProcessingInstruction:
                        {
                            XmlProcessingInstruction srcAsXmlProcessingInstruction = _source as XmlProcessingInstruction;
                            if (srcAsXmlProcessingInstruction != null)
                            {
                                return srcAsXmlProcessingInstruction.Name;
                            }
                            break;
                        }
                }
                // If any other type inheriting from XmlNode
                return string.Empty;
            }
        }
                ...
                switch (_source.NodeType)
                {
                    ...
                    case XmlNodeType.Attribute:
                        if (((XmlAttribute)_source).IsNamespace())
                        {
                            ...
                            if (Ref.Equal(localName, XmlConst.NsXmlNs))
                            {
        ...
        public override string GetAttribute(string localName, string namespaceURI)
        {
            ...
            if (srcAsXmlElement != null)
            {
                if (namespaceURI == XmlConst.ReservedNsXmlNs)
                    return null;
                XmlAttribute attr = srcAsXmlElement.GetAttributeNode(localName, namespaceURI);
                if (attr != null)
                    return attr.Value;
            }
            return string.Empty;
        ...
        public override string GetNamespace(string name)
        {
            ...
            if (name == XmlConst.NsXml)
            {
                return XmlConst.ReservedNsXml;
            }
            else if (name == XmlConst.NsXmlNs)
            {
        ...
        private static bool MoveToFirstNamespaceGlobal(ref XmlAttributeCollection attributes, ref int index, XmlNode attributesParent)
        {
            if (MoveToFirstNamespaceLocal(attributes, ref index))
            {
                return true;
            ...
            Debug.Assert(attributes != null && attributesParent != null);
            XmlElement element = attributesParent.ParentNode as XmlElement;
            while (element != null)
            {
                if (element.HasAttributes)
                {
        ...
        private static bool MoveToNextNamespaceGlobal(ref XmlAttributeCollection attributes, ref int index, XmlNode attributesParent)
        {
            if (MoveToNextNamespaceLocal(attributes, ref index))
            {
                return true;
        ...
        public override bool MoveToChild(XPathNodeType type)
        {
            ...
            if (child != null)
            {
                ...
                do
                {
                    if (((1 << (int)child.GetXPNodeType()) & mask) != 0)
                    {
                        _source = child;
                        return true;
                    }
        ...
        public override bool MoveToFollowing(XPathNodeType type, XPathNavigator end)
        {
            ...
            while (((1 << (int)following.GetXPNodeType()) & mask) == 0);
        ...
        public override bool MoveToNext(XPathNodeType type)
        {
            ...
            do
            {
                if (((1 << (int)sibling.GetXPNodeType()) & mask) != 0)
                {
                    _source = sibling;
                    return true;
                }
        ...
        public override bool IsSamePosition(XPathNavigator other)
        {
            ...
            if (that != null)
            {
                ...
                return this._source == that._source
                       && this._namespaceParent == that._namespaceParent;
            }
            return false;
        }
        ...
        public override bool IsDescendant(XPathNavigator other)
        {
            ...
            if (that != null)
            {
                return IsDescendant(this._source, that._source);
            }
            return false;
        }
        ...
        private XmlNodeOrder Compare(XmlNode node1, XmlNode node2)
        {
            ...
            if (node1.GetXPNodeType() == XPathNodeType.Attribute)
            {
                if (node2.GetXPNodeType() == XPathNodeType.Attribute)
                {
        ...
        public override XmlNodeOrder ComparePosition(XPathNavigator other)
        {
            ...
            if (this._source == that._source
                && this._namespaceParent == that._namespaceParent)
            {
                return XmlNodeOrder.Same;
            }

            if (this._namespaceParent != null
                || that._namespaceParent != null)
            {
                return base.ComparePosition(other);
            }

            XmlNode node1 = this._source;
        ...
        internal XmlNode GetNode() { return _source; }
        ...
        public override XPathNodeIterator SelectDescendants(string localName, string namespaceURI, bool matchSelf)
        {
            ...
            if (nsAtom == null || this._source.NodeType == XmlNodeType.Attribute)
    ...
    internal sealed class DocumentXPathNodeIterator_Empty : XPathNodeIterator
    {
        ...
        internal DocumentXPathNodeIterator_Empty(DocumentXPathNavigator nav) { this._nav = nav.Clone(); }
        internal DocumentXPathNodeIterator_Empty(DocumentXPathNodeIterator_Empty other) { this._nav = other._nav.Clone(); }
