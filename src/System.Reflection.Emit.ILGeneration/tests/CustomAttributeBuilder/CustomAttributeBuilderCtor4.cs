...
namespace System.Reflection.Emit.Tests
{
    ...
    public class CustomAttributeBuilderCtor4
    {
        ...
        public void Ctor(Type[] ctorParams, object[] constructorArgs, string[] namedPropertyNames, object[] propertyValues, string[] namedFieldNames, object[] fieldValues, object[] expected)
        {
            ...
            FieldInfo[] namedFields = GetFields(namedFieldNames);
            ...
            FieldInfo[] fields = GetFields(IntField, StringField, GetStringField, GetIntField);
        ...
        public void NamedPropertyAndPropertyValuesDifferentLengths_ThrowsArgumentException(string[] propertyNames, object[] propertyValues, string paramName)
        {
            ...
            Assert.Throws<ArgumentException>(paramName, () => new CustomAttributeBuilder(constructor, new object[0], namedProperties, propertyValues, GetFields(), new object[0]));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>("con", () => new CustomAttributeBuilder(null, new object[0], GetProperties(), new object[0], GetFields(), new object[0]));
        }
        ...
        {
            ConstructorInfo constructor = typeof(CustomAttributeBuilderTest).GetConstructor(new Type[0]);
            Assert.Throws<ArgumentNullException>("constructorArgs", () => new CustomAttributeBuilder(constructor, null, GetProperties(), new object[0], GetFields(), new object[0]));
        }
        ...
        {
            ConstructorInfo constructor = typeof(CustomAttributeBuilderTest).GetConstructor(new Type[0]);
            Assert.Throws<ArgumentNullException>("namedProperties", () => new CustomAttributeBuilder(constructor, new object[0], (PropertyInfo[])null, new object[0], GetFields(), new object[0]));
        }
        ...
        {
            ConstructorInfo constructor = typeof(CustomAttributeBuilderTest).GetConstructor(new Type[0]);
            Assert.Throws<ArgumentNullException>("propertyValues", () => new CustomAttributeBuilder(constructor, new object[0], GetProperties(), null, GetFields(), new object[0]));
        }
        ...
        {
            ConstructorInfo constructor = typeof(CustomAttributeBuilderTest).GetConstructor(new Type[0]);
            Assert.Throws<ArgumentNullException>("propertyValues[0]", () => new CustomAttributeBuilder(constructor, new object[0], GetProperties(IntProperty, StringProperty), new object[] { null, 10 }, GetFields(), new object[0]));
        }
        ...
        {
            ConstructorInfo constructor = typeof(CustomAttributeBuilderTest).GetConstructor(new Type[0]);
            Assert.Throws<ArgumentNullException>("namedProperties[0]", () => new CustomAttributeBuilder(constructor, new object[0], GetProperties(null, IntProperty), new object[] { "TestString", 10 }, GetFields(), new object[0]));
        }
        ...
        {
            ConstructorInfo constructor = typeof(CustomAttributeBuilderTest).GetConstructor(new Type[0]);
            Assert.Throws<ArgumentNullException>("namedFields", () => new CustomAttributeBuilder(constructor, new object[0], GetProperties(), new object[0], (FieldInfo[])null, new object[0]));
        }
        ...
        {
            ConstructorInfo constructor = typeof(CustomAttributeBuilderTest).GetConstructor(new Type[0]);
            Assert.Throws<ArgumentNullException>("fieldValues", () => new CustomAttributeBuilder(constructor, new object[0], GetProperties(), new object[0], GetFields(), null));
        }
        ...
        {
            ConstructorInfo constructor = typeof(CustomAttributeBuilderTest).GetConstructor(new Type[0]);
            Assert.Throws<ArgumentNullException>("fieldValues[0]", () => new CustomAttributeBuilder(constructor, new object[0], GetProperties(), new object[0], GetFields(IntField, StringField), new object[] { null, 10 }));
        }
        ...
        {
            ConstructorInfo constructor = typeof(CustomAttributeBuilderTest).GetConstructor(new Type[0]);
            Assert.Throws<ArgumentNullException>("namedFields[0]", () => new CustomAttributeBuilder(constructor, new object[0], GetProperties(), new object[0], GetFields(null, IntField), new object[] { "TestString", 10 }));
        }
