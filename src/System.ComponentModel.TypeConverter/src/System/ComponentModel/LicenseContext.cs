...
{
    /// <summary> Specifies when the licensed object can be used. </summary>
    public class LicenseContext : IServiceProvider
    {
        /// <summary> When overridden in a derived class, gets a value that specifies when a license can be used. </summary>
        ...
        /// <summary> When overridden in a derived class, will return an object that implements the asked for service. </summary>
