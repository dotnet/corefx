...
{
    /// <summary> Converts the value of an object into a different data type. </summary>
    public class TypeConverter
    {
        ...
        /// <summary> Converts the given value to the converter's native type. </summary>
        ...
        /// <summary> Converts the given string to the converter's native type using the invariant culture. </summary>
        ...
        /// <summary> Converts the specified text into an object. </summary>
        ...
        /// <summary> Re-creates an <see cref='object'/> given a set of property values for the object. </summary>
        ...
        /// <summary> Gets a suitable exception to throw when a conversion cannot be performed. </summary>
        ...
        /// <summary> An <see langword='abstract '/> class that provides properties for objects that do not have properties. </summary>
        protected abstract class SimplePropertyDescriptor : PropertyDescriptor
        {
            /// <summary> Initializes a new instance of the <see cref='System.ComponentModel.TypeConverter.SimplePropertyDescriptor'/> class. </summary>
            ...
            /// <summary> Gets the type of the component this property description is bound to. </summary>
            ...
            /// <summary> Gets a value indicating whether resetting the component will change the value of the component. </summary>
            ...
            /// <summary> Gets a value indicating whether the value of this property needs to be persisted. </summary>
