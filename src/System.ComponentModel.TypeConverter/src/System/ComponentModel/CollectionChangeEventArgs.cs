...
{
    /// <summary> Provides data for the <see langword='CollectionChange '/> event. </summary>
    public class CollectionChangeEventArgs : EventArgs
    {
        /// <summary> Initializes a new instance of the <see cref='System.ComponentModel.CollectionChangeEventArgs'/> class. </summary>
