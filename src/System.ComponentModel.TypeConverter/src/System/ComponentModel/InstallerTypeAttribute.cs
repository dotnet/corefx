...
{
    /// <summary> Specifies the installer to use for a type to install components. </summary>
    [AttributeUsage(AttributeTargets.Class)]
    public class InstallerTypeAttribute : Attribute
    {
        private readonly string _typeName;

        /// <summary> Initializes a new instance of the System.Windows.Forms.ComponentModel.InstallerTypeAttribute class. </summary>
