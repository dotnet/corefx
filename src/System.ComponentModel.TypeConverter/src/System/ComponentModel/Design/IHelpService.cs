...
namespace System.ComponentModel.Design
{
    ...
    public interface IHelpService
    {
        ...
        /// <summary> Clears all existing context attributes from the document. </summary>
        void ClearContextAttributes();

        /// <summary> Creates a Local IHelpService to manage subcontexts. </summary>
        ...
        /// <summary> Removes a context that was created with CreateLocalContext </summary>
        ...
        /// <summary> Shows the help topic that corresponds with the specified Url and topic navigation ID. </summary>
