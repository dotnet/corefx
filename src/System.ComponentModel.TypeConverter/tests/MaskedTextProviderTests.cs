...
namespace System.ComponentModel.Tests
{
    public class MaskedTextProviderTests
    {
        ...
        public void Ctor_Mask_Culture()
        {
            ...
            Assert.Same(TestSimpleDigitMask, maskedTextProvider.Mask);
            Assert.Equal(1033, maskedTextProvider.Culture.LCID);
        }
        ...
        {
            var maskedTextProvider = new MaskedTextProvider(TestSimpleDigitMask, '&', false);
            Assert.Same(TestSimpleDigitMask, maskedTextProvider.Mask);
            Assert.Equal('&',maskedTextProvider.PasswordChar);
        ...
        {
            var maskedTextProvider = new MaskedTextProvider(TestSimpleDigitMask, new CultureInfo("en-US"), '&', false);
            Assert.Same(TestSimpleDigitMask, maskedTextProvider.Mask);
            Assert.Equal(1033, maskedTextProvider.Culture.LCID);
            Assert.Equal('&',maskedTextProvider.PasswordChar);
            Assert.False(maskedTextProvider.AllowPromptAsInput);
        ...
        {
            var maskedTextProvider = new MaskedTextProvider(TestSimpleDigitMask,
                new CultureInfo("en-US"), false,'-','&', false);

            Assert.Same(TestSimpleDigitMask, maskedTextProvider.Mask);
            Assert.Equal(1033, maskedTextProvider.Culture.LCID);
            Assert.False(maskedTextProvider.AllowPromptAsInput);
            Assert.Equal('-', maskedTextProvider.PromptChar);
            Assert.Equal('&',maskedTextProvider.PasswordChar);
            Assert.False(maskedTextProvider.AllowPromptAsInput);
        }
        ...
        {
            var maskedTextProvider = new MaskedTextProvider(TestSimpleDigitMask);
            maskedTextProvider.Clear(out var resultHint);
        ...
        public void InsertAt_Input_Position_TestPosition_ResultHint()
        {
            ...
            Assert.True(maskedTextProvider.InsertAt(string.Empty, 0, out var testPosition,
                out var resultHint));
            Assert.Equal(MaskedTextResultHint.NoEffect, resultHint);

            Assert.True(maskedTextProvider.InsertAt('1', 0, out testPosition,
                out resultHint));

            Assert.Equal(0, testPosition);
            Assert.Equal(MaskedTextResultHint.Success, resultHint);

            Assert.False(maskedTextProvider.InsertAt('1', 6, out testPosition,
                out resultHint));
        ...
        public void Remove_TestPosition_ResultHint()
        {
            ...
            Assert.True(maskedTextProvider.Remove(out var testPosition, out var resultHint));
            Assert.Equal(MaskedTextResultHint.Success, resultHint);
            Assert.Equal(0, testPosition);
        }
        ...
        public void RemoveAt_StartPosition_EndPosition_TestPosition_ResultHint()
        {
            ...
            Assert.False(maskedTextProvider.RemoveAt(0,6, out var testPosition, out var resultHint));
            Assert.Equal(6, testPosition);
            Assert.Equal(MaskedTextResultHint.PositionOutOfRange, resultHint);
        ...
        public void Replace_InputChar_Position()
        {
            ...
            Assert.Equal("2-2_-_", maskedTextProvider.ToDisplayString());
        }
        ...
        public void Replace_InputChar_Position_TestPosition_ResultHint()
        {
            ...
            Assert.True(maskedTextProvider.Replace('2', 0, out var testPosition, out var resultHint));
        ...
        public void Replace_InputChar_StartPosition_EndPosition_TestPosition_ResultHint()
        {
            ...
            Assert.True(maskedTextProvider.Replace('2', 0, 5, out var testPosition, out var resultHint));
        ...
        public void Replace_InputString_Position()
        {
            ...
            Assert.Equal("2-3_-_", maskedTextProvider.ToDisplayString());
        }
        ...
        public void Replace_InputString_Position_TestPosition_ResultHint()
        {
            ...
            Assert.True(maskedTextProvider.Replace("23", 0, out var testPosition, out var resultHint));
        ...
        public void Replace_InputString_StartPosition_EndPosition_TestPosition_ResultHint()
        {
            ...
            Assert.False(maskedTextProvider.Replace("2", 0, 6, out var testPosition, out var resultHint));
            Assert.Equal(MaskedTextResultHint.PositionOutOfRange, resultHint);
        ...
        public void Set_InputString_TestPosition_ResultHint()
        {
            ...
            Assert.True(maskedTextProvider.Set("1234", out var testPosition, out var resultHint));
            Assert.Equal("1-23-4", maskedTextProvider.ToDisplayString());
        ...
        {
            var maskedTextProvider = new MaskedTextProvider(TestSimpleDigitMask);
            Assert.True(maskedTextProvider.VerifyChar('1', 0, out var resultHint));
            Assert.Equal(MaskedTextResultHint.Success, resultHint);
        ...
        public void VerifyString_Input_TestPosition_ResultHint()
        {
            ...
            Assert.True(maskedTextProvider.VerifyString("10000000", out var testPosition, out var resultHint));
