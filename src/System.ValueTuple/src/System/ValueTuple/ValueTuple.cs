...
namespace System
{
        ...
        : IEquatable<ValueTuple<T1>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1>>, ITupleInternal
    {
        ...
        public override int GetHashCode()
        {
            return T1Comparer.GetHashCode(Item1);
        }
        ...
        : IEquatable<ValueTuple<T1, T2>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2>>, ITupleInternal
    {
        ...
        public override int GetHashCode()
        {
            return ValueTuple.CombineHashCodes(T1Comparer.GetHashCode(Item1),
                                               T2Comparer.GetHashCode(Item2));
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3>>, ITupleInternal
    {
        private static readonly IEqualityComparer<T1> T1Comparer = EqualityComparer<T1>.Default;
        private static readonly IEqualityComparer<T2> T2Comparer = EqualityComparer<T2>.Default;
        private static readonly IEqualityComparer<T3> T3Comparer = EqualityComparer<T3>.Default;
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4>>, ITupleInternal
    {
        ...
        private static readonly IEqualityComparer<T2> T2Comparer = EqualityComparer<T2>.Default;
        private static readonly IEqualityComparer<T3> T3Comparer = EqualityComparer<T3>.Default;
        private static readonly IEqualityComparer<T4> T4Comparer = EqualityComparer<T4>.Default;
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4, T5>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5>>, ITupleInternal
    {
        ...
        private static readonly IEqualityComparer<T3> T3Comparer = EqualityComparer<T3>.Default;
        private static readonly IEqualityComparer<T4> T4Comparer = EqualityComparer<T4>.Default;
        private static readonly IEqualityComparer<T5> T5Comparer = EqualityComparer<T5>.Default;
        ...
        public bool Equals(ValueTuple<T1, T2, T3, T4, T5> other)
        {
            return T1Comparer.Equals(Item1, other.Item1)
                ...
                && T3Comparer.Equals(Item3, other.Item3)
                && T4Comparer.Equals(Item4, other.Item4)
                && T5Comparer.Equals(Item5, other.Item5);
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6>>, ITupleInternal
    {
        ...
        private static readonly IEqualityComparer<T4> T4Comparer = EqualityComparer<T4>.Default;
        private static readonly IEqualityComparer<T5> T5Comparer = EqualityComparer<T5>.Default;
        private static readonly IEqualityComparer<T6> T6Comparer = EqualityComparer<T6>.Default;
        ...
        public bool Equals(ValueTuple<T1, T2, T3, T4, T5, T6> other)
        {
            return T1Comparer.Equals(Item1, other.Item1)
                ...
                && T4Comparer.Equals(Item4, other.Item4)
                && T5Comparer.Equals(Item5, other.Item5)
                && T6Comparer.Equals(Item6, other.Item6);
        }
        ...
        : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, ITupleInternal
    {
        ...
        private static readonly IEqualityComparer<T5> T5Comparer = EqualityComparer<T5>.Default;
        private static readonly IEqualityComparer<T6> T6Comparer = EqualityComparer<T6>.Default;
        private static readonly IEqualityComparer<T7> T7Comparer = EqualityComparer<T7>.Default;
        ...
        where TRest : struct
    {
        ...
        private static readonly IEqualityComparer<T6> T6Comparer = EqualityComparer<T6>.Default;
        private static readonly IEqualityComparer<T7> T7Comparer = EqualityComparer<T7>.Default;
        private static readonly IEqualityComparer<TRest> TRestComparer = EqualityComparer<TRest>.Default;
        ...
        public bool Equals(ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> other)
        {
            return T1Comparer.Equals(Item1, other.Item1)
                ...
                && T6Comparer.Equals(Item6, other.Item6)
                && T7Comparer.Equals(Item7, other.Item7)
                && TRestComparer.Equals(Rest, other.Rest);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                case 1:
                    return ValueTuple.CombineHashCodes(T7Comparer.GetHashCode(Item7),
                                                       rest.GetHashCode());
                case 2:
                    return ValueTuple.CombineHashCodes(T6Comparer.GetHashCode(Item6),
                                                       T7Comparer.GetHashCode(Item7),
                                                       rest.GetHashCode());
                case 3:
                    return ValueTuple.CombineHashCodes(T5Comparer.GetHashCode(Item5),
                                                       T6Comparer.GetHashCode(Item6),
                                                       T7Comparer.GetHashCode(Item7),
                                                       rest.GetHashCode());
                case 4:
                    return ValueTuple.CombineHashCodes(T4Comparer.GetHashCode(Item4),
                                                       T5Comparer.GetHashCode(Item5),
                                                       T6Comparer.GetHashCode(Item6),
                                                       T7Comparer.GetHashCode(Item7),
                                                       rest.GetHashCode());
                case 5:
                    return ValueTuple.CombineHashCodes(T3Comparer.GetHashCode(Item3),
                                                       T4Comparer.GetHashCode(Item4),
                                                       T5Comparer.GetHashCode(Item5),
                                                       T6Comparer.GetHashCode(Item6),
                                                       T7Comparer.GetHashCode(Item7),
                                                       rest.GetHashCode());
                case 6:
                    return ValueTuple.CombineHashCodes(T2Comparer.GetHashCode(Item2),
                                                       T3Comparer.GetHashCode(Item3),
                                                       T4Comparer.GetHashCode(Item4),
                                                       T5Comparer.GetHashCode(Item5),
                                                       T6Comparer.GetHashCode(Item6),
