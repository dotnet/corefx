...
public class Read_char_int_int_Generic
{
    ...
    public static readonly String s_strTFName = "Read_char_int_int_Generic.cs";
    ...
    {
        Read_char_int_int_Generic objTest = new Read_char_int_int_Generic();
    ...
    public bool ParityErrorOnLastByte()
    {
        ...
        retValue &= VerifyRead(com1, com2, bytesToWrite, expectedChars, expectedChars.Length / 2);
    ...
    private bool VerifyTimeout(SerialPort com)
    {
        ...
        try
        {
            com.Read(new char[defaultCharArraySize], 0, defaultCharArraySize); //Warm up read method
    ...
    public bool VerifyParityReplaceByte(int parityReplace, int parityErrorIndex)
    {
        ...
        return VerifyRead(com1, com2, bytesToWrite, expectedChars, numBytesReadPairty);
    }
    ...
    public bool VerifyBytesToRead(int numBytesRead)
    {
        ...
        return VerifyRead(com1, com2, bytesToWrite, expectedChars, numBytesRead);
    }


    private bool VerifyRead(SerialPort com1, SerialPort com2, byte[] bytesToWrite, char[] expectedChars, int rcvBufferSize)
    {
        bool retValue = true;
