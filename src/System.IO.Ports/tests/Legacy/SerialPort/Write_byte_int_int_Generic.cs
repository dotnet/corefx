...
public class Write_byte_int_int_generic : PortsTest
{
    ...
    private bool BytesToWrite()
    {
        ...
        {
            retValue = false;
            Debug.WriteLine("ERROR!!! Expcted BytesToWrite={0} actual {1} after first write", BYTE_SIZE_BYTES_TO_WRITE, com.BytesToWrite);
        }
    ...
    private bool BytesToWriteSuccessive()
    {
        ...
        {
            retValue = false;
            Debug.WriteLine("ERROR!!! Expcted BytesToWrite={0} actual {1} after second write", BYTE_SIZE_BYTES_TO_WRITE * 2, com.BytesToWrite);
        }
    ...
    public bool Verify_Handshake(Handshake handshake)
    {
        ...
        {
            retValue = false;
            Debug.WriteLine("ERROR!!! Expcted BytesToWrite={0} actual {1}", BYTE_SIZE_HANDSHAKE, com1.BytesToWrite);
        }
