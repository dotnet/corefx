...
namespace Resources {
    ...
    internal class Strings {
        ...
        /// <summary> Looks up a localized string similar to No information about the exception is available.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The value must be different than {0}.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The value must be equal to {0}.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The value must be inside the range {0}-{1}.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The value must not be in the range {0}-{1}.. </summary>
        ...
        /// <summary> Looks up a localized string similar to Only types derived from {0} are valid validator types.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The supplied validator does not support validating the configuration element type {0}.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The supplied validator does not support the type of the property &apos;{0}&apos;.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The configuration element &apos;{0}&apos; is not valid. The error is: {1}. </summary>
        ...
        /// <summary> Looks up a localized string similar to The supplied method name &apos;{0}&apos; was not found. The callback method must be a public static void method with one object parameter.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The upper range limit value must be greater than the lower range limit value.. </summary>
        ...
        /// <summary> Looks up a localized string similar to Multiple validator attributes are not currently supported. The property &apos;{0}&apos; has more than one validator attribute associated with it.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The value must have a resolution of {0}.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The string cannot contain any of the following characters: &apos;{0}&apos;.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The string must be no more than {0} characters long.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The string must be at least {0} characters long.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The time span value must be positive.. </summary>
        ...
        /// <summary> Looks up a localized string similar to The supplied value is not of type which the validator can process.. </summary>
