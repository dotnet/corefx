...
namespace System.Threading.Tests
{
    public class MutexTests : RemoteExecutorTestBase
    {
        ...
        [ConditionalFact("System.PlatformDetection, CoreFx.Private.TestUtilities!" + nameof(PlatformDetection.IsNotWinRT))] // Can't create global objects in appcontainer
        ...
        [ConditionalFact("System.PlatformDetection, CoreFx.Private.TestUtilities!" + nameof(PlatformDetection.IsWinRT))] // Can't create global objects in appcontainer
        [PlatformSpecific(TestPlatforms.Windows)]
