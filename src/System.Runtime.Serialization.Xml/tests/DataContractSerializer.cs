...
#region Non-Generic Dictionary
    ...
    private static void TestingTheDelegate(People P)
    {
        DelegateClass.delegateVariable = "Verifying the Delegate Test";
        DelegateClass.someType = P;
    }
