...
namespace System.Xml.Tests
{
    ...
    public class TCElement
    {
        ...
        [Theory]
        [XmlWriterInlineData(TestCaseUtilsImplementation.XmlFactoryWriter, false, "<Root>-0</Root>")]
        [XmlWriterInlineData(TestCaseUtilsImplementation.XmlFactoryWriter, true, "<Root b=\"-0\" />")]
