...
{
    /// <summary> Data structure for storing whitespace rules generated by xsl:strip-space and xsl:preserve-space </summary>
    internal class WhitespaceRule
    {
        ...
        /// <summary> Allow derived classes to construct empty whitespace rule. </summary>
        protected WhitespaceRule()
        {
        }

        /// <summary> Construct new whitespace rule. </summary>
        public WhitespaceRule(string localName, string namespaceName, bool preserveSpace)
        {
            Init(localName, namespaceName, preserveSpace);
        }

        /// <summary> Initialize whitespace rule after it's been constructed. </summary>
        ...
        /// <summary> Namespace name (uri) of the element. </summary>
