...
namespace System.Xml.Xsl.IlGen
{
    internal class XmlILOptimizerVisitor : QilPatternVisitor
    {
        ...
        /// <summary> Perform normalization and annotation. </summary>
        ...
        /// <summary> Override the Visit method in order to scan for redundant namespaces and compute side-effect bit. </summary>
        ...
        /// <summary> Override the VisitReference method in order to possibly substitute. </summary>
        ...
        /// <summary> Override the RecalculateType method so that global variable type is not recalculated. </summary>
        ...
        /// <summary> Selectively enable/disable optimizations </summary>
        ...
        private class NodeCounter : QilVisitor
        {
            ...
            /// <summary> Returns number of occurrences of "target" node within the subtree of "expr". </summary>
        ...
        private class NodeFinder : QilVisitor
        {
            ...
            /// <summary> Returns true if "target" node exists within the subtree of "expr". </summary>
            ...
            /// <summary> Recursively visit, searching for target.  If/when found, call OnFound() method. </summary>
            ...
            /// <summary> Determine whether target is a reference. </summary>
            ...
            /// <summary> By default, just return true. </summary>
        ...
        {
            /// <summary> Return true only if parent node type is PositionOf. </summary>
        ...
        private class EqualityIndexVisitor : QilVisitor
        {
            ...
            /// <summary> Recursively visit, looking for references to "key" and "ctxt". </summary>
            protected override QilNode VisitReference(QilNode expr)
            {
                if (this.result)
                {
            ...
            /// <summary> If Root wraps a reference to "ctxt", then don't visit "ctxt" and continue scan. </summary>
        ...
        /// <summary> Returns true if any operator within the "expr" subtree references "target". </summary>
        private bool DependsOn(QilNode expr, QilNode target)
        {
            return new NodeFinder().Find(expr, target);
        }

        /// <summary> Returns true if there is no PositionOf operator within the "expr" subtree that references iterator "iter". </summary>
        protected bool NonPositional(QilNode expr, QilNode iter)
        {
            return !(new PositionOfFinder().Find(expr, iter));
        }

        /// <summary> Scans "expr" subtree, looking for "refOld" references and replacing them with "refNew" references. </summary>
        ...
        /// <summary> True if the specified iterator is a global variable Let iterator. </summary>
        private bool IsGlobalVariable(QilIterator iter)
        {
            return _qil.GlobalVariableList.Contains(iter);
        }

        /// <summary> True if the specified node is a global variable or parameter. </summary>
        ...
        /// <summary> Return true if "typ" is xs:decimal=, xs:integer=, xs:int=, xs:double=, or xs:float=. </summary>
        ...
        /// <summary> Returns true if "typ" matches one of the XPath content node tests: *, text(), comment(), pi(), or node(). </summary>
        ...
        /// <summary> True if the specified expression is a literal value. </summary>
        ...
        /// <summary> Return true if all children of "nd" are constant. </summary>
        ...
        /// <summary> Extract the value of a literal. </summary>
        ...
        /// <summary> Return true if "nd" has a child of type Sequence. </summary>
        ...
        /// <summary> True if the JoinAndDod pattern is allowed to match the specified node. </summary>
        ...
        /// <summary> True if the DodReverse pattern is allowed to match the specified node. </summary>
        ...
        /// <summary> Return true if XsltConvert applied to a Literal can be folded (i.e. the XsltConvert eliminated). </summary>
        ...
        /// <summary> Mark the specified node as matching the Step pattern and set the step node and step input arguments. </summary>
        ...
        /// <summary> Return true if "nd" matches the Step pattern and the StepType argument is equal to "stepType". </summary>
        ...
        /// <summary> Return true if "patt" matches the Step pattern and the StepType argument is equal to "stepType". </summary>
        ...
        /// <summary> Remove unused global functions, variables, or parameters from the list. </summary>
