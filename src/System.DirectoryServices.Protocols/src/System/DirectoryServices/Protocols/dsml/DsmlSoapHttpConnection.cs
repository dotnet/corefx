...
namespace System.DirectoryServices.Protocols {
     ...
     public class DsmlSoapHttpConnection :DsmlSoapConnection {
         ...
         private HttpWebRequest dsmlHttpConnection = null;
         string dsmlSoapAction = "\"#batchRequest\"";
         AuthType dsmlAuthType = AuthType.Negotiate;
         string dsmlSessionID = null;   
         private Hashtable httpConnectionTable = null;         
         private string debugResponse = null;
         ...
         { 
             ...
             httpConnectionTable = Hashtable.Synchronized(tempTable);
         }
         ...
         public override void BeginSession()
         {
            ...
            try
            {
                ...
                HttpWebResponse dsmlResponse = (HttpWebResponse) dsmlHttpConnection.GetResponse();
                // N.B.: we deliberately permit any exception to bubble up to the caller                

                try
                {
                    // extract the sessionID from the successful response
                    dsmlSessionID = ExtractSessionID(dsmlResponse);            
                }
                finally
                {
                    dsmlResponse.Close();
        ...
        DsmlResponseDocument SendRequestHelper(string reqstring)
        {
            //
            // Request
            //                        
            ...
            try
            {
                ...
                try
                {
                    ...
                    debugResponse = dsmlResponseDoc.ResponseString;
                }
                finally
                {                    
                    dsmlResponse.Close();                    
        ...
        [EnvironmentPermission(SecurityAction.Assert, Unrestricted=true)]
        void PrepareHttpWebRequest(HttpWebRequest dsmlConnection)
        {
        ...
        StreamWriter GetWebRequestStreamWriter()
        {
			Stream reqStream = dsmlHttpConnection.GetRequestStream();
            // N.B.: we deliberately permit any exception to bubble up to the caller
        ...
        /// applicable.
        /// </summary>
        void BeginSOAPRequest(ref StringBuilder buffer)
        {
        ...
        /// </summary>
        void EndSOAPRequest(ref StringBuilder buffer)
        {
        ...
        /// of a response
        /// </summary>
	string ExtractSessionID(HttpWebResponse resp)
	{
        ...
        { 
            ...
            httpConnectionTable.Add(asyncResult, asyncConnection);
        ...
        public void Abort(IAsyncResult asyncResult)
        {
            ...
            HttpWebRequest request = (HttpWebRequest) (httpConnectionTable[asyncResult]);
