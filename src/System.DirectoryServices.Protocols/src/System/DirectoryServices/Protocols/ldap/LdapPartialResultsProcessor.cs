...
namespace System.DirectoryServices.Protocols {
    ...
    internal class LdapPartialResultsProcessor {        
        ...
        private ManualResetEvent workThreadWaitHandle = null;
        ...
        {            
            ...
            lock(this) {
                ...
                while(true)
                {
                    ...
                    asyncResult = (LdapPartialAsyncResult) resultList[currentIndex];
                    i++;
                    currentIndex++;
