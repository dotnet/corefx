...
namespace System.DirectoryServices.Protocols {
    ...
    public class DirectoryAttribute :CollectionBase {
        ...
        static UTF8Encoding utf8EncoderWithErrorDetection = new UTF8Encoding(false, true);    
        ...
        {  
            ...
            {  
                ...
                {
                    if(List[i] is string)
                        results[i] = encoder.GetBytes((string)List[i]);
            ...
            else if(valuesType == typeof(string))
            {
                ...
                for(int i = 0; i < count; i++)
                {
                    if(List[i] is string)
                        ...
                        results[i] = encoder.GetString((byte[])List[i]);
                    else
                        throw new NotSupportedException(Res.GetString(Res.DirectoryAttributeConversion));
                }
            ...
            get {
                ...
                else
                {
                    ...
                    {                
                        try
                        {                                
                            return utf8EncoderWithErrorDetection.GetString(temp);
                        }
