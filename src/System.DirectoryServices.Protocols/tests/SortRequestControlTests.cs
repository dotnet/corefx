...
namespace System.DirectoryServices.Protocols.Tests
{
    public class SortRequestControlTests
    {
        ...
        public void Ctor_SortKeys(bool critical)
        {
            ...
            AssertExtensions.Equal(new byte[] { 48, 132, 0, 0, 0, 43, 48, 132, 0, 0, 0, 17, 4, 5, 110, 97, 109, 101, 49, 128, 5, 114, 117, 108, 101, 49, 129, 1, 255, 48, 132, 0, 0, 0, 14, 4, 5, 110, 97, 109, 101, 50, 128, 5, 114, 117, 108, 101, 50 }, control.GetValue());
        }
