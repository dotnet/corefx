...
namespace Properties {
    ...
    internal class Resources {
        ...
        /// <summary> Looks up a localized string similar to This manifest is discovered by the CustomAssemblyTests.GetManifestResourceInfoTest. Do not delete!. </summary>
