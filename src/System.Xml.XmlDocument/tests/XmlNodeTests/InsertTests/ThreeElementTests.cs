...
namespace XmlDocumentTests.XmlNodeTests.InsertTests
{
    ...
    {
        private static readonly XmlNodeType[] _XmlNodeTypes = new[] { XmlNodeType.Whitespace, XmlNodeType.SignificantWhitespace, XmlNodeType.CDATA, XmlNodeType.Text };
        private static readonly InsertType[] _InsertTypes = new[] { InsertType.InsertBefore, InsertType.InsertAfter };
