...
namespace XmlDocumentTests.XmlNodeTests
{
    ...
    {
        private static readonly XmlNodeType[] _XmlNodeTypes = new XmlNodeType[] { XmlNodeType.Whitespace, XmlNodeType.SignificantWhitespace, XmlNodeType.CDATA, XmlNodeType.Text, XmlNodeType.Comment };
