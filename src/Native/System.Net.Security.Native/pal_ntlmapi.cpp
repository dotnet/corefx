...
static inline int32_t NetSecurityNative_SetBufferLength(int32_t status, ntlm_buf* ntlmBuffer, struct PAL_NtlmBuffer* targetBuffer)
{
...
static int32_t
NetSecurityNative_build_ntlm2_master(uint8_t* key, int32_t keylen, ntlm_buf* blob, ntlm_buf* sessionKey, ntlm_buf* masterKey)
{
                                                  ...
                                                  struct PAL_NtlmBuffer* outBuffer)
{
    ...
    {
        // in case of v2, masterKey.data is created by NetSecurityNative_build_ntlm2_master function and free_buf cannot be
        // called.
