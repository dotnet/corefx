...
namespace System.Composition.Hosting.Providers.Lazy
{
    ...
    {
        private static readonly MethodInfo _GetLazyDefinitionsMethod = typeof(LazyExportDescriptorProvider)
        ...
        public override IEnumerable<ExportDescriptorPromise> GetExportDescriptors(CompositionContract exportKey, DependencyAccessor definitionAccessor)
        {
            ...
            var gld = _GetLazyDefinitionsMethod.MakeGenericMethod(exportKey.ContractType.GenericTypeArguments[0]);
