...
namespace System.Reflection.Tests
{
    public class TypeInfoDeclaredFieldTests
    {
        ...
        {
            VerifyFields(typeof(TypeInfoFieldBaseClass), TypeInfoFieldBaseClass.PublicFieldNames);
        }
        ...
        {
            VerifyFields(typeof(TypeInfoFieldSubClass), TypeInfoFieldSubClass.PublicFieldNames);
        }
