...
namespace System.Reflection.Tests
{
    public class ParameterInfoTests
    {
        ...
        {
            yield return new object[] { typeof(MyClass), "Method1", new string[] { "str", "iValue", "lValue" }, new Type[] { typeof(string), typeof(int), typeof(long) } };
            yield return new object[] { typeof(MyClass), "Method2", new string[0], new Type[0] };
            yield return new object[] { typeof(MyClass), "MethodWithArray", new string[] { "strArray" }, new Type[] { typeof(string[]) } };
            yield return new object[] { typeof(MyClass), "VirtualMethod", new string[] { "data" }, new Type[] { typeof(long) } };
            yield return new object[] { typeof(MyClass), "MethodWithRefParameter", new string[] { "str" }, new Type[] { typeof(string).MakeByRefType() } };
            yield return new object[] { typeof(MyClass), "MethodWithOutParameter", new string[] { "i", "str" }, new Type[] { typeof(int), typeof(string).MakeByRefType() } };
            yield return new object[] { typeof(GenericClass<string>), "GenericMethod", new string[] { "t" }, new Type[] { typeof(string) } };
        }

        [Theory]
        [MemberData("Parameters_TestData")]
        ...
        [Theory]
        [InlineData(typeof(MyClass), "MethodWithDefault1", 1, true)]
        [InlineData(typeof(MyClass), "MethodWithDefault2", 0, true)]
        [InlineData(typeof(MyClass), "MethodWithDefault3", 0, true)]
        [InlineData(typeof(MyClass), "MethodWithDefault4", 0, true)]
        [InlineData(typeof(GenericClass<int>), "GenericMethodWithDefault", 1, true)]
        [InlineData(typeof(MyClass), "Method1", 1, false)]
        [InlineData(typeof(MyClass), "MethodWithRefParameter", 0, false)]
        [InlineData(typeof(MyClass), "MethodWithOutParameter", 1, false)]
        ...
        {
            ParameterInfo parameterInfo = GetMethod(typeof(MyClass), "Method1").ReturnParameter;
            Assert.True(parameterInfo.HasDefaultValue);
        }

        [Theory]
        [InlineData(typeof(MyClass), "MethodWithRefParameter", 0, false)]
        [InlineData(typeof(MyClass), "MethodWithOutParameter", 1, true)]
        [InlineData(typeof(MyClass), "Method1", 1, false)]
        ...
        [Theory]
        [InlineData(typeof(MyClass), "MethodWithDefault1", 1, 0)]
        [InlineData(typeof(MyClass), "MethodWithDefault2", 0, "abc")]
        [InlineData(typeof(MyClass), "MethodWithDefault3", 0, false)]
        [InlineData(typeof(MyClass), "MethodWithDefault4", 0, '\0')]
        ...
        {
            ParameterInfo parameterInfo = GetParameterInfo(typeof(MyClass), "MethodWithOptionalAndNoDefault", 0);
        ...
        [Theory]
        [InlineData(typeof(MyClass), "Method1", 1, false)]
        [InlineData(typeof(MyClass), "MethodWithDefault2", 0, false)]
        ...
        [Theory]
        [InlineData(typeof(MyClass), "MethodWithOptionalDefaultOutInMarshalParam", 0,
        ...
        {
            ParameterInfo parameterInfo = GetParameterInfo(typeof(MyClass), "MethodWithOptionalDefaultOutInMarshalParam", 0);
