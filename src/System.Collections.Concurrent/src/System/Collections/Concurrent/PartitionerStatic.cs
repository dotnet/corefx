...
namespace System.Collections.Concurrent
{
    ...
    public static class Partitioner
    {
        ...
        public static OrderablePartitioner<Tuple<long, long>> Create(long fromInclusive, long toExclusive)
        {
            ...
            return Create(CreateRanges(fromInclusive, toExclusive, rangeSize), EnumerablePartitionerOptions.NoBuffering); // chunk one range at a time
        }
        ...
        private abstract class DynamicPartitionEnumerator_Abstract<TSource, TSourceReader> : IEnumerator<KeyValuePair<long, TSource>>
        {
            ...
            private const int ChunkDoublingRate = 3; // Double the chunk size every this many grabs
            ...
            public bool MoveNext()
            {
                ...
                if (_localOffset == null)
                {
                    ...
                    _doublingCountdown = ChunkDoublingRate;
                }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        _doublingCountdown = ChunkDoublingRate; // reset
                    }
            ...
            private class InternalPartitionEnumerable : IEnumerable<KeyValuePair<long, TSource>>, IDisposable
            {
                ...
                internal InternalPartitionEnumerable(IEnumerator<TSource> sharedReader, bool useSingleChunking, bool isStaticPartitioning)
                {
                    ...
                    if (!_useSingleChunking)
                    {
                        ...
                        _fillBuffer = new KeyValuePair<long, TSource>[fillBufferMultiplier * GetDefaultChunkSize<TSource>()];
                    }
        ...
        private abstract class DynamicPartitionEnumeratorForIndexRange_Abstract<TSource, TSourceReader> : DynamicPartitionEnumerator_Abstract<TSource, TSourceReader>
        {
            ...
            protected override bool GrabNextChunk(int requestedChunkSize)
            {
                ...
                while (!HasNoElementsLeft)
                {
                    ...
                    if (Interlocked.CompareExchange(ref _sharedIndex.Value, newSharedIndex, oldSharedIndex) == oldSharedIndex)
                    {
