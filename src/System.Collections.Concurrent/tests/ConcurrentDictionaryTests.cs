...
namespace Test
{
    public class ConcurrentDictionaryTests
    {
        ...
        public static void RunDictionaryTest_ICollection()
        {
            ...
            //potential bug!! throws TypeMisMatch instead of ArgumentException
            //@TODO: Uncomment this test after the product fix is submitted.
            /* Assert.EnsureExceptionThrown(() => dictionary.CopyTo(new string[1], 0),
              typeof(ArgumentException),
              "CopyTo didn't throw AE when the wrong Array type is passed");*/
       ...
       // [Fact]
        public static void RunDictionaryTest_TryUpdate()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                Assert.True(dictionary[i.ToString()] == i + 1, "RunDictionaryTest_TryUpdate:  FAILED.  TryUpdate failed!");
            }
