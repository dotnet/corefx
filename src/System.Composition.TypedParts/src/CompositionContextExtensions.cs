...
namespace System.Composition
{
    ...
    {
        private static readonly DirectAttributeContext _directAttributeContext = new DirectAttributeContext();
        ...
        {
            SatisfyImportsInternal(compositionContext, objectWithLooseImports, _directAttributeContext);
        }
