...
namespace System.Collections.Immutable
{
    ...
    public partial class ImmutableDictionary<TKey, TValue>
    {
        ...
        private readonly struct MutationResult
        {
            ...
            /// <summary> The number of elements added or removed from the collection as a result of the operation (a negative number represents removed elements). </summary>
            private readonly int _countAdjustment;

            /// <summary> Initializes a new instance of the <see cref="ImmutableDictionary{TKey, TValue}.MutationResult"/> struct. </summary>
            ...
            /// <summary> Gets the number of elements added or removed from the collection as a result of the operation (a negative number represents removed elements). </summary>
            internal int CountAdjustment
            {
                get { return _countAdjustment; }
            }

            /// <summary> Returns an immutable dictionary that captures the result of this mutation. </summary>
