...
{
    /// <summary> A thin wrapper around the <see cref="IDictionary{TKey, TValue}.Keys"/> or <see cref="IDictionary{TKey, TValue}.Values"/> enumerators so they look like a collection. </summary>
    ...
    {
        /// <summary> The underlying wrapped dictionary. </summary>
        private readonly IImmutableDictionary<TKey, TValue> _dictionary;

        /// <summary> The key or value enumerable that this instance wraps. </summary>
        private readonly IEnumerable<T> _keysOrValues;

        /// <summary> Initializes a new instance of the <see cref="KeysOrValuesCollectionAccessor{TKey, TValue, T}"/> class. </summary>
        ...
        /// <summary> See <see cref="IEnumerable{T}"/> </summary>
        public IEnumerator<T> GetEnumerator()
        {
            return _keysOrValues.GetEnumerator();
        }

        /// <summary> See <see cref="System.Collections.IEnumerable"/> </summary>
    ...
    /// <summary> A lightweight collection view over and IEnumerable of keys. </summary>
    internal sealed class KeysCollectionAccessor<TKey, TValue> : KeysOrValuesCollectionAccessor<TKey, TValue, TKey>
    {
        /// <summary> Initializes a new instance of the <see cref="KeysCollectionAccessor{TKey, TValue}"/> class. </summary>
    ...
    /// <summary> A lightweight collection view over and IEnumerable of values. </summary>
    internal sealed class ValuesCollectionAccessor<TKey, TValue> : KeysOrValuesCollectionAccessor<TKey, TValue, TValue>
    {
        /// <summary> Initializes a new instance of the <see cref="ValuesCollectionAccessor{TKey, TValue}"/> class. </summary>
