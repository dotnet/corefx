...
namespace System.Collections.Immutable
{
    ...
    public sealed partial class ImmutableHashSet<T> : IImmutableSet<T>, IHashKeyCollection<T>, IReadOnlyCollection<T>, ICollection<T>, ISet<T>, ICollection
    {
        ...
        public ImmutableHashSet<T> Clear()
        {
            ...
            return this.IsEmpty ? this : ImmutableHashSet<T>.Empty.WithComparer(this._equalityComparer);
        }
        ...
        public bool TryGetValue(T equalValue, out T actualValue)
        {
            ...
            HashBucket bucket;
            if (this._root.TryGetValue(hashCode, Comparer<int>.Default, out bucket))
            {
                return bucket.TryExchange(equalValue, this._equalityComparer, out actualValue);
            }
        ...
        public ImmutableHashSet<T> Except(IEnumerable<T> other)
        {
            ...
            var result = Except(other, this._equalityComparer, this._root);
            return result.Finalize(this);
        }
        ...
        {
            return (root != this._root) ? new ImmutableHashSet<T>(root, this._equalityComparer, adjustedCountIfDifferentRoot) : this;
        }
