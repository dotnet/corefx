    ...
    public sealed partial class ImmutableSortedDictionary<TKey, TValue>
    {
        ...
        public sealed class Builder : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, IDictionary
        {
            ...
            public IComparer<TKey> KeyComparer
            {
                ...
                set
                {
                    ...
                    if (value != this._keyComparer)
                    {
                        ...
                        {
                            bool mutated;
                            newRoot = newRoot.Add(item.Key, item.Value, value, this._valueComparer, out mutated);
                            if (mutated)
                            {
                                count++;
                            }
            ...
            public IEqualityComparer<TValue> ValueComparer
            {
                ...
                set
                {
                    ...
                    if (value != this._valueComparer)
                    {
                        ...
                        this._immutable = null; // invalidate cached immutable
                    }
                }
            }
            ...
            public ImmutableSortedDictionary<TKey, TValue> ToImmutable()
            {
                ...
                {
                    this._immutable = Wrap(this.Root, this._count, this._keyComparer, this._valueComparer);
                }
