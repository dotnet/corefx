...
namespace System.Collections.Immutable
{
    ...
    public sealed partial class ImmutableHashSet<T>
    {
        ...
        public sealed class Builder : IReadOnlyCollection<T>, ISet<T>
        {
            ...
            /// </summary>
            private ImmutableSortedDictionary<int, HashBucket>.Node _root = ImmutableSortedDictionary<int, HashBucket>.Node.EmptyNode;
            ...
            public IEqualityComparer<T> KeyComparer
            {
                ...
                set
                {
                    ...
                    if (value != this._equalityComparer)
                    {
                        ...
                        this._count = result.Count; // whether the offset or absolute, since the base is 0, it's no difference.
                    }
                }
            }
            ...
            {
                get { return new MutationInput(this.Root, this._equalityComparer, this._count); }
            }
            ...
            {
                var result = ImmutableHashSet<T>.Except(other, this._equalityComparer, this._root);
                this.Apply(result);
            }
