...
namespace System.Collections.Immutable
{
    ...
    public partial class ImmutableHashSet<T>
    {
        ...
        private readonly struct MutationInput
        {
            ...
            /// <summary> The current number of elements in the collection. </summary>
            private readonly int _count;

            /// <summary> The equality comparer to use when checking for <see cref="HashBucket"/> equality. </summary>
            private readonly IEqualityComparer<HashBucket> _hashBucketEqualityComparer;

            /// <summary> Initializes a new instance of the <see cref="ImmutableHashSet{T}.MutationInput"/> struct. </summary>
            ...
            /// <summary> Gets the equality comparer. </summary>
            internal IEqualityComparer<T> EqualityComparer
            {
                get { return _equalityComparer; }
            }

            /// <summary> Gets the current number of elements in the collection. </summary>
            internal int Count
            {
                get { return _count; }
            }

            /// <summary> Gets the equality comparer to use when checking for <see cref="HashBucket"/> equality. </summary>
