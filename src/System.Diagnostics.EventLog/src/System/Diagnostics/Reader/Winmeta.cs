...
{
    /// <summary> WindowsEventLevel </summary>
    ...
    /// <summary> WindowsEventTask </summary>
    ...
    {
        /// <summary> Wild card value </summary>
        None = 0x0,
        /// <summary> Events providing response time information </summary>
        ...
        /// <summary> Incorrect CorrelationHint value mistakenly shipped in .NET 3.5. Don't use: duplicates AuditFailure. </summary>
        [Obsolete("Incorrect value: use CorrelationHint2 instead", false)]
        CorrelationHint = 0x10000000000000,
        /// <summary> Transfer events where the related Activity ID is a computed value and not a GUID </summary>
