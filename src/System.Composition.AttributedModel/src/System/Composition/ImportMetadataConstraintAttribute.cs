...
{
    /// <summary> When applied on an import, requires certain metadata values on the exporter. </summary>
    [AttributeUsage(AttributeTargets.Property, Inherited = false)]
    public sealed class ImportMetadataConstraintAttribute : Attribute
    {
        /// <summary> Require a specific metadata value on the exporter. </summary>
        ...
        /// <summary> The metadata key to match. </summary>
