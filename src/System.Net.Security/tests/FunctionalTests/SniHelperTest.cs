...
namespace System.Net.Security.Tests
{
    public class SniHelperTest
    {
        ...
        private static byte[] s_validClientHello = new byte[] {
            ...
            0x03, 0x03,
            // ClientHello.random
            0xEB, 0xD8, 0xD1, 0x29, 0xAB,
            0x41, 0x81, 0x55, 0x82, 0xB5,
            0xD0, 0xDB, 0x46, 0xAC, 0xBB,
            0x0C, 0xF9, 0x4F, 0x99, 0x4D,
            0xB2, 0x1C, 0x62, 0x4D, 0xBA,
            0xEE, 0xE7, 0x13, 0xF7, 0x21,
            0xAD, 0xEB,
        ...
        private static IEnumerable<object[]> InvalidClientHelloData()
        {
            ...
            yield return new object[] {
                ...
                new byte[] {
                    ...
                    0x03, 0x03,
                    // ClientHello.random
                    0xB7, 0xD2, 0xF8, 0x07, 0x8F,
                    0x0D, 0xB1, 0xE3, 0x36, 0x63,
                    0x02, 0x13, 0xBD, 0x93, 0xC9,
                    0x91, 0xD8, 0x61, 0x21, 0xB7,
                    0x54, 0x56, 0xFF, 0xFA, 0xB8,
                    0x15, 0xB8, 0x49, 0x51, 0x9C,
                    0xA5, 0x6C,
                    // ClientHello.SessionId
                    0x00,
                    // ClientHello.cipher_suites
