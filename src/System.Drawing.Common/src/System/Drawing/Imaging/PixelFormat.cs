...
namespace System.Drawing.Imaging
{
    ...
    public enum PixelFormat
    {
        ...
        /// </summary>
        Indexed = 0x00010000,
        /// <summary> Specifies that pixel data contains GDI colors. </summary>
        Gdi = 0x00020000,
        /// <summary> Specifies that pixel data contains alpha values that are not pre-multiplied. </summary>
        Alpha = 0x00040000,
        /// <summary> Specifies that pixel format contains pre-multiplied alpha values. </summary>
        PAlpha = 0x00080000, // What's this?
        Extended = 0x00100000,
        Canonical = 0x00200000,
        /// <summary> Specifies that pixel format is undefined. </summary>
        Undefined = 0,
        /// <summary> Specifies that pixel format is a don't care. </summary>
        DontCare = 0,
        // makes it into devtools, we can change this.
        /// <summary> Specifies that pixel format is 1 bit per pixel indexed color. The color table therefore has two colors in it. </summary>
        Format1bppIndexed = 1 | (1 << 8) | (int)Indexed | (int)Gdi,
        /// <summary> Specifies that pixel format is 4 bits per pixel indexed color. The color table therefore has 16 colors in it. </summary>
        Format4bppIndexed = 2 | (4 << 8) | (int)Indexed | (int)Gdi,
        /// <summary> Specifies that pixel format is 8 bits per pixel indexed color. The color table therefore has 256 colors in it. </summary>
        Format8bppIndexed = 3 | (8 << 8) | (int)Indexed | (int)Gdi,
        Format16bppGrayScale = 4 | (16 << 8) | (int)Extended,
        /// <summary> Specifies that pixel format is 16 bits per pixel. The color information specifies 65536 shades of gray. </summary>
