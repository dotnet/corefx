...
namespace System.Drawing.Printing
{
    ...
    public enum PaperSourceKind
    {
        ...
        /// <summary> The upper bin of a printer (or, if the printer only has one bin, the only bin). </summary>
        ...
        /// <summary> A manually-fed envelope. </summary>
        ManualFeed = SafeNativeMethods.DMBIN_ENVMANUAL,

        /// <summary> Automatic-fed paper. </summary>
        ...
        /// <summary> A large-capacity bin printer. </summary>
