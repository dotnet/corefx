...
{
    /// <summary> The BufferedGraphicsManager is used for accessing a BufferedGraphicsContext. </summary>
    public static class BufferedGraphicsManager
    {
        /// <summary> Static constructor.  Here, we hook the exit &amp; unload events so we can clean up our context buffer. </summary>
        ...
        /// <summary> Retrieves the context associated with the app domain. </summary>
        public static BufferedGraphicsContext Current { get; }

        /// <summary> Called on process exit </summary>
        [PrePrepareMethod]
