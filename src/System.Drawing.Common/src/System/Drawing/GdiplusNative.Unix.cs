...
namespace System.Drawing
{
    internal partial class SafeNativeMethods
    {
        internal unsafe partial class Gdip
        {
            ...
            private delegate int GdipCreateFontFromHfont_delegate(HandleRef hdc, out IntPtr font, ref LOGFONT lf);
            private static FunctionWrapper<GdipCreateFontFromHfont_delegate> GdipCreateFontFromHfont_ptr;
            internal static int GdipCreateFontFromHfont(HandleRef hdc, out IntPtr font, ref LOGFONT lf) => GdipCreateFontFromHfont_ptr.Delegate(hdc, out font, ref lf);
