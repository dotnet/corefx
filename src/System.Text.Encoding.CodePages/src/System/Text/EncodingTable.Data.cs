...
// It operated over files Data\CodePageNameMappings.csv (for IANA name to code page mappings),
//   and Data\PreferredCodePageNames.csv (for main/preferred IANA names and "English"/descriptive names.
