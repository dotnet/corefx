...
* CONSIDER - writing activity [RootId](#root-id) with every telemetry event _if_ filtering by Id prefix is not supported by you logging backend or too expensive.
