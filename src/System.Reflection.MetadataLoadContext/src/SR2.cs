...
namespace System
{
    ...
    {
        internal const string NotSupported_AssemblyCodeBase = "The CodeBase property is not supported on assemblies loaded by a MetadataLoadContext. Use Assembly.Location to find the origin of an Assembly.";
        internal const string NotSupported_SatelliteAssembly = "Satellite assemblies are not supported on assemblies loaded by a MetadataLoadContext.";
        internal const string NotSupported_CaseInsensitive = "Passing true for ignoreCase is not supported on assemblies loaded by a MetadataLoadContext.";
        internal const string NotSupported_InterfaceMapping = "InterfaceMapping is not supported on assemblies loaded by a MetadataLoadContext.";
        internal const string NotSupported_GetBaseDefinition = "GetBaseDefinition() is not supported on assemblies loaded by a MetadataLoadContext.";
        internal const string NotSupported_MDStreamVersion = "MDStreamVersion is not supported on assemblies loaded by a MetadataLoadContext.";
        internal const string NotSupported_ResolvingTokens = "Resolving tokens is not supported on assemblies loaded by a MetadataLoadContext.";
        ...
        internal const string InvalidOperation_IsSecurity = "This property is not supported on assemblies loaded by a MetadataLoadContext as there is no trust level to evaluate these against.";
        ...
        internal const string Arg_ReflectionOnlyCA = "The requested operation is invalid on objects loaded by a MetadataLoadContext. Use CustomAttributeData instead.";
        internal const string Arg_ReflectionOnlyInvoke = "It is illegal to invoke a method on a Type loaded by a MetadataLoadContext.";
        internal const string Arg_ReflectionOnlyIllegal = "The requested operation is invalid on objects loaded by a MetadataLoadContext.";
        internal const string Arg_ReflectionOnlyParameterDefaultValue = "It is illegal to request the default value on a ParameterInfo loaded by a MetadataLoadContext. Use RawDefaultValue instead.";
        ...
        internal const string FileLoadDuplicateAssemblies = "The assembly '{0}' has already loaded been loaded into this MetadataLoadContext.";
        ...
        internal const string NoCoreAssemblyDefined = "This operation could not be completed because this MetadataLoadContext's CoreAssemblyName property was not set to a valid assembly name.";
        ...
        internal const string ExternalAssemblyReturnedByResolveHandler = "An assembly that was not created by this MetadataLoadContext object was returned from its Resolving event handler.";

        internal const string NoInvokeMember = "Types loaded by a MetadataLoadContext cannot pass any of these BindingFlags: InvokeMethod, CreateInstance, GetProperty, SetProperty";
        ...
        internal const string ModuleResolveEventReturnedExternalModule = "ModuleResolve handlers may only return Modules loaded by the MetadataLoadContext that loaded the parent assembly.";
        internal const string MakeGenericType_NotLoadedByMetadataLoadContext = "This type {0} was not loaded by the MetadataLoadContext that loaded the generic type or method.";
        ...
        internal const string TooLateToSetCoreAssemblyName = "This MetadataLoadContext has already loaded the core Assembly using a previously supplied name.";
        ...
        internal const string Arg_MustBeType = "Type must be a type provided by the MetadataLoadContext.";
        internal const string Arg_EmptyArray = "Array may not be empty.";

        internal const string MetadataLoadContextDisposed = "This object is no longer valid because the MetadataLoadContext that created it has been disposed.";
