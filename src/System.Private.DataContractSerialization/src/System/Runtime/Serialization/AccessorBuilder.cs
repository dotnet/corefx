...
namespace System.Runtime.Serialization
{
    internal static class FastInvokerBuilder
    {
        ...
        private static MethodInfo s_createGetterInternal = typeof(FastInvokerBuilder).GetTypeInfo().GetDeclaredMethod(nameof(CreateGetterInternal));
        private static MethodInfo s_createSetterInternal = typeof(FastInvokerBuilder).GetTypeInfo().GetDeclaredMethod(nameof(CreateSetterInternal));
        private static MethodInfo s_make = typeof(FastInvokerBuilder).GetTypeInfo().GetDeclaredMethod(nameof(Make));
