...
#endif
    {
        ...
        private class ClassDataContractCriticalHelper : DataContract.DataContractCriticalHelper
        {
            ...
            internal ClassDataContractCriticalHelper(Type type) : base(type)
            {
                ...
                {
#if uapaot
                    // The DataContact pre-generated by SG is incomplete, in other words, some of its fields are not
                    // populated by SG. Reflection-based serialization, however, requires a complete DataContract.
                    //
                    // At this point, we're in the middle of creating a new DataContract at runtime, which indicates
                    // reflection-based serialization is being used. Therefore, we cannot use the pre-generated DataContracts
                    // of base types even if they exist.
                    //
                    // Note: the above comments only apply to using (SG + reflection as fallback) on UWP.
