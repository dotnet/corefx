    ...
    public sealed class X509Store : IDisposable
    {
        ...
        public X509Store(StoreName storeName, StoreLocation storeLocation)
        {
            if (storeLocation != StoreLocation.CurrentUser && storeLocation != StoreLocation.LocalMachine)
                throw new ArgumentException(SR.Format(CultureInfo.CurrentCulture, SR.Arg_EnumIllegalVal, nameof(storeLocation)));
            ...
            switch (storeName)
            {
                ...
                case StoreName.TrustedPublisher:
                    ...
                    break;
                default:
                    throw new ArgumentException(SR.Format(CultureInfo.CurrentCulture, SR.Arg_EnumIllegalVal, nameof(storeName)));
            }
