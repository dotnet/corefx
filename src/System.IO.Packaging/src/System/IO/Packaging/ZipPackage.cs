...
namespace System.IO.Packaging
{
    ...
    public sealed class ZipPackage : Package
    {
        ...
        {
            return String.Concat(ForwardSlash, zipItemName);
        }
        ...
        private bool IsZipItemValidOpcPartOrPiece(string zipItemName)
        {
            ...
            else
            {
                ...
                if (zipItemName.StartsWith(ForwardSlash, StringComparison.Ordinal))
                    return false;
                ...
                if (zipItemName.EndsWith(ForwardSlash, StringComparison.Ordinal))
                    return false;
                else
                    return true;
            }
        ...
        private const string ForwardSlash = "/"; //Required for creating a part name from a zip item name
