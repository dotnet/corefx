...
namespace System.Text.Json
{
    ...
    {
        /// <summary> Writes the pre-encoded property name and <see cref="DateTime"/> value (as a JSON string) as part of a name/value pair of a JSON object. </summary>
        ...
        /// <summary> Writes the property name and <see cref="DateTime"/> value (as a JSON string) as part of a name/value pair of a JSON object. </summary>
