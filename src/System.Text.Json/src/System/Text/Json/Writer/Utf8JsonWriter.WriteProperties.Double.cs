...
namespace System.Text.Json
{
    public ref partial struct Utf8JsonWriter
    {
        ...
        private void WriteNumberSuppressFalse(ReadOnlySpan<char> propertyName, double value)
        {
        ...
        private void WriteNumberSuppressFalse(ReadOnlySpan<byte> propertyName, double value)
        {
            int propertyIdx = JsonWriterHelper.NeedsEscaping(propertyName);
        ...
        private void WriteNumberEscapeProperty(ReadOnlySpan<byte> propertyName, double value, int firstEscapeIndexProp)
        {
            Debug.Assert(int.MaxValue / JsonConstants.MaxExpansionFactorWhileEscaping >= propertyName.Length);
        ...
        private void WriteNumberByOptions(ReadOnlySpan<byte> propertyName, double value)
        {
            ValidateWritingProperty();
            if (_writerOptions.Indented)
            {
