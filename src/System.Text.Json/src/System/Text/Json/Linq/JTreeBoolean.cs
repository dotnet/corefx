...
namespace System.Text.Json.Linq
{
    ...
    /// </summary>
    public sealed class JTreeBoolean : JTreeNode, IEquatable<JTreeBoolean>
    {
        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeBoolean"/> class representing the value <see langword="false"/>.
        /// </summary>
        public JTreeBoolean() => Value = false;

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeBoolean"/> class representing a specified value.
        /// </summary>
        public JTreeBoolean(bool value) => Value = value;
        ...
        /// </returns>
        public override bool Equals(object obj) => obj is JTreeBoolean jsonBoolean && Equals(jsonBoolean);
        ...
        ///   <see langword="false"/> otherwise.
        /// </returns>
        public bool Equals(JTreeBoolean other) => !(other is null) && Value == other.Value;
        ...
        ///   <see langword="false"/> otherwise.
        /// </returns>
        public static bool operator ==(JTreeBoolean left, JTreeBoolean right)
        {
        ...
        ///   <see langword="false"/> otherwise.
        /// </returns>
        public static bool operator !=(JTreeBoolean left, JTreeBoolean right) => !(left == right);
        ...
        public override JTreeNode Clone() => new JTreeBoolean(Value);
