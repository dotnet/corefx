...
namespace System.Text.Json.Linq
{
    ...
    /// </summary>
    public sealed class JTreeNumber : JTreeNode, IEquatable<JTreeNumber>
    {
        private string _value;

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class representing the value 0.
        /// </summary>
        public JTreeNumber() => _value = "0";

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class representing a specified value.
        /// </summary>
        ...
        public JTreeNumber(string value) => SetFormattedValue(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from a <see cref="byte"/> value.
        /// </summary>
        /// <param name="value">The value to represent as a JSON number.</param>
        public JTreeNumber(byte value) => SetByte(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from an <see cref="short"/> value.
        /// </summary>
        /// <param name="value">The value to represent as a JSON number.</param>
        public JTreeNumber(short value) => SetInt16(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from an <see cref="int"/> value.
        /// </summary>
        /// <param name="value">The value to represent as a JSON number.</param>
        public JTreeNumber(int value) => SetInt32(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from an <see cref="long"/> value.
        /// </summary>
        /// <param name="value">The value to represent as a JSON number.</param>
        public JTreeNumber(long value) => SetInt64(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from a <see cref="float"/> value.
        /// </summary>
        /// <param name="value">A value to represent as a JSON number.</param>
        /// <exception cref="ArgumentException">
        ///   Provided value is not in a legal JSON number format.
        /// </exception>
        public JTreeNumber(float value) => SetSingle(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from a <see cref="double"/> value.
        /// </summary>
        /// <param name="value">The value to represent as a JSON number.</param>
        /// <exception cref="ArgumentException">
        ///   Provided value is not in a legal JSON number format.
        /// </exception>
        public JTreeNumber(double value) => SetDouble(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from a <see cref="sbyte"/> value.
        /// </summary>
        /// <param name="value">The value to represent as a JSON number.</param>
        [CLSCompliant(false)]
        public JTreeNumber(sbyte value) => SetSByte(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from a <see cref="ushort"/> value.
        /// </summary>
        /// <param name="value">The value to represent as a JSON number.</param>
        [CLSCompliant(false)]
        public JTreeNumber(ushort value) => SetUInt16(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from a <see cref="uint"/> value.
        /// </summary>
        /// <param name="value">The value to represent as a JSON number.</param>
        [CLSCompliant(false)]
        public JTreeNumber(uint value) => SetUInt32(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from a <see cref="ulong"/> value.
        /// </summary>
        /// <param name="value">The value to represent as a JSON number.</param>
        [CLSCompliant(false)]
        public JTreeNumber(ulong value) => SetUInt64(value);

        /// <summary>
        ///   Initializes a new instance of the <see cref="JTreeNumber"/> class from a <see cref="decimal"/> value.
        /// </summary>
        /// <param name="value">The value to represent as a JSON number.</param>
        public JTreeNumber(decimal value) => SetDecimal(value);
        ...
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="byte.MinValue"/> or greater than <see cref="byte.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="byte"/>.
        /// </exception>
        ...
        /// <exception cref="OverflowException">
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="short.MinValue"/> or greater than <see cref="short.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="short"/>.
        /// </exception>
        ...
        /// <exception cref="OverflowException">
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="int.MinValue"/> or greater than <see cref="int.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="int"/>.
        /// </exception>
        ...
        /// <exception cref="OverflowException">
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="long.MinValue"/> or greater than <see cref="long.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="long"/>.
        /// </exception>
        ...
        /// <exception cref="OverflowException">
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="float.MinValue"/> or greater than <see cref="float.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="float"/>.
        /// </exception>
        /// <remarks>
        ...
        /// <exception cref="OverflowException">
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="double.MinValue"/> or greater than <see cref="double.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="double"/>.
        /// </exception>
        /// <remarks>
        ///   On .NET Core this method does not return <see langword="false"/> for values larger than
        ...
        /// <exception cref="OverflowException">
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="sbyte.MinValue"/> or greater than <see cref="sbyte.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="sbyte"/>.
        /// </exception>
        [CLSCompliant(false)]
        ...
        /// <exception cref="OverflowException">
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="ushort.MinValue"/> or greater than <see cref="ushort.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="ushort"/>.
        /// </exception>
        [CLSCompliant(false)]
        ...
        /// <exception cref="OverflowException">
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="uint.MinValue"/> or greater than <see cref="uint.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="uint"/>.
        /// </exception>
        [CLSCompliant(false)]
        ...
        /// <exception cref="OverflowException">
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="ulong.MinValue"/> or greater than <see cref="ulong.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="ulong"/>.
        /// </exception>
        [CLSCompliant(false)]
        ...
        /// <exception cref="OverflowException">
        ///   <see cref="JTreeNumber"/> represents a number less than <see cref="decimal.MinValue"/> or greater than <see cref="decimal.MaxValue"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   <see cref="JTreeNumber"/> represents a number in a format not compliant with <see cref="decimal"/>.
        /// </exception>
        ...
        /// </returns>
        public override bool Equals(object obj) => obj is JTreeNumber jsonNumber && Equals(jsonNumber);
        ...
        ///   <see langword="false"/> otherwise.
        /// </returns>
        public bool Equals(JTreeNumber other) => !(other is null) && _value == other._value;
        ...
        ///   <see langword="false"/> otherwise.
        /// </returns>
        public static bool operator ==(JTreeNumber left, JTreeNumber right)
        {
        ...
        ///   <see langword="false"/> otherwise.
        /// </returns>
        public static bool operator !=(JTreeNumber left, JTreeNumber right) => !(left == right);
        ...
        public override JTreeNode Clone() => new JTreeNumber(_value);
