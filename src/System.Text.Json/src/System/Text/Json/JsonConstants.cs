...
namespace System.Text.Json
{
    internal static class JsonConstants
    {
        ...
        public const int DateTimeParseNumFractionDigits = 15; // The maximum number of fraction digits the Json DateTime parser allows
        public const int MaximumDateTimeOffsetParseLength = (MaximumFormatDateTimeOffsetLength +
            (DateTimeParseNumFractionDigits - DateTimeNumFractionDigits)); // Like StandardFormat 'O' for DateTimeOffset, but allowing 8 additional (up to 15) fraction digits.
