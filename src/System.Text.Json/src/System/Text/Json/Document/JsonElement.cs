...
namespace System.Text.Json
{
    ...
    public readonly partial struct JsonElement
    {
        ...
        /// <remarks>
        ///  This method does not create a byte[] representation of values other than <see cref="Base64"/> encoded JSON strings.
        /// </remarks>
        /// <returns>
        ///   <see langword="true"/> if the entire token value is encoded as valid <see cref="Base64"/> text and can be successfully decoded to <see cref="Base64"/> bytes.
        ...
        ///   This method does not create a byte[] representation of values other than <see cref="Base64"/> encoded JSON strings.
        /// </remarks>
        /// <returns>The value decode as a bytes.</returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="Type"/> is not <see cref="JsonValueType.String"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ///   The value is not encoded as <see cref="Base64"/> text and hence cannot be decoded to bytes.
        /// </exception>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
