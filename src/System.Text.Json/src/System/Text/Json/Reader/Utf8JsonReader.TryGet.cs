...
namespace System.Text.Json
{
    public ref partial struct Utf8JsonReader
    {
        ...
        /// <summary>
        /// Reads the next JSON token value from the source and parses it to an <see cref="uint"/>.
        /// Returns the value if the entire UTF-8 encoded token value can be successfully parsed to an <see cref="uint"/>
        /// value.
        /// Throws exceptions otherwise.
        /// </summary>
        /// <exception cref="InvalidOperationException">
