...
namespace System.Text.Json
{
    public ref partial struct Utf8JsonReader
    {
        ...
        /// </exception>
        /// <exception cref="FormatException">
        /// On .NET Framework, thrown if the JSON token value represents a number less than <see cref="float.MinValue"/> or greater 
        ...
        /// </exception>
        /// <exception cref="FormatException">
        /// On .NET Framework, thrown if the JSON token value represents a number less than <see cref="double.MinValue"/> or greater 
