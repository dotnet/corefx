...
{
    public abstract class SetTime_str_dt : FileSystemTest
    {
        ...
        public virtual void PositiveTests()
        {
            ...
            test(new DateTime(2000, 1, 1, 1, 1, 1, 1, DateTimeKind.Unspecified));
            test(new DateTime(2020, 10, 20, 20, 30, 30, 500, DateTimeKind.Unspecified));
            test(new DateTime(2040, 12, 31, 23, 59, 59, 999, DateTimeKind.Unspecified));
            test(new DateTime(9999, 1, 1, 1, 1, 1, 1, DateTimeKind.Unspecified));
        }
