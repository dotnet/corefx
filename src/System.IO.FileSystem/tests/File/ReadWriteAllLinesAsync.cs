...
namespace System.IO.Tests
{
    public class File_ReadWriteAllLines_EnumerableAsync : FileSystemTest
    {
        ...
        {
            await Assert.ThrowsAsync<ArgumentNullException>(async () => await WriteAsync(null, new string[] {"Text"}));
            await Assert.ThrowsAsync<ArgumentException>(async () => await WriteAsync(string.Empty, new string[] {"Text"}));
            await Assert.ThrowsAsync<ArgumentNullException>(async () => await ReadAsync(null));
            await Assert.ThrowsAsync<ArgumentException>(async () => await ReadAsync(string.Empty));
        }
        ...
        public async Task NullLinesAsync()
        {
            ...
            await Assert.ThrowsAsync<ArgumentNullException>(async () => await WriteAsync(path, null));
    ...
    public class File_ReadWriteAllLines_Enumerable_EncodedAsync : File_ReadWriteAllLines_EnumerableAsync
    {
        ...
        {
            string path = GetTestFilePath();
            await Assert.ThrowsAsync<ArgumentNullException>(async () => await File.WriteAllLinesAsync(path, new string[] { "Text" }, null));
            await Assert.ThrowsAsync<ArgumentNullException>(async () => await File.ReadAllLinesAsync(path, null));
        }
