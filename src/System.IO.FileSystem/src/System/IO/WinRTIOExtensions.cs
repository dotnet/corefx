    ...
    internal static class WinRTIOExtensions
    {
        ...
        public static Exception TranslateWinRTException(this Exception exception, string filePath, bool isDirectory = false)
        {
            ...
            else
            {
                ...
                if (errorCode == Interop.ERROR_PATH_NOT_FOUND && filePath.Equals(Directory.InternalGetDirectoryRoot(filePath)))
                ...
                // WinRT remaps all ERROR_PATH_NOT_FOUND to ERROR_FILE_NOT_FOUND
                if (errorCode == Interop.ERROR_FILE_NOT_FOUND && filePath.Length > 0 && filePath[filePath.Length - 1] == Path.DirectorySeparatorChar)
                    errorCode = Interop.ERROR_PATH_NOT_FOUND;
            }
