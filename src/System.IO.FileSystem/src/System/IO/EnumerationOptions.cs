...
#endif
{
    public class EnumerationOptions
    {
        ...
        internal static EnumerationOptions Compatible
        {
            get
            {
                return new EnumerationOptions { MatchType = MatchType.Win32, AttributesToSkip = 0, IgnoreInaccessible = false, IsNormalized = false };
            }
        }
        ...
        private static EnumerationOptions CompatibleRecursive
        {
            get
            {
                return new EnumerationOptions { RecurseSubdirectories = true, MatchType = MatchType.Win32, AttributesToSkip = 0, IgnoreInaccessible = false, IsNormalized = false };
            }
        }
