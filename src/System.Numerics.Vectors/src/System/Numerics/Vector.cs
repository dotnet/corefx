...
namespace System.Numerics
{
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    public struct Vector<T> : IEquatable<Vector<T>>, IFormattable where T : struct
    {
        ...
        private static int _count = InitializeCount();

        /// <summary> 
        /// Returns a vector containing all zeroes. 
        /// </summary>
        [JitIntrinsic]
        public static Vector<T> Zero { get { return _zero; } }
        private static readonly Vector<T> _zero = new Vector<T>(GetZeroValue());

        /// <summary> 
        /// Returns a vector containing all ones. 
        /// </summary>
        [JitIntrinsic]
        public static Vector<T> One { get { return _one; } }
        private static readonly Vector<T> _one = new Vector<T>(GetOneValue());

        internal static Vector<T> AllOnes { get { return _allOnes; } }
        private static readonly Vector<T> _allOnes = new Vector<T>(GetAllBitsSetValue());
            ...
            : this()
        {
            if (Vector.IsHardwareAccelerated)
            {
                if (typeof(T) == typeof(Byte))
                {
                    fixed (Byte* basePtr = &this._register.byte_0)
                    {
                ...
                {
                    fixed (SByte* basePtr = &this._register.sbyte_0)
                    {
                        for (int g = 0; g < Count; g++)
                        {
                ...
                {
                    fixed (UInt16* basePtr = &this._register.uint16_0)
                    {
                        for (int g = 0; g < Count; g++)
                        {
                ...
                {
                    fixed (Int16* basePtr = &this._register.int16_0)
                    {
                        for (int g = 0; g < Count; g++)
                        {
                ...
                {
                    fixed (UInt32* basePtr = &this._register.uint32_0)
                    {
                        for (int g = 0; g < Count; g++)
                        {
                ...
                {
                    fixed (Int32* basePtr = &this._register.int32_0)
                    {
                        for (int g = 0; g < Count; g++)
                        {
                ...
                {
                    fixed (UInt64* basePtr = &this._register.uint64_0)
                    {
                        for (int g = 0; g < Count; g++)
                        {
                ...
                {
                    fixed (Int64* basePtr = &this._register.int64_0)
                    {
                        for (int g = 0; g < Count; g++)
                        {
                ...
                {
                    fixed (Single* basePtr = &this._register.single_0)
                    {
                        for (int g = 0; g < Count; g++)
                        {
                ...
                {
                    fixed (Double* basePtr = &this._register.double_0)
                    {
                        for (int g = 0; g < Count; g++)
                        {
...
#pragma warning disable 3001 // void* is not a CLS-Compliant argument type
            ...
            : this()
        {
            if (typeof(T) == typeof(Byte))
            {
                ...
                castedPtr += offset;
                fixed (Byte* registerBase = &this._register.byte_0)
                {
                    for (int g = 0; g < Count; g++)
                    {
            ...
            else if (typeof(T) == typeof(SByte))
            {
                ...
                castedPtr += offset;
                fixed (SByte* registerBase = &this._register.sbyte_0)
                {
                    for (int g = 0; g < Count; g++)
                    {
                        registerBase[g] = castedPtr[g];
            ...
            else if (typeof(T) == typeof(UInt16))
            {
                ...
                castedPtr += offset;
                fixed (UInt16* registerBase = &this._register.uint16_0)
                {
                    for (int g = 0; g < Count; g++)
                    {
                        registerBase[g] = castedPtr[g];
            ...
            else if (typeof(T) == typeof(Int16))
            {
                ...
                castedPtr += offset;
                fixed (Int16* registerBase = &this._register.int16_0)
                {
                    for (int g = 0; g < Count; g++)
                    {
                        registerBase[g] = castedPtr[g];
            ...
            else if (typeof(T) == typeof(UInt32))
            {
                ...
                castedPtr += offset;
                fixed (UInt32* registerBase = &this._register.uint32_0)
                {
                    for (int g = 0; g < Count; g++)
                    {
                        registerBase[g] = castedPtr[g];
            ...
            else if (typeof(T) == typeof(Int32))
            {
                ...
                castedPtr += offset;
                fixed (Int32* registerBase = &this._register.int32_0)
                {
                    for (int g = 0; g < Count; g++)
                    {
                        registerBase[g] = castedPtr[g];
            ...
            else if (typeof(T) == typeof(UInt64))
            {
                ...
                castedPtr += offset;
                fixed (UInt64* registerBase = &this._register.uint64_0)
                {
                    for (int g = 0; g < Count; g++)
                    {
                        registerBase[g] = castedPtr[g];
            ...
            else if (typeof(T) == typeof(Int64))
            {
                ...
                castedPtr += offset;
                fixed (Int64* registerBase = &this._register.int64_0)
                {
                    for (int g = 0; g < Count; g++)
                    {
                        registerBase[g] = castedPtr[g];
            ...
            else if (typeof(T) == typeof(Single))
            {
                ...
                castedPtr += offset;
                fixed (Single* registerBase = &this._register.single_0)
                {
                    for (int g = 0; g < Count; g++)
                    {
                        registerBase[g] = castedPtr[g];
            ...
            else if (typeof(T) == typeof(Double))
            {
                ...
                castedPtr += offset;
                fixed (Double* registerBase = &this._register.double_0)
                {
                    for (int g = 0; g < Count; g++)
                    {
                        registerBase[g] = castedPtr[g];
...
#pragma warning restore 3001 // void* is not a CLS-Compliant argument type
        ...
        {
            this._register = existingRegister;
        }
        ...
        public unsafe void CopyTo(T[] destination, int startIndex)
        {
            ...
            else
            {
                if (typeof(T) == typeof(Byte))
                {
                    ...
                    fixed (Byte* destinationBase = byteArray)
                    {
                        destinationBase[startIndex + 0] = this._register.byte_0;
                        destinationBase[startIndex + 1] = this._register.byte_1;
                        destinationBase[startIndex + 2] = this._register.byte_2;
                        destinationBase[startIndex + 3] = this._register.byte_3;
                        destinationBase[startIndex + 4] = this._register.byte_4;
                        destinationBase[startIndex + 5] = this._register.byte_5;
                        destinationBase[startIndex + 6] = this._register.byte_6;
                        destinationBase[startIndex + 7] = this._register.byte_7;
                        destinationBase[startIndex + 8] = this._register.byte_8;
                        destinationBase[startIndex + 9] = this._register.byte_9;
                        destinationBase[startIndex + 10] = this._register.byte_10;
                        destinationBase[startIndex + 11] = this._register.byte_11;
                        destinationBase[startIndex + 12] = this._register.byte_12;
                        destinationBase[startIndex + 13] = this._register.byte_13;
                        destinationBase[startIndex + 14] = this._register.byte_14;
                        destinationBase[startIndex + 15] = this._register.byte_15;
                    }
                }
                else if (typeof(T) == typeof(SByte))
                {
                    ...
                    fixed (SByte* destinationBase = sbyteArray)
                    {
                        destinationBase[startIndex + 0] = this._register.sbyte_0;
                        destinationBase[startIndex + 1] = this._register.sbyte_1;
                        destinationBase[startIndex + 2] = this._register.sbyte_2;
                        destinationBase[startIndex + 3] = this._register.sbyte_3;
                        destinationBase[startIndex + 4] = this._register.sbyte_4;
                        destinationBase[startIndex + 5] = this._register.sbyte_5;
                        destinationBase[startIndex + 6] = this._register.sbyte_6;
                        destinationBase[startIndex + 7] = this._register.sbyte_7;
                        destinationBase[startIndex + 8] = this._register.sbyte_8;
                        destinationBase[startIndex + 9] = this._register.sbyte_9;
                        destinationBase[startIndex + 10] = this._register.sbyte_10;
                        destinationBase[startIndex + 11] = this._register.sbyte_11;
                        destinationBase[startIndex + 12] = this._register.sbyte_12;
                        destinationBase[startIndex + 13] = this._register.sbyte_13;
                        destinationBase[startIndex + 14] = this._register.sbyte_14;
                        destinationBase[startIndex + 15] = this._register.sbyte_15;
                    }
                }
                else if (typeof(T) == typeof(UInt16))
                {
                    ...
                    fixed (UInt16* destinationBase = uint16Array)
                    {
                        destinationBase[startIndex + 0] = this._register.uint16_0;
                        destinationBase[startIndex + 1] = this._register.uint16_1;
                        destinationBase[startIndex + 2] = this._register.uint16_2;
                        destinationBase[startIndex + 3] = this._register.uint16_3;
                        destinationBase[startIndex + 4] = this._register.uint16_4;
                        destinationBase[startIndex + 5] = this._register.uint16_5;
                        destinationBase[startIndex + 6] = this._register.uint16_6;
                        destinationBase[startIndex + 7] = this._register.uint16_7;
                    }
                }
                else if (typeof(T) == typeof(Int16))
                {
                    ...
                    fixed (Int16* destinationBase = int16Array)
                    {
                        destinationBase[startIndex + 0] = this._register.int16_0;
                        destinationBase[startIndex + 1] = this._register.int16_1;
                        destinationBase[startIndex + 2] = this._register.int16_2;
                        destinationBase[startIndex + 3] = this._register.int16_3;
                        destinationBase[startIndex + 4] = this._register.int16_4;
                        destinationBase[startIndex + 5] = this._register.int16_5;
                        destinationBase[startIndex + 6] = this._register.int16_6;
                        destinationBase[startIndex + 7] = this._register.int16_7;
                    }
                }
                else if (typeof(T) == typeof(UInt32))
                {
                    ...
                    fixed (UInt32* destinationBase = uint32Array)
                    {
                        destinationBase[startIndex + 0] = this._register.uint32_0;
                        destinationBase[startIndex + 1] = this._register.uint32_1;
                        destinationBase[startIndex + 2] = this._register.uint32_2;
                        destinationBase[startIndex + 3] = this._register.uint32_3;
                    }
                }
                else if (typeof(T) == typeof(Int32))
                {
                    ...
                    fixed (Int32* destinationBase = int32Array)
                    {
                        destinationBase[startIndex + 0] = this._register.int32_0;
                        destinationBase[startIndex + 1] = this._register.int32_1;
                        destinationBase[startIndex + 2] = this._register.int32_2;
                        destinationBase[startIndex + 3] = this._register.int32_3;
                    }
                }
                else if (typeof(T) == typeof(UInt64))
                {
                    ...
                    fixed (UInt64* destinationBase = uint64Array)
                    {
                        destinationBase[startIndex + 0] = this._register.uint64_0;
                        destinationBase[startIndex + 1] = this._register.uint64_1;
                    }
                }
                else if (typeof(T) == typeof(Int64))
                {
                    ...
                    fixed (Int64* destinationBase = int64Array)
                    {
                        destinationBase[startIndex + 0] = this._register.int64_0;
                        destinationBase[startIndex + 1] = this._register.int64_1;
                    }
                }
                else if (typeof(T) == typeof(Single))
                {
                    ...
                    fixed (Single* destinationBase = singleArray)
                    {
                        destinationBase[startIndex + 0] = this._register.single_0;
                        destinationBase[startIndex + 1] = this._register.single_1;
                        destinationBase[startIndex + 2] = this._register.single_2;
                        destinationBase[startIndex + 3] = this._register.single_3;
                    }
                }
                else if (typeof(T) == typeof(Double))
                {
                    ...
                    fixed (Double* destinationBase = doubleArray)
                    {
                        destinationBase[startIndex + 0] = this._register.double_0;
                        destinationBase[startIndex + 1] = this._register.double_1;
                    }
                }
            }
        }
        ...
        public bool Equals(Vector<T> other)
        {
            ...
            else
            {
                ...
                {
                    return
                        this._register.byte_0 == other._register.byte_0
                        && this._register.byte_1 == other._register.byte_1
                        && this._register.byte_2 == other._register.byte_2
                        && this._register.byte_3 == other._register.byte_3
                        && this._register.byte_4 == other._register.byte_4
                        && this._register.byte_5 == other._register.byte_5
                        && this._register.byte_6 == other._register.byte_6
                        && this._register.byte_7 == other._register.byte_7
                        && this._register.byte_8 == other._register.byte_8
                        && this._register.byte_9 == other._register.byte_9
                        && this._register.byte_10 == other._register.byte_10
                        && this._register.byte_11 == other._register.byte_11
                        && this._register.byte_12 == other._register.byte_12
                        && this._register.byte_13 == other._register.byte_13
                        && this._register.byte_14 == other._register.byte_14
                        && this._register.byte_15 == other._register.byte_15;
                }
                else if (typeof(T) == typeof(SByte))
                {
                    return
                        this._register.sbyte_0 == other._register.sbyte_0
                        && this._register.sbyte_1 == other._register.sbyte_1
                        && this._register.sbyte_2 == other._register.sbyte_2
                        && this._register.sbyte_3 == other._register.sbyte_3
                        && this._register.sbyte_4 == other._register.sbyte_4
                        && this._register.sbyte_5 == other._register.sbyte_5
                        && this._register.sbyte_6 == other._register.sbyte_6
                        && this._register.sbyte_7 == other._register.sbyte_7
                        && this._register.sbyte_8 == other._register.sbyte_8
                        && this._register.sbyte_9 == other._register.sbyte_9
                        && this._register.sbyte_10 == other._register.sbyte_10
                        && this._register.sbyte_11 == other._register.sbyte_11
                        && this._register.sbyte_12 == other._register.sbyte_12
                        && this._register.sbyte_13 == other._register.sbyte_13
                        && this._register.sbyte_14 == other._register.sbyte_14
                        && this._register.sbyte_15 == other._register.sbyte_15;
                }
                else if (typeof(T) == typeof(UInt16))
                {
                    return
                        this._register.uint16_0 == other._register.uint16_0
                        && this._register.uint16_1 == other._register.uint16_1
                        && this._register.uint16_2 == other._register.uint16_2
                        && this._register.uint16_3 == other._register.uint16_3
                        && this._register.uint16_4 == other._register.uint16_4
                        && this._register.uint16_5 == other._register.uint16_5
                        && this._register.uint16_6 == other._register.uint16_6
                        && this._register.uint16_7 == other._register.uint16_7;
                }
                else if (typeof(T) == typeof(Int16))
                {
                    return
                        this._register.int16_0 == other._register.int16_0
                        && this._register.int16_1 == other._register.int16_1
                        && this._register.int16_2 == other._register.int16_2
                        && this._register.int16_3 == other._register.int16_3
                        && this._register.int16_4 == other._register.int16_4
                        && this._register.int16_5 == other._register.int16_5
                        && this._register.int16_6 == other._register.int16_6
                        && this._register.int16_7 == other._register.int16_7;
                }
                else if (typeof(T) == typeof(UInt32))
                {
                    return
                        this._register.uint32_0 == other._register.uint32_0
                        && this._register.uint32_1 == other._register.uint32_1
                        && this._register.uint32_2 == other._register.uint32_2
                        && this._register.uint32_3 == other._register.uint32_3;
                }
                else if (typeof(T) == typeof(Int32))
                {
                    return
                        this._register.int32_0 == other._register.int32_0
                        && this._register.int32_1 == other._register.int32_1
                        && this._register.int32_2 == other._register.int32_2
                        && this._register.int32_3 == other._register.int32_3;
                }
                else if (typeof(T) == typeof(UInt64))
                {
                    return
                        this._register.uint64_0 == other._register.uint64_0
                        && this._register.uint64_1 == other._register.uint64_1;
                }
                else if (typeof(T) == typeof(Int64))
                {
                    return
                        this._register.int64_0 == other._register.int64_0
                        && this._register.int64_1 == other._register.int64_1;
                }
                else if (typeof(T) == typeof(Single))
                {
                    return
                        this._register.single_0 == other._register.single_0
                        && this._register.single_1 == other._register.single_1
                        && this._register.single_2 == other._register.single_2
                        && this._register.single_3 == other._register.single_3;
                }
                else if (typeof(T) == typeof(Double))
                {
                    return
                        this._register.double_0 == other._register.double_0
                        && this._register.double_1 == other._register.double_1;
                }
                else
                {
                    throw new NotSupportedException(SR.GetString("Arg_TypeNotSupported", typeof(T)));
        ...
        public override int GetHashCode()
        {
            ...
            else
            {
                if (typeof(T) == typeof(Byte))
                {
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_0.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_1.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_2.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_3.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_4.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_5.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_6.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_7.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_8.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_9.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_10.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_11.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_12.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_13.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_14.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.byte_15.GetHashCode());
                    return hash;
                }
                else if (typeof(T) == typeof(SByte))
                {
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_0.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_1.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_2.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_3.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_4.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_5.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_6.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_7.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_8.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_9.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_10.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_11.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_12.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_13.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_14.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.sbyte_15.GetHashCode());
                    return hash;
                }
                else if (typeof(T) == typeof(UInt16))
                {
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint16_0.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint16_1.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint16_2.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint16_3.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint16_4.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint16_5.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint16_6.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint16_7.GetHashCode());
                    return hash;
                }
                else if (typeof(T) == typeof(Int16))
                {
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int16_0.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int16_1.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int16_2.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int16_3.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int16_4.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int16_5.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int16_6.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int16_7.GetHashCode());
                    return hash;
                }
                else if (typeof(T) == typeof(UInt32))
                {
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint32_0.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint32_1.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint32_2.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint32_3.GetHashCode());
                    return hash;
                }
                else if (typeof(T) == typeof(Int32))
                {
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int32_0.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int32_1.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int32_2.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int32_3.GetHashCode());
                    return hash;
                }
                else if (typeof(T) == typeof(UInt64))
                {
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint64_0.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.uint64_1.GetHashCode());
                    return hash;
                }
                else if (typeof(T) == typeof(Int64))
                {
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int64_0.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.int64_1.GetHashCode());
                    return hash;
                }
                else if (typeof(T) == typeof(Single))
                {
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.single_0.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.single_1.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.single_2.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.single_3.GetHashCode());
                    return hash;
                }
                else if (typeof(T) == typeof(Double))
                {
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.double_0.GetHashCode());
                    hash = HashCodeHelper.CombineHashCodes(hash, this._register.double_1.GetHashCode());
                    return hash;
                }
                else
                {
