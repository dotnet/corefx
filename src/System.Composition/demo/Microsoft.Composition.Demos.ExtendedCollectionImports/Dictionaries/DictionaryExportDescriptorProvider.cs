...
namespace Microsoft.Composition.Demos.ExtendedCollectionImports.Dictionaries
{
    public class DictionaryExportDescriptorProvider : ExportDescriptorProvider
    {
        ...
        private static readonly MethodInfo _GetDictionaryDefinitionsMethod = typeof(DictionaryExportDescriptorProvider).GetTypeInfo().GetDeclaredMethod("GetDictionaryDefinition");
        ...
        public override IEnumerable<ExportDescriptorPromise> GetExportDescriptors(CompositionContract contract, DependencyAccessor descriptorAccessor)
        {
            ...
            var gdd = _GetDictionaryDefinitionsMethod.MakeGenericMethod(keyType, valueType);
