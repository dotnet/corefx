            ...
            else
            {
                ...
                if (metadataViewType.IsInterface)
                {
                    if(!metadataViewType.IsAttributeDefined<MetadataViewImplementationAttribute>())
                    {
                        ...
                        {
                            throw new NotSupportedException(SR.Format(CultureInfo.CurrentCulture, SR.NotSupportedInterfaceMetadataView, metadataViewType.FullName), ex);
                        }
                    }
                    else
                    {
                        ...
                        if(proxyType == null)
                        {
                            throw new CompositionContractMismatchException(SR.Format(CultureInfo.CurrentCulture, 
