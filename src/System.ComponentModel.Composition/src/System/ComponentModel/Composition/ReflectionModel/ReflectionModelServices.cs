...
namespace System.ComponentModel.Composition.ReflectionModel
{
    public static class ReflectionModelServices
    {
        ...
        public static LazyMemberInfo GetExportingMember(ExportDefinition exportDefinition)
        {
            ...
            if (reflectionExportDefinition == null)
            {
                throw new ArgumentException(
                    SR.Format(CultureInfo.CurrentCulture, SR.ReflectionModel_InvalidExportDefinition, exportDefinition.GetType()),
        ...
        public static LazyMemberInfo GetImportingMember(ImportDefinition importDefinition)
        {
            ...
            {
                throw new ArgumentException(
                    SR.Format(CultureInfo.CurrentCulture, SR.ReflectionModel_InvalidMemberImportDefinition, importDefinition.GetType()),
        ...
        public static Lazy<ParameterInfo> GetImportingParameter(ImportDefinition importDefinition)
        {
            ...
            {
                throw new ArgumentException(
                    SR.Format(CultureInfo.CurrentCulture, SR.ReflectionModel_InvalidParameterImportDefinition, importDefinition.GetType()),
                    nameof(importDefinition));
            }
        ...
        public static bool IsImportingParameter(ImportDefinition importDefinition)
        {
            ...
            {
                throw new ArgumentException(
                    SR.Format(CultureInfo.CurrentCulture, SR.ReflectionModel_InvalidImportDefinition, importDefinition.GetType()),
                    nameof(importDefinition));
            }
...
internal class ReflectionPartCreationInfo : IReflectionPartCreationInfo
    {
            ...
            foreach (ExportDefinition export in exports)
            {
                ...
                if (reflectionExport == null)
                {
                    throw new InvalidOperationException(
                        SR.Format(CultureInfo.CurrentCulture, SR.ReflectionModel_InvalidExportDefinition, export.GetType()));
                }
        ...
        public IEnumerable<ImportDefinition> GetImports()
        {
            ...
            foreach (ImportDefinition import in imports)
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.Format(CultureInfo.CurrentCulture, SR.ReflectionModel_InvalidMemberImportDefinition, import.GetType()));
                }
