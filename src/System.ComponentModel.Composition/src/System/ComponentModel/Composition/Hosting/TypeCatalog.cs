    ...
    public class TypeCatalog : ComposablePartCatalog, ICompositionElement
    {
        ...
        private void InitializeTypeCatalog(IEnumerable<Type> types, ReflectionContext reflectionContext)
        {
            ...
            foreach (var type in types)
            {
                ...
                {
                    throw new ArgumentException(SR.Format(CultureInfo.CurrentCulture, SR.Argument_ElementReflectionOnlyType, nameof(types)), nameof(types));
                }
                ...
                if (lclType != null)
                {
                    ...
                    {
                        throw new ArgumentException(SR.Format(CultureInfo.CurrentCulture, SR.Argument_ReflectionContextReturnsReflectionOnlyType, nameof(reflectionContext)), nameof(reflectionContext));
                    }
