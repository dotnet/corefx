...
{
    /// <summary> Specifies <see cref="CreationPolicy"/> for a given <see cref="Primitives.ComposablePart" />. </summary>
    ...
    public sealed class PartCreationPolicyAttribute : Attribute
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PartCreationPolicyAttribute"/> class. </summary>
        public PartCreationPolicyAttribute(CreationPolicy creationPolicy)
        {
            CreationPolicy = creationPolicy;
        }

        /// <summary> Gets or sets a value indicating the creation policy of the attributed part. </summary>
        /// <value>
