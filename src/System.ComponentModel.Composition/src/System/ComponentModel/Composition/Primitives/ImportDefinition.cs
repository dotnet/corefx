...
namespace System.ComponentModel.Composition.Primitives
{
    ...
    public class ImportDefinition
    {
        ...
        internal ImportDefinition(string contractName, ImportCardinality cardinality, bool isRecomposable, bool isPrerequisite, IDictionary<string, object> metadata)
        {
            ...
            {
                throw new ArgumentException(SR.Format(CultureInfo.CurrentCulture, SR.ArgumentOutOfRange_InvalidEnum, nameof(cardinality), cardinality, typeof(ImportCardinality).Name), nameof(cardinality));
            }
