...
namespace Microsoft.Internal
{
    internal static partial class Requires
    {
        ...
        public static void IsInMembertypeSet(MemberTypes value, string parameterName, MemberTypes enumFlagSet)
        {
            ...
            {
                throw new ArgumentException(SR.Format(CultureInfo.CurrentCulture, SR.ArgumentOutOfRange_InvalidEnumInSet, parameterName, value, enumFlagSet.ToString()), parameterName);
            }
            Contract.EndContractBlock();
        }
        ...
        public static void NotNullOrEmpty(string value, string parameterName)
        {
            ...
            if (value.Length == 0)
            {
                throw new ArgumentException(SR.Format(CultureInfo.CurrentCulture, SR.ArgumentException_EmptyString, parameterName), parameterName);
            }
        }
