...
namespace System.UnitTesting
{
    ...
    {
        /// <summary> Verifies that the exception has the default message generated by the base Exception class. </summary>
        ...
        /// <summary> Verifies that the specified action throws an exception of type <typeparam name="T"/>. </summary>
        ...
        /// <summary> Verifies that the specified action throws an ObjectDisposedException. </summary>
