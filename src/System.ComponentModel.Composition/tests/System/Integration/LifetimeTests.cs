...
namespace Tests.Integration
{
    public class LifetimeTests
    {
        ...
        public void NonSharedPart_RecomposableImport_WithReference_ShouldNotBeCollected()
        {
            ...
            Assert.Equal(42, exportedValue.Value); // "Value should have been recomposed");
        ...
        public void NonSharedPart_DisposableRecomposabeImport_NoReference_ShouldNotBeCollected()
        {
            ...
            Assert.Equal(42, exportedValue.Value); // "Value shoudl ahve been recomposed.");
        ...
        public void NonSharedPart_TwoRecomposablePartsSameExportedValue()
        {
            ...
            Assert.Equal(export1.MyInstanceNumber, export2.MyInstanceNumber); // "Should be the same shared object!");
        }
...
[Fact]
        ...
        public void GetReleaseExport_NonSharedPart_ShouldNotRecomposeAfterRelease()
        {
            ...
            Assert.Equal(21, exportedValue.Value); // "Value should not be recomposed after ReleaseExport is called on it.");
        }
