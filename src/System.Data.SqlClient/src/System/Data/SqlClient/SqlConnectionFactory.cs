            ...
            if (opt.UserInstance)
            {
                ...
                { // Non-pooled or pooled and no connections in the pool.
                    ...
                    try
                    {
                        ...
                        //       of the UserInstance.
                        SqlConnectionString sseopt = new SqlConnectionString(opt, opt.DataSource, true /* user instance=true */, false);
                ...
                opt = new SqlConnectionString(opt, instanceName, false /* user instance=false */, null);
