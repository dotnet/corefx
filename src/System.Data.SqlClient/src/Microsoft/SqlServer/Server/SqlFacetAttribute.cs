...
namespace Microsoft.SqlServer.Server
{
    ...
    {
        /// <summary> Is this a fixed size field? </summary>
        ...
        /// <summary> Precision, only valid for numeric types. </summary>
        public int Precision { get; set; }

        /// <summary> Scale, only valid for numeric types. </summary>
        public int Scale { get; set; }

        /// <summary> Is this field nullable? </summary>
