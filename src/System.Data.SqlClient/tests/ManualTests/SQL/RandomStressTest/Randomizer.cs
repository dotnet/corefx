...
namespace System.Data.SqlClient.ManualTesting.Tests
{
    ...
    {
        /// <summary> counter used to prevent same seed generation for multi-threaded operations </summary>
        ...
        /// <summary> encapsulate the randomizer state which is a byte array within the read-only structure </summary>
        ...
        public struct State
        {
            ...
            /// <summary> recreates the state instance from string, generated by ToString() </summary>
            ...
            /// <summary> represents an empty randomizer state, it cannot be used to create a randomizer! </summary>
        ...
        /// <summary> Used to create an instance of randomizer from its state. Use Create static method to create the instance. </summary>
        ...
        /// <summary> returns size needed to serialize the randomizer state, override this method to reserve space for custom fields. </summary>
        ...
        /// <summary> this method is used to serialize the state, binState size must be BinaryStateSize </summary>
        /// <remarks>
        ...
        /// <summary> this method is used to deserialize the randomizer from its binary state, binState size is BinaryStateSize </summary>
        /// <remarks>
        ...
        /// <summary> helper method to serialize int field </summary>
        ...
        /// <summary> helper method to deserialize int field </summary>
        ...
        /// <summary> use this method to create seeds for nested randomizers out of current one </summary>
        public int NextSeed()
        {
            return Next();
        }
