...
namespace System.Data.SqlClient.ManualTesting.Tests
{
    public class ConnectionPoolWrapper
    {
        ...
        /// <summary> Finds the connection pool for the given internal connection </summary>
        ...
        /// <summary> The number of connections in this connection pool (free + non-free; including transaction pools) </summary>
        public int ConnectionCount
        { get { return ConnectionPoolHelper.CountConnectionsInPool(_connectionPool); } }

        /// <summary> Counts the number of free connection in the pool (excluding any transaction pools) </summary>
        public int FreeConnectionCount
        { get { return ConnectionPoolHelper.CountFreeConnections(_connectionPool); } }

        /// <summary> The connection string associated with this connection pool </summary>
        public string ConnectionString { get; private set; }

        /// <summary> Creates a list of all connection pools </summary>
        ...
        /// <summary> Invokes the cleanup timer code </summary>
        public void Cleanup()
        {
            ConnectionPoolHelper.CleanConnectionPool(_connectionPool);
        }

        /// <summary> Checks if the SqlConnection specified has an internal connection that belongs to this pool </summary>
        ...
        /// <summary> Checks if this wrapper wraps the same pool as another wrapper </summary>
