...
{
    /// <summary> Wrapper for security functions that implement SSPI </summary>
    internal class SecurityWrapper
    {
        /// <summary> Acquires a handle to preexisting credentials of a security principal </summary>
        ...
        /// <summary> The InitializeSecurityContext (Schannel) function initiates the client side, outbound security context from a credential handle. </summary>
        ...
        /// <summary> The CompleteAuthToken function completes an authentication token </summary>
        ...
        /// <summary> The AcceptSecurityContext (Negotiate) function enables the server component of a transport application to establish a security context between the server and a remote client </summary>
        ...
        /// <summary> The FreeCredentialsHandle function notifies the security system that the credentials are no longer needed </summary>
        ...
        /// <summary> The FreeContextBuffer function enables callers of security package functions to free memory buffers allocated by the security package. </summary>
