...
{
    /// <summary> Security package info </summary>
    [StructLayout(LayoutKind.Sequential)]
    internal struct SecPkgInfo
    {
        /// <summary> Set of bit flags that describes the capabilities of the security package </summary>
        public uint Capabilities;

        /// <summary> Specifies the version of the package protocol. Must be 1. </summary>
        public ushort Version;

        /// <summary> Specifies a DCE RPC identifier, if appropriate </summary>
        public ushort RPCID;
