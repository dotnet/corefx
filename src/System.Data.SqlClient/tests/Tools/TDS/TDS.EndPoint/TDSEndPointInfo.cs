...
{
    /// <summary> Container of the connection end-point information </summary>
    public class TDSEndPointInfo
    {
        /// <summary> IP address to/from which connection is established </summary>
        public IPAddress Address { get; internal set; }

        /// <summary> Port number </summary>
        public int Port { get; internal set; }

        /// <summary> Transport protocol for the end-point </summary>
