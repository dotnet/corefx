...
{
    /// <summary> Interface that enables partial, sequential and continuable object inflation </summary>
    public interface IInflatable
    {
        /// <summary> Inflate the object using the next available chunk of byte stream </summary>
