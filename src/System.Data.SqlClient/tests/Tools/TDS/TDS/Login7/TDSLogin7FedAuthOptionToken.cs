...
{
    /// <summary> The Federated authentication library type. </summary>
    ...
    public class TDSLogin7FedAuthOptionToken : TDSLogin7FeatureOptionToken
    {
        ...
        /// <summary> Federated Authentication option length </summary>
        public uint Length
        {
            get
            {
        ...
        /// <summary> Federated authentication library. </summary>
        public TDSFedAuthLibraryType Library { get; private set; }

        /// <summary> FedAuthEcho: The intention of this flag is for the client to echo the server's FEDAUTHREQUIRED prelogin option. </summary>
        public TdsPreLoginFedAuthRequiredOption Echo { get; private set; }

        /// <summary> Whether this protocol is requesting further information from server to perform authentication. </summary>
        public bool IsRequestingAuthenticationInfo { get; private set; }

        /// <summary> Federated authentication token generated by the specified federated authentication library. </summary>
        public byte[] Token { get; private set; }

        /// <summary> The nonce provided by the server during prelogin exchange </summary>
        public byte[] Nonce { get; private set; }

        /// <summary> Channel binding token associated with the underlying SSL stream. </summary>
        ...
        /// <summary> Read the stream for IDCRL based login </summary>
        ...
        /// <summary> Read the stream for SecurityToken based login </summary>
        /// <param name="source">source</param>
        /// <param name="optionDataLength">option data length</param>
