...
{
    /// <summary> Flags that indicate fSQLType bit of LOGIN 7 options </summary>
    ...
    /// <summary> Flags that indicate fOLEDB bit of LOGIN 7 options </summary>
    ...
    /// <summary> Flags that indicate fReadOnlyIntent bit of LOGIN 7 options </summary>
    ...
    /// <summary> Structure of the flags 3 </summary>
    public class TDSLogin7TokenTypeFlags
    {
        /// <summary> The type of SQL the client sends to the server </summary>
        public TDSLogin7TypeFlagsSQL SQL { get; set; }

        /// <summary> Set if the client is the OLEDB driver </summary>
        public TDSLogin7TypeFlagsOleDb OleDb { get; set; }

        /// <summary> Application intent </summary>
