...
{
    /// <summary> Flags that indicate fChangePassword bit of LOGIN 7 options </summary>
    ...
    /// <summary> Flags that indicate fUnknownCollationHandling bit of LOGIN 7 options </summary>
    ...
    public class TDSLogin7TokenOptionalFlags3
    {
        ...
        /// <summary> Client is requesting separate process to be spawned as user instance </summary>
        public bool IsUserInstance { get; set; }

        /// <summary> Send Yukon binary XML. </summary>
        public bool SendYukonBinaryXML { get; set; }

        /// <summary> Unknown collection handling </summary>
        public TDSLogin7OptionalFlags3Collation UnknownCollation { get; set; }

        /// <summary> Feature extension flag. </summary>
