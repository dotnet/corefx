...
{
    /// <summary> Flags that indicate fLanguage bit of LOGIN 7 options </summary>
    ...
    /// <summary> Flags that indicate fODBC bit of LOGIN 7 options </summary>
    ...
    /// <summary> Flags that indicate fUserType bit of LOGIN 7 options </summary>
    ...
    /// <summary> Flags that indicate fIntSecurity bit of LOGIN 7 options </summary>
    ...
    {
        /// <summary> Set if the change to initial language must succeed if the connect is to succeed </summary>
        public TDSLogin7OptionalFlags2Language Language { get; set; }

        /// <summary> Set if the client is the ODBC driver. </summary>
        public TDSLogin7OptionalFlags2Odbc Odbc { get; set; }

        /// <summary> The type of user connecting to the server </summary>
        public TDSLogin7OptionalFlags2UserType UserType { get; set; }

        /// <summary> The type of security required by the client </summary>
