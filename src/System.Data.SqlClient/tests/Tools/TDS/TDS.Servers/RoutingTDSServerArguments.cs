...
{
    /// <summary> Arguments for routing TDS Server </summary>
    public class RoutingTDSServerArguments : TDSServerArguments
    {
        /// <summary> Routing destination protocol </summary>
        public int RoutingProtocol { get; set; }

        /// <summary> Routing TCP port </summary>
        public ushort RoutingTCPPort { get; set; }

        /// <summary> Routing TCP host name </summary>
        public string RoutingTCPHost { get; set; }

        /// <summary> Packet on which routing should occur </summary>
        public TDSMessageType RouteOnPacket { get; set; }

        /// <summary> Indicates that routing should only occur on read-only connections </summary>
