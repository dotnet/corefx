...
{
    /// <summary> Common arguments for TDS Server </summary>
    public class TDSServerArguments
    {
        /// <summary> Service Principal Name, representing Azure SQL Database in Azure Active Directory. </summary>
        public const string AzureADServicePrincipalName = @"https://database.windows.net/";

        /// <summary> The Azure Active Directory production token endpoint to re-direct the client to fetch a token from. </summary>
