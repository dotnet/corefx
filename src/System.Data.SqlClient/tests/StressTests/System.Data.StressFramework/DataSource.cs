...
{
    /// <summary> supported source types - values for 'type' attribute for 'source' node in App.config </summary>
    ...
    {
        /// <summary> name of the source - can be used in command line: StressTest ... -override source "sourcename" </summary>
        public readonly string Name;

        /// <summary> database type </summary>
        public readonly DataSourceType Type;

        /// <summary> whether this source is the default one for the type specified </summary>
        public readonly bool IsDefault;

        /// <summary> constructs new data source - called by derived class c-tors only (thus protected) </summary>
        ...
        /// <summary> this method is used to create the data source, based on its type </summary>
        ...
        /// <summary> used by GetRequiredAttributeValue or derived classes to construct exception on missing required attribute </summary>
        ...
        /// <summary> search for required attribute or fail if not found </summary>
        ...
        /// <summary> search for optional attribute or return default vale </summary>
    ...
    /// <summary> Represents SQL Server data source. This source is used by SqlClient as well as by ODBC and OLEDB when connecting to SQL with SNAC or MDAC/WDAC </summary>
    /// <example>
    ///       <source
    ///        name="mysrv01"
    ///        type="SqlServer"
