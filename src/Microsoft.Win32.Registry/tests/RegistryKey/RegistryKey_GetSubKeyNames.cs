...
{
    public class RegistryKey_GetSubKeyNames : IDisposable
    {
        // Variables needed
        private RegistryKey _rk1, _rk2;
        private int _iCount = 0;
        private string _testKeyName = "REG_TEST_8";
        ...
        public void Test03()
        {
            ...
            if (!_rk1.OpenSubKey(_testKeyName).GetSubKeyNames()[0].Equals("BLAH"))
            {
        ...
        public void Test05()
        {
            ...
            _rk2 = _rk1.CreateSubKey(_testKeyName);
            if (_rk2.GetSubKeyNames().Length != 0)
            {
                Assert.False(true, "Error Expected zero Length array");
            }
            _rk1.DeleteSubKeyTree(_testKeyName);
        }
