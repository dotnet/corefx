...
namespace Microsoft.Win32.RegistryTests
{
    public class RegistryKey_OpenSubKey_str_rkpc_rr : RegistryKeyOpenSubKeyTestsBase
    {
        ...
        public void NegativeTests()
        {
            ...
            AssertExtensions.Throws<ArgumentException>("name", () => TestRegistryKey.OpenSubKey(new string('a', 256), RegistryKeyPermissionCheck.Default, rights: RegistryRights.FullControl));
