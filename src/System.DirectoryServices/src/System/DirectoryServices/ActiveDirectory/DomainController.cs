    ...
    public class DomainController : DirectoryServer
    {
        ...
        public void SeizeRoleOwnership(ActiveDirectoryRole role)
        {
            ...
            try
            {
                ...
                {
                    System.DirectoryServices.InteropInternal.UnsafeNativeMethods.IADsLargeInteger ridPool = (System.DirectoryServices.InteropInternal.UnsafeNativeMethods.IADsLargeInteger)roleObjectEntry.Properties[PropertyManager.RIDAvailablePool].Value;
