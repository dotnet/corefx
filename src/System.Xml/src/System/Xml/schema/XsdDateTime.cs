...
namespace System.Xml.Schema
{
    ...
    internal struct XsdDateTime
    {
        ...
        public XsdDateTime(string text, XsdDateTimeFlags kinds) : this()
        {
            ...
            {
                throw new FormatException(string.Format(SR.XmlConvert_BadFormat, text, kinds));
            }
        ...
        public static int Compare(XsdDateTime left, XsdDateTime right)
        {
            ...
            else
            {
                ...
                {
                    throw new ArgumentException(string.Format(SR.Sch_XsdDateTimeCompare, left.TypeCode, right.TypeCode));
                }
                // Convert both to UTC
