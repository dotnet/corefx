    ...
    public class XmlEntityReference : XmlLinkedNode
    {
        ...
        protected internal XmlEntityReference(string name, XmlDocument doc) : base(doc)
        {
            if (!doc.IsLoading)
            {
                ...
                {
                    throw new ArgumentException(string.Format(Res.Xdom_InvalidCharacter_EntityReference));
                }
            }
        ...
        public override String Value
        {
            ...
            set
            {
                throw new InvalidOperationException(string.Format(Res.Xdom_EntRef_SetVal));
            }
        }
