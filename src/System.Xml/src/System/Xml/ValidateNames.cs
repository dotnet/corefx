...
namespace System.Xml
{
    ...
    internal static class ValidateNames
    {
...
#else
                throw new XmlException(string.Format(Res.Xml_EmptyName, string.Empty));
#endif
...
#else
                throw new XmlException(string.Format(Res.Xml_BadStartNameChar, XmlExceptionHelper.BuildCharExceptionArgs(s, offsetBadChar)));
#endif
            }
            else
            {
...
#else
                throw new XmlException(string.Format(Res.Xml_BadNameChar, XmlExceptionHelper.BuildCharExceptionArgs(s, offsetBadChar)));
#endif
            }
        }
        ...
        internal static void SplitQName(string name, out string prefix, out string lname)
        {
            ...
            {
#if !SILVERLIGHT_XPATH
                throw new ArgumentException(string.Format(Res.Xml_BadNameChar, XmlException.BuildCharExceptionArgs(':', '\0')), "name");
#else
                throw new ArgumentException(string.Format(Res.Xml_BadNameChar, XmlExceptionHelper.BuildCharExceptionArgs(':', '\0')), "name");
#endif
            }
            else
            {
