...
namespace System.Xml.Serialization
{
    ...
    internal class XmlCustomFormatter
    {
        ...
        internal static string FromDefaultValue(object value, string formatter)
        {
            ...
            throw new Exception(string.Format(Res.XmlUnsupportedDefaultType, type.FullName));
        }
        ...
        internal static string FromEnum(long val, string[] vals, long[] ids, string typeName)
        {
                ...
                if (ids.Length != vals.Length) throw new InvalidOperationException(string.Format(Res.XmlInternalErrorDetails, "Invalid enum"));
#endif
            ...
            if (val != 0)
            {
                ...
                throw new InvalidOperationException(string.Format(Res.XmlUnknownConstant, originalValue, typeName == null ? "enum" : typeName));
            }
        ...
        internal static object ToDefaultValue(string value, string formatter)
        {
            ...
            throw new Exception(string.Format(Res.XmlUnsupportedDefaultValue, formatter));
        ...
        internal static long ToEnum(string val, Hashtable vals, string typeName, bool validate)
        {
            ...
            for (int i = 0; i < parts.Length; i++)
            {
                ...
                if (id != null)
                    ...
                    throw new InvalidOperationException(string.Format(Res.XmlUnknownConstant, parts[i], typeName));
            }
            return value;
        }
