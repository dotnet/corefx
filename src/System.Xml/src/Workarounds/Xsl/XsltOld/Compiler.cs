...
namespace System.Xml.Xsl.XsltOld
{
    ...
    internal class Compiler
    {
        ...
        {
            return (
                lang == ScriptingLanguage.JScript ? (CodeDomProvider)Activator.CreateInstance(Type.GetType("Microsoft.JScript.JScriptCodeProvider, " + AssemblyRef.MicrosoftJScript), BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, null, null) :
#if !FEATURE_PAL // visualbasic
