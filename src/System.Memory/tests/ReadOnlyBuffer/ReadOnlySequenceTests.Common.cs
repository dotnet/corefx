...
namespace System.Memory.Tests
{
    public class CommonReadOnlySequenceTests
    {
        ...
        public void Empty_TryGet()
        {
            ...
            Assert.Equal(null, c1.GetObject());
            Assert.True(memory.IsEmpty);
            //Assert.Throws<ArgumentOutOfRangeException>(() => buffer.TryGet(ref c1, out memory, false));
            //Assert.Throws<ArgumentOutOfRangeException>(() => buffer.TryGet(ref c1, out memory, true));
