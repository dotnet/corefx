...
namespace System.MemoryTests
{
    public static partial class ReadOnlyMemoryTests
    {
        ...
        public static void SliceWithStart()
        {
            ...
            ReadOnlyMemory<int> memoryFromOwner = ((ReadOnlyMemory<int>)owner.AsMemory).Slice(6);
        ...
        public static void SliceWithStartPastEnd()
        {
            ...
            OwnedMemory<int> owner = new CustomMemoryForTest<int>(a);
            ReadOnlyMemory<int> memoryFromOwner = ((ReadOnlyMemory<int>)owner.AsMemory).Slice(a.Length);
        ...
        public static void SliceWithStartAndLength()
        {
            ...
            OwnedMemory<int> owner = new CustomMemoryForTest<int>(a);
            ReadOnlyMemory<int> memoryFromOwner = ((ReadOnlyMemory<int>)owner.AsMemory).Slice(3, 5);
        ...
        public static void SliceWithStartAndLengthUpToEnd()
        {
            ...
            OwnedMemory<int> owner = new CustomMemoryForTest<int>(a);
            ReadOnlyMemory<int> memoryFromOwner = ((ReadOnlyMemory<int>)owner.AsMemory).Slice(4, 6);
        ...
        public static void SliceWithStartAndLengthPastEnd()
        {
            ...
            OwnedMemory<int> owner = new CustomMemoryForTest<int>(a);
            ReadOnlyMemory<int> memoryFromOwner = ((ReadOnlyMemory<int>)owner.AsMemory).Slice(a.Length, 0);
