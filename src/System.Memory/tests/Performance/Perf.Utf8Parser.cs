...
namespace System.Buffers.Text.Tests
{
    public static partial class Utf8ParserTests
    {
        ...
        [InlineData("4294967295")] // max value
        [InlineData("0")] // min value
        private static unsafe void PrimitiveParserByteSpanToUInt32_BytesConsumed(string text)
        {
        ...
        [Benchmark]
        private static unsafe void PrimitiveParserByteSpanToUInt32_BytesConsumed_VariableLength()
        {
        ...
        [InlineData("ffffffff")] // max value
        [InlineData("0")] // min value
        private static unsafe void PrimitiveParserByteSpanToUInt32Hex_BytesConsumed(string text)
        {
            byte[] utf8ByteArray = Encoding.UTF8.GetBytes(text);
            var utf8ByteSpan = new ReadOnlySpan<byte>(utf8ByteArray);
            foreach (BenchmarkIteration iteration in Benchmark.Iterations)
        ...
        [Benchmark]
        private static unsafe void PrimitiveParserByteSpanToUInt32Hex_BytesConsumed_VariableLength()
        {
