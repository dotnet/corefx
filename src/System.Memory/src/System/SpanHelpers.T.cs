...
namespace System
{
    internal static partial class SpanHelpers
    {
        ...
        public static unsafe bool StartsWith<T>(ref T searchSpace, int searchSpaceLength, ref T value, int valueLength)
            where T : struct, IEquatable<T>
        {
            Debug.Assert(searchSpaceLength >= 0);
            Debug.Assert(valueLength >= 0);
            ...
            while (valueLength >= 8)
            {
                ...
                if (!Unsafe.Add(ref value, index).Equals(Unsafe.Add(ref searchSpace, index)))
                    goto NotMatched;
                if (!Unsafe.Add(ref value, index + 1).Equals(Unsafe.Add(ref searchSpace, index + 1)))
                    goto NotMatched;
                if (!Unsafe.Add(ref value, index + 2).Equals(Unsafe.Add(ref searchSpace, index + 2)))
                    goto NotMatched;
                if (!Unsafe.Add(ref value, index + 3).Equals(Unsafe.Add(ref searchSpace, index + 3)))
                    goto NotMatched;
                if (!Unsafe.Add(ref value, index + 4).Equals(Unsafe.Add(ref searchSpace, index + 4)))
                    goto NotMatched;
                if (!Unsafe.Add(ref value, index + 5).Equals(Unsafe.Add(ref searchSpace, index + 5)))
                    goto NotMatched;
                if (!Unsafe.Add(ref value, index + 6).Equals(Unsafe.Add(ref searchSpace, index + 6)))
                    goto NotMatched;
                if (!Unsafe.Add(ref value, index + 7).Equals(Unsafe.Add(ref searchSpace, index + 7)))
                    goto NotMatched;
