...
{
    public class TypeBuilderCreateType4
    {
        ...
        public void TestDefineType()
        {
            ...
            for (int i = 0; i < NumLoops; i++)
            {
                ...
                {
                    nestedType.DefineNestedType(nestedTypeName, TypeAttributes.Abstract | TypeAttributes.NestedPublic, typeBuilder.GetType(), DefaultSize);
                }
                else
                {
                    nestedType = typeBuilder.DefineNestedType(nestedTypeName, TypeAttributes.Abstract | TypeAttributes.NestedPublic, typeBuilder.GetType(), DefaultSize);
                }
            }
        ...
        public void TestWithEmbeddedNullsInName()
        {
            ...
            for (int i = 0; i < NumLoops; i++)
            {
                ...
                // create nested type
                typeBuilder.DefineNestedType(nestedTypeName, TypeAttributes.Abstract | TypeAttributes.NestedPublic, typeBuilder.GetType(), DefaultSize);
        ...
        public void TestWithTypeAttributes()
        {
            ...
            for (i = 0; i < _typesPos.Length; i++)
            {
                ...
                if (null != nestedType && 0 == (_generator.GetInt32() % 2))
                {
                    nestedType.DefineNestedType(nestedTypeName, _typesPos[i], typeBuilder.GetType(), DefaultSize);
                }
                else
                {
                    nestedType = typeBuilder.DefineNestedType(nestedTypeName, _typesPos[i], typeBuilder.GetType(), DefaultSize);
                }
            }
        ...
        public void TestWithDefaultSize()
        {
            ...
            // create nested type
            nestedType = typeBuilder.DefineNestedType(nestedTypeName, TypeAttributes.Abstract | TypeAttributes.NestedPublic, null, DefaultSize);
        ...
        public void TestThrowsExceptionOnNullName()
        {
            ...
            {
                // create nested type
                typeBuilder.DefineNestedType(nestedTypeName, TypeAttributes.NestedPublic | TypeAttributes.Class, typeBuilder.GetType(), DefaultSize);
