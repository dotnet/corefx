...
namespace System.Linq.Parallel.Tests
{
    public class AverageTests
    {
        ...
        {
            Assert.Equal(average, ParallelEnumerable.Range(0, count).Average());
            Assert.Equal((double?)average, ParallelEnumerable.Range(0, count).Select(x => (int?)x).Average());
            Assert.Equal(-average, ParallelEnumerable.Range(0, count).Average(x => -x));
            Assert.Equal(-(double?)average, ParallelEnumerable.Range(0, count).Average(x => -(int?)x));
        }

        [Theory]
        [OuterLoop]
        [MemberData(nameof(AverageData), new[] { 1024 * 1024, 1024 * 1024 * 4 })]
        public static void Average_Int_Longrunning(int count, double average)
        {
            Average_Int(count, average);
        }
        ...
        {
            Assert.Equal(Math.Truncate(average), ParallelEnumerable.Range(0, count).Select(x => (x % 2 == 0) ? (int?)x : null).Average());
            Assert.Equal(Math.Truncate(-average), ParallelEnumerable.Range(0, count).Average(x => (x % 2 == 0) ? -(int?)x : null));
        }
        ...
        {
            Assert.Null(ParallelEnumerable.Range(0, count).Select(x => (int?)null).Average());
            Assert.Null(ParallelEnumerable.Range(0, count).Average(x => (int?)null));
        }
        ...
        {
            Assert.Equal(average, ParallelEnumerable.Range(0, count).Select(x => (long)x).Average());
            Assert.Equal((double?)average, ParallelEnumerable.Range(0, count).Select(x => (long?)x).Average());
            Assert.Equal(-average, ParallelEnumerable.Range(0, count).Average(x => -(long)x));
            Assert.Equal(-(double?)average, ParallelEnumerable.Range(0, count).Average(x => -(long?)x));
        }

        [Theory]
        [OuterLoop]
        [MemberData(nameof(AverageData), new[] { 1024 * 1024, 1024 * 1024 * 4 })]
        public static void Average_Long_Longrunning(int count, double average)
        {
            Average_Long(count, average);
        }

        [Fact]
        public static void Average_Long_Overflow()
        {
            AssertThrows.Wrapped<OverflowException>(() => ParallelEnumerable.Range(0, 2).Select(x => x == 0 ? 1 : long.MaxValue).Average());
            AssertThrows.Wrapped<OverflowException>(() => ParallelEnumerable.Range(0, 2).Select(x => x == 0 ? (long?)1 : long.MaxValue).Average());
            AssertThrows.Wrapped<OverflowException>(() => ParallelEnumerable.Range(0, 2).Average(x => x == 0 ? -1 : long.MinValue));
            AssertThrows.Wrapped<OverflowException>(() => ParallelEnumerable.Range(0, 2).Average(x => x == 0 ? (long?)-1 : long.MinValue));
        }
        ...
        {
            Assert.Equal(Math.Truncate(average), ParallelEnumerable.Range(0, count).Select(x => (x % 2 == 0) ? (long?)x : null).Average());
            Assert.Equal(Math.Truncate(-average), ParallelEnumerable.Range(0, count).Average(x => (x % 2 == 0) ? -(long?)x : null));
        }
        ...
        {
            Assert.Null(ParallelEnumerable.Range(0, count).Select(x => (long?)null).Average());
            Assert.Null(ParallelEnumerable.Range(0, count).Average(x => (long?)null));
        }
        ...
        {
            Assert.Equal(average, ParallelEnumerable.Range(0, count).Select(x => (float)x).Average());
            Assert.Equal((float?)average, ParallelEnumerable.Range(0, count).Select(x => (float?)x).Average());
            Assert.Equal(-average, ParallelEnumerable.Range(0, count).Average(x => -(float)x));
            Assert.Equal(-(float?)average, ParallelEnumerable.Range(0, count).Average(x => -(float?)x));
        }

        [Theory]
        [OuterLoop]
        [MemberData(nameof(AverageData), new[] { 1024 * 1024, 1024 * 1024 * 4 })]
        public static void Average_Float_Longrunning(int count, float average)
        {
            Average_Float(count, average);
        }
        ...
        {
            Assert.Equal((float?)Math.Truncate(average), ParallelEnumerable.Range(0, count).Select(x => (x % 2 == 0) ? (float?)x : null).Average());
            Assert.Equal((float?)Math.Truncate(-average), ParallelEnumerable.Range(0, count).Average(x => (x % 2 == 0) ? -(float?)x : null));
        }
        ...
        {
            Assert.Null(ParallelEnumerable.Range(0, count).Select(x => (float?)null).Average());
            Assert.Null(ParallelEnumerable.Range(0, count).Average(x => (float?)null));
        }
        ...
        {
            Assert.Equal(average, ParallelEnumerable.Range(0, count).Select(x => (double)x).Average());
            Assert.Equal((double?)average, ParallelEnumerable.Range(0, count).Select(x => (double?)x).Average());
            Assert.Equal(-average, ParallelEnumerable.Range(0, count).Average(x => -(double)x));
            Assert.Equal(-(double?)average, ParallelEnumerable.Range(0, count).Average(x => -(double?)x));
        }

        [Theory]
        [OuterLoop]
        [MemberData(nameof(AverageData), new[] { 1024 * 1024, 1024 * 1024 * 4 })]
        public static void Average_Double_Longrunning(int count, double average)
        {
            Average_Double(count, average);
        }
        ...
        {
            Assert.Equal(Math.Truncate(average), ParallelEnumerable.Range(0, count).Select(x => (x % 2 == 0) ? (double?)x : null).Average());
            Assert.Equal(Math.Truncate(-average), ParallelEnumerable.Range(0, count).Average(x => (x % 2 == 0) ? -(double?)x : null));
        }
        ...
        {
            Assert.Null(ParallelEnumerable.Range(0, count).Select(x => (double?)null).Average());
            Assert.Null(ParallelEnumerable.Range(0, count).Average(x => (double?)null));
        }
        ...
        {
            Assert.Equal(average, ParallelEnumerable.Range(0, count).Select(x => (decimal)x).Average());
            Assert.Equal((decimal?)average, ParallelEnumerable.Range(0, count).Select(x => (decimal?)x).Average());
            Assert.Equal(-average, ParallelEnumerable.Range(0, count).Average(x => -(decimal)x));
            Assert.Equal(-(decimal?)average, ParallelEnumerable.Range(0, count).Average(x => -(decimal?)x));
        }

        [Theory]
        [OuterLoop]
        [MemberData(nameof(AverageData), new[] { 1024 * 1024, 1024 * 1024 * 4 })]
        public static void Average_Decimal_Longrunning(int count, decimal average)
        {
            Average_Decimal(count, average);
        }
        ...
        {
            Assert.Equal(Math.Truncate(average), ParallelEnumerable.Range(0, count).Select(x => (x % 2 == 0) ? (decimal?)x : null).Average());
            Assert.Equal(Math.Truncate(-average), ParallelEnumerable.Range(0, count).Average(x => (x % 2 == 0) ? -(decimal?)x : null));
        }
        ...
        {
            Assert.Null(ParallelEnumerable.Range(0, count).Select(x => (decimal?)null).Average());
            Assert.Null(ParallelEnumerable.Range(0, count).Average(x => (decimal?)null));
        }
        ...
        {
            AssertThrows.Wrapped<DeliberateTestException>(() => ParallelEnumerable.Range(0, 1).Average((Func<int, int>)(x => { throw new DeliberateTestException(); })));
            AssertThrows.Wrapped<DeliberateTestException>(() => ParallelEnumerable.Range(0, 1).Average((Func<int, int?>)(x => { throw new DeliberateTestException(); })));

            AssertThrows.Wrapped<DeliberateTestException>(() => ParallelEnumerable.Range(0, 1).Average((Func<int, long>)(x => { throw new DeliberateTestException(); })));
            AssertThrows.Wrapped<DeliberateTestException>(() => ParallelEnumerable.Range(0, 1).Average((Func<int, long?>)(x => { throw new DeliberateTestException(); })));

            AssertThrows.Wrapped<DeliberateTestException>(() => ParallelEnumerable.Range(0, 1).Average((Func<int, float>)(x => { throw new DeliberateTestException(); })));
            AssertThrows.Wrapped<DeliberateTestException>(() => ParallelEnumerable.Range(0, 1).Average((Func<int, float?>)(x => { throw new DeliberateTestException(); })));

            AssertThrows.Wrapped<DeliberateTestException>(() => ParallelEnumerable.Range(0, 1).Average((Func<int, double>)(x => { throw new DeliberateTestException(); })));
            AssertThrows.Wrapped<DeliberateTestException>(() => ParallelEnumerable.Range(0, 1).Average((Func<int, double?>)(x => { throw new DeliberateTestException(); })));

            AssertThrows.Wrapped<DeliberateTestException>(() => ParallelEnumerable.Range(0, 1).Average((Func<int, decimal>)(x => { throw new DeliberateTestException(); })));
            AssertThrows.Wrapped<DeliberateTestException>(() => ParallelEnumerable.Range(0, 1).Average((Func<int, decimal?>)(x => { throw new DeliberateTestException(); })));
        }
