...
namespace System.Security.Cryptography.Xml
{
    public class XmlLicenseTransform : Transform
    {
                    ...
                    (cipherData != null))
                {
                    ...
                    try
                    {
                        ...
                        if ((decryptedContent == null) || (decryptedContent.Length == 0))
                            throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_XrmlUnableToDecryptGrant"));
        ...
        public override void LoadInput(object obj)
        {
            ...
            if (Context == null)
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_XrmlMissingContext"));
            ...
            if (currentIssuerContext == null)
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_XrmlMissingIssuer"));
            ...
            if (currentLicenseContext == null)
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_XrmlMissingLicence"));
            ...
            if (encryptedGrantList.Count > 0)
            {
                if (_relDecryptor == null)
                    throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_XrmlMissingIRelDecryptor"));
