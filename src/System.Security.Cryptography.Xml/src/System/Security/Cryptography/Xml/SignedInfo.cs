    ...
    public class SignedInfo : ICollection
    {
        ...
        public Transform CanonicalizationMethodObject
        {
            get
            {
                if (_canonicalizationMethodTransform == null)
                {
                    ...
                    if (_canonicalizationMethodTransform == null)
                        throw new CryptographicException(string.Format(CultureInfo.CurrentCulture, SR.GetResourceString("Cryptography_Xml_CreateTransformFailed"), CanonicalizationMethod));
        ...
        internal XmlElement GetXml(XmlDocument document)
        {
            ...
            if (string.IsNullOrEmpty(_signatureMethod))
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_SignatureMethodRequired"));
            ...
            if (_references.Count == 0)
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_ReferenceElementRequired"));
        ...
        public void LoadXml(XmlElement value)
        {
            ...
            if (!signedInfoElement.LocalName.Equals("SignedInfo"))
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_InvalidElement"), "SignedInfo");
            ...
            if (canonicalizationMethodElement == null)
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_InvalidElement"), "SignedInfo/CanonicalizationMethod");
            ...
            if (signatureMethodElement == null)
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_InvalidElement"), "SignedInfo/SignatureMethod");
