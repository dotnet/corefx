...
namespace System.Security.Cryptography.Xml
{
    public class Signature
    {
        ...
        internal XmlElement GetXml(XmlDocument document)
        {
            ...
            // Add the SignedInfo
            if (_signedInfo == null)
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_SignedInfoRequired"));
        ...
        public void LoadXml(XmlElement value)
        {
            ...
            if (!signatureElement.LocalName.Equals("Signature"))
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_InvalidElement"), "Signature");
            ...
            if (signatureValueElement == null)
                throw new CryptographicException(SR.GetResourceString("Cryptography_Xml_InvalidElement"), "SignedInfo/SignatureValue");
