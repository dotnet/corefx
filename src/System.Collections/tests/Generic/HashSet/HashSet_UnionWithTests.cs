...
namespace Tests
{
    namespace HashSet_HashSet_UnionWithTests
    {
        public class HashSet_UnionWithTests
        {
            ...
            [Fact]
            public static void UnionWith_Test1()
            {
            ...
            [Fact]
            public static void UnionWith_Test2()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test3()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test4()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test5()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test6()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test7()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test8()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test9()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test10()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test11()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test12()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test13()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test14()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test15()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test16()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test17()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test18()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test19()
            {
            ...
            [Fact]
            public static void UnionWith_Test20()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test21()
            {
            ...
            [Fact]
            public static void UnionWith_Test22()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test23()
            {
            ...
            [Fact]
            public static void UnionWith_Test24()
            {
                List<int> item1 = new List<int>(new int[] { 1, 2 });
                List<int> item2 = new List<int>(new int[] { 2, -1 });
                HashSet<IEnumerable> hashSet;
            ...
            [Fact]
            public static void UnionWith_Test25()
            {
                HashSet<int> hashSet;
            ...
            [Fact]
            public static void UnionWith_Test26()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test27()
            {
                HashSet<int> hashSet;
                IEnumerable<int> other;
            ...
            [Fact]
            public static void UnionWith_Test28()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test29()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test30()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test31()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test32()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test33()
            {
                List<int> item1 = new List<int>(new int[] { 1, 2 });
                List<int> item2 = new List<int>(new int[] { 2, -1 });
            ...
            [Fact]
            public static void UnionWith_Test34()
            {
                List<int> item1 = new List<int>(new int[] { 1, 2 });
                List<int> item2 = new List<int>(new int[] { 2, -1 });
                IEnumerable item3 = new List<int>(new int[] { 1, 4, 5, 6, 8 });
            ...
            [Fact]
            public static void UnionWith_Test35()
            {
                HashSet<int> hashSet;
                IEnumerable<int> other;
                ...
                HashSetTestSupport<int>.VerifyHashSet(hashSet, new int[] { 1, 2, 3, 4, 0, 6, 7, 111, -111 }, hashSet.Comparer);
            }
            ...
            [Fact]
            public static void UnionWith_Test36()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test37()
            {
                HashSet<int> hashSet;
                IEnumerable<int> other;
            ...
            [Fact]
            public static void UnionWith_Test38()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test39()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test40()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test41()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test42()
            {
                HashSet<Item> hashSet;
                IEnumerable<Item> other;
            ...
            [Fact]
            public static void UnionWith_Test43()
            {
            ...
            [Fact]
            public static void UnionWith_Test44()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test45()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test48()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test49()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test50()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test51()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(340, -5);
            ...
            [Fact]
            public static void UnionWith_Test53()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test54()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test55()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test56()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(340, -5);
            ...
            [Fact]
            public static void UnionWith_Test57()
            {
                ValueItem itemn4 = new ValueItem(-4, -4);
                ValueItem itemn3 = new ValueItem(-3, -3);
                ValueItem itemn2 = new ValueItem(-2, -2);
            ...
            [Fact]
            public static void UnionWith_Test58()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test59()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test60()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem item1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test62()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
            ...
            [Fact]
            public static void UnionWith_Test63()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test64()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test65()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test66()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test67()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test68()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test69()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(34, -5);
                ...
                HashSetTestSupport<ValueItem>.VerifyHashSet(hashSet, new ValueItem[] { items1, items2, items3, items4, itemo1, itemo3 }, hashSet.Comparer);
            }

            //Test 70: Set/Collection Duplicate Item Test 13: other contains duplicates by default comparer but not by sets comparer
            [Fact]
            public static void UnionWith_Test70()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test71()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(-34, -5);
            ...
            [Fact]
            public static void UnionWith_Test72()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(34, -5);
            ...
            [Fact]
            public static void UnionWith_Test73()
            {
                HashSet<ValueItem> hashSet;
                IEnumerable<ValueItem> other;
                ValueItem itemo1 = new ValueItem(34, -5);
