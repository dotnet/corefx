...
namespace System.Collections.Tests
{
    ...
    public abstract partial class List_Generic_Tests<T> : IList_Generic_Tests<T>
    {
        ...
        public void BinarySearch_Validations(int count)
        {
            ...
            Assert.Throws<ArgumentException>(() => list.BinarySearch(count + 1, count, element, GetIComparer())); //"ArgumentException should be thrown on index greater than length of array."
        }
    }
}
