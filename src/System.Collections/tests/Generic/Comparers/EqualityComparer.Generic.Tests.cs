...
namespace System.Collections.Generic.Tests
{
    public abstract partial class ComparersGenericTests<T>
    {
        ...
        {
            [Fact]
            public void EqualityComparerDefault()
            {
            ...
            public void EqualsShouldBeOverriddenAndWorkForDifferentInstances()
            {
                ...
                // If we are running on full framework/CoreCLR, EqualityComparer<T> additionally
            ...
            [Fact]
            public void IEqualityComparerEqualsWithObjectsNotOfMatchingType())
            {
            ...
            [Fact]
            public void IEqualityComparerGetHashCodeWithObjectNotOfMatchingType()
            {
