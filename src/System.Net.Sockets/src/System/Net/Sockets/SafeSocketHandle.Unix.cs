...
namespace System.Net.Sockets
{
    public partial class SafeSocketHandle
    {
        ...
        internal static unsafe SocketError Accept(SafeSocketHandle socketHandle, byte[] socketAddress, ref int socketAddressLen, out SafeSocketHandle socket)
        {
            socket = new SafeSocketHandle();
