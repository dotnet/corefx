...
{
    /// <summary> Presents UDP receive result information from a call to the <see cref="UdpClient.ReceiveAsync"/> method </summary>
    public struct UdpReceiveResult : IEquatable<UdpReceiveResult>
    {
        private readonly byte[] _buffer;
        private readonly IPEndPoint _remoteEndPoint;

        /// <summary> Initializes a new instance of the <see cref="UdpReceiveResult"/> class </summary>
        ...
        /// <summary> Tests whether two specified <see cref="UdpReceiveResult"/> instances are equivalent </summary>
        ...
        /// <summary> Tests whether two specified <see cref="UdpReceiveResult"/> instances are not equal </summary>
