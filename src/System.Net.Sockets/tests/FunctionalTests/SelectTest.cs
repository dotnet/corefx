...
namespace System.Net.Sockets.Tests
{
    public class SelectTest
    {
        ...
        [PlatformSpecific(~TestPlatforms.OSX)] // typical OSX install has very low max open file descriptors value
        [ConditionalFact("System.PlatformDetection, CoreFx.Private.TestUtilities!" + nameof(PlatformDetection.IsNotWindowsSubsystemForLinux))] // https://github.com/Microsoft/BashOnWindows/issues/308
