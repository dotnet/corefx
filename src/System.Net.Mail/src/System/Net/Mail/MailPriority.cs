        ...
        internal HeaderCollection Headers
        {
            get
            {
                if (_headers == null)
                {
                    ...
                    if (EmailEventSource.Log.IsEnabled()) EmailEventSource.Log.Associate(this, _headers);
                }
        ...
        internal HeaderCollection EnvelopeHeaders
        {
            get
            {
                if (_envelopeHeaders == null)
                {
                    ...
                    if (EmailEventSource.Log.IsEnabled()) EmailEventSource.Log.Associate(this, _envelopeHeaders);
                }
