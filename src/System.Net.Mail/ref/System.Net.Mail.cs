...
namespace System.Net.Mime
{
    ...
    public static partial class MediaTypeNames
    {
        public static partial class Application
        {
            ...
            public const string MicrosoftExcelOpenXml = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
            public const string MicrosoftPowerPoint = "application/vnd.ms-powerpoint";
            public const string MicrosoftPowerPointOpenXml = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
            public const string MicrosoftWord = "application/msword";
            public const string MicrosoftWordOpenXml = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
