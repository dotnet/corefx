...
{
    /// <summary> See <see cref="IArgumentProvider"/> for design considerations. </summary>
    internal interface IParameterProvider
    {
        /// <summary> Gets the parameter expression with the specified <paramref name="index"/>. </summary>
        ...
        /// <summary> Gets the number of parameter expressions of the node. </summary>
        int ParameterCount
        {
            get;
        }
