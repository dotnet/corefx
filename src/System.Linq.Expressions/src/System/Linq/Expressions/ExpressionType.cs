...
namespace System.Linq.Expressions
{
    ...
    public enum ExpressionType
    {
        ...
        OrElse,
        /// <summary> A node that represents a reference to a parameter or variable defined in the context of the expression. </summary>
        Parameter,
        /// <summary> A node that represents raising a number to a power. </summary>
        Power,
        /// <summary> A node that represents an expression that has a constant value of type Expression. A Quote node can contain references to parameters defined in the context of the expression it represents. </summary>
        Quote,
        ...
        SubtractChecked,
        /// <summary> A node that represents an explicit reference or boxing conversion where null reference (Nothing in Visual Basic) is supplied if the conversion fails. </summary>
        TypeAs,
        /// <summary> A node that represents a type test. </summary>
        TypeIs,
        /// <summary> A node that represents an assignment. </summary>
        Assign,
        /// <summary> A node that represents a block of expressions. </summary>
        Block,
        /// <summary> A node that represents a debugging information. </summary>
        DebugInfo,
        ...
        Extension,
        /// <summary> A node that represents a goto. </summary>
        Goto,
        ...
        Label,
        /// <summary> A node that represents a list of runtime variables. </summary>
        RuntimeVariables,
        ...
        Unbox,
        /// <summary> A node that represents an arithmetic addition compound assignment without overflow checking. </summary>
        AddAssign,
        /// <summary> A node that represents a bitwise AND compound assignment. </summary>
        AndAssign,
        /// <summary> A node that represents an arithmetic division compound assignment . </summary>
        DivideAssign,
        ...
        ModuloAssign,
        /// <summary> A node that represents arithmetic multiplication compound assignment without overflow checking. </summary>
        MultiplyAssign,
        ...
        RightShiftAssign,
        /// <summary> A node that represents arithmetic subtraction compound assignment without overflow checking. </summary>
        SubtractAssign,
        /// <summary> A node that represents an arithmetic addition compound assignment with overflow checking. </summary>
        AddAssignChecked,
        /// <summary> A node that represents arithmetic multiplication compound assignment with overflow checking. </summary>
        MultiplyAssignChecked,
        /// <summary> A node that represents arithmetic subtraction compound assignment with overflow checking. </summary>
        SubtractAssignChecked,
        /// <summary> A node that represents an unary prefix increment. </summary>
        PreIncrementAssign,
        /// <summary> A node that represents an unary prefix decrement. </summary>
        PreDecrementAssign,
        /// <summary> A node that represents an unary postfix increment. </summary>
        PostIncrementAssign,
        /// <summary> A node that represents an unary postfix decrement. </summary>
        PostDecrementAssign,
