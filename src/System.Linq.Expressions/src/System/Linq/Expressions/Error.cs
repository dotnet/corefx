...
{
    /// <summary> Strongly-typed and parameterized exception factory. </summary>
    internal static class Error
    {
        /// <summary> ArgumentException with message like "reducible nodes must override Expression.Reduce()" </summary>
        internal static Exception ReducibleMustOverrideReduce()
        {
            return new ArgumentException(Strings.ReducibleMustOverrideReduce);
        }
        /// <summary> ArgumentException with message like "Argument count must be greater than number of named arguments." </summary>
        ...
        /// <summary> InvalidOperationException with message like "An IDynamicMetaObjectProvider {0} created an invalid DynamicMetaObject instance." </summary>
        ...
        /// <summary> System.Reflection.AmbiguousMatchException with message like "More than one key matching '{0}' was found in the ExpandoObject." </summary>
        ...
        /// <summary> ArgumentException with message like "An element with the same key '{0}' already exists in the ExpandoObject." </summary>
        ...
        /// <summary> System.Collections.Generic.KeyNotFoundException with message like "The specified key '{0}' does not exist in the ExpandoObject." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Collection was modified; enumeration operation may not execute." </summary>
        ...
        /// <summary> NotSupportedException with message like "Collection is read-only." </summary>
        internal static Exception CollectionReadOnly()
        {
            return new NotSupportedException(Strings.CollectionReadOnly);
        }
        /// <summary> ArgumentException with message like "node cannot reduce to itself or null" </summary>
        internal static Exception MustReduceToDifferent()
        {
            return new ArgumentException(Strings.MustReduceToDifferent);
        }
        /// <summary> InvalidOperationException with message like "The result type '{0}' of the binder '{1}' is not compatible with the result type '{2}' expected by the call site." </summary>
        ...
        /// <summary> InvalidOperationException with message like "The result of the dynamic binding produced by the object with type '{0}' for the binder '{1}' needs at least one restriction." </summary>
        ...
        /// <summary> InvalidCastException with message like "The result type '{0}' of the dynamic binding produced by the object with type '{1}' for the binder '{2}' is not compatible with the result type '{3}' expected by the call site." </summary>
        ...
        /// <summary> InvalidCastException with message like "The result type '{0}' of the dynamic binding produced by binder '{1}' is not compatible with the result type '{2}' expected by the call site." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Bind cannot return null." </summary>
        internal static Exception BindingCannotBeNull()
        {
            return new InvalidOperationException(Strings.BindingCannotBeNull);
        }
        /// <summary> ArgumentException with message like "cannot assign from the reduced node type to the original node type" </summary>
        internal static Exception ReducedNotCompatible()
        {
            return new ArgumentException(Strings.ReducedNotCompatible);
        }
        /// <summary> ArgumentException with message like "Setter must have parameters." </summary>
        ...
        /// <summary> ArgumentException with message like "Property cannot have a managed pointer type." </summary>
        ...
        /// <summary> ArgumentException with message like "Indexing parameters of getter and setter must match." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Type parameter is {0}. Expected a delegate." </summary>
        internal static Exception TypeParameterIsNotDelegate(object p0)
        {
            return new InvalidOperationException(Strings.TypeParameterIsNotDelegate(p0));
        }
        /// <summary> ArgumentException with message like "First argument of delegate must be CallSite" </summary>
        internal static Exception FirstArgumentMustBeCallSite()
        {
            return new ArgumentException(Strings.FirstArgumentMustBeCallSite);
        }
        /// <summary> ArgumentException with message like "Accessor method should not have VarArgs." </summary>
        ...
        /// <summary> ArgumentException with message like "Accessor indexes cannot be passed ByRef." </summary>
        ...
        /// <summary> ArgumentException with message like "Type must be derived from System.Delegate" </summary>
        ...
        /// <summary> InvalidOperationException with message like "No or Invalid rule produced" </summary>
        internal static Exception NoOrInvalidRuleProduced()
        {
            return new InvalidOperationException(Strings.NoOrInvalidRuleProduced);
        }
        /// <summary> ArgumentException with message like "Bounds count cannot be less than 1" </summary>
        ...
        /// <summary> ArgumentException with message like "Type must not be ByRef" </summary>
        ...
        /// <summary> ArgumentException with message like "Type must not be a pointer type" </summary>
        ...
        /// <summary> ArgumentException with message like "Setter should have void type." </summary>
        ...
        /// <summary> ArgumentException with message like "Property type must match the value type of getter" </summary>
        ...
        /// <summary> ArgumentException with message like "Property type must match the value type of setter" </summary>
        ...
        /// <summary> ArgumentException with message like "Both accessors must be static." </summary>
        ...
        /// <summary> ArgumentException with message like "Static field requires null instance, non-static field requires non-null instance." </summary>
        ...
        /// <summary> ArgumentException with message like "Static property requires null instance, non-static property requires non-null instance." </summary>
        ...
        /// <summary> ArgumentException with message like "Property cannot have a void type." </summary>
        ...
        /// <summary> ArgumentException with message like "Can only unbox from an object or interface type to a value type." </summary>
        ...
        /// <summary> ArgumentException with message like "Expression must be writeable" </summary>
        ...
        /// <summary> ArgumentException with message like "Argument must not have a value type." </summary>
        ...
        /// <summary> ArgumentException with message like "must be reducible node" </summary>
        internal static Exception MustBeReducible()
        {
            return new ArgumentException(Strings.MustBeReducible);
        }
        /// <summary> ArgumentException with message like "All test values must have the same type." </summary>
        ...
        /// <summary> ArgumentException with message like "All case bodies and the default body must have the same type." </summary>
        ...
        /// <summary> ArgumentException with message like "Default body must be supplied if case bodies are not System.Void." </summary>
        ...
        /// <summary> ArgumentException with message like "Label type must be System.Void if an expression is not supplied" </summary>
        ...
        /// <summary> ArgumentException with message like "Type must be System.Void for this label argument" </summary>
        ...
        /// <summary> ArgumentException with message like "Quoted expression must be a lambda" </summary>
        ...
        /// <summary> ArgumentException with message like "Variable '{0}' uses unsupported type '{1}'. Reference types are not supported for variables." </summary>
        ...
        /// <summary> ArgumentException with message like "Found duplicate parameter '{0}'. Each ParameterExpression in the list must be a unique object." </summary>
        ...
        /// <summary> ArgumentException with message like "Start and End must be well ordered" </summary>
        internal static Exception StartEndMustBeOrdered()
        {
            return new ArgumentException(Strings.StartEndMustBeOrdered);
        }
        /// <summary> ArgumentException with message like "fault cannot be used with catch or finally clauses" </summary>
        ...
        /// <summary> ArgumentException with message like "try must have at least one catch, finally, or fault clause" </summary>
        ...
        /// <summary> ArgumentException with message like "Body of catch must have the same type as body of try." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Extension node must override the property {0}." </summary>
        ...
        /// <summary> ArgumentException with message like "User-defined operator method '{0}' must be static." </summary>
        ...
        /// <summary> ArgumentException with message like "User-defined operator method '{0}' must not be void." </summary>
        ...
        /// <summary> InvalidOperationException with message like "The unary operator {0} is not defined for the type '{1}'." </summary>
        ...
        /// <summary> InvalidOperationException with message like "The binary operator {0} is not defined for the types '{1}' and '{2}'." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Reference equality is not defined for the types '{0}' and '{1}'." </summary>
        ...
        /// <summary> InvalidOperationException with message like "The operands for operator '{0}' do not match the parameters of method '{1}'." </summary>
        ...
        /// <summary> InvalidOperationException with message like "The return type of overload method for operator '{0}' does not match the parameter type of conversion method '{1}'." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Conversion is not supported for arithmetic types without operator overloading." </summary>
        ...
        /// <summary> ArgumentException with message like "Argument type cannot be void" </summary>
        internal static Exception ArgumentTypeCannotBeVoid()
        {
            return new ArgumentException(Strings.ArgumentTypeCannotBeVoid);
        }
        /// <summary> ArgumentException with message like "Argument must be array" </summary>
        ...
        /// <summary> ArgumentException with message like "Argument must be boolean" </summary>
        ...
        /// <summary> ArgumentException with message like "The user-defined equality method '{0}' must return a boolean value." </summary>
        ...
        /// <summary> ArgumentException with message like "Argument must be either a FieldInfo or PropertyInfo" </summary>
        ...
        /// <summary> ArgumentException with message like "Argument must be either a FieldInfo, PropertyInfo or MethodInfo" </summary>
        ...
        /// <summary> ArgumentException with message like "Argument must be an instance member" </summary>
        ...
        /// <summary> ArgumentException with message like "Argument must be of an integer type" </summary>
        ...
        /// <summary> ArgumentException with message like "Argument for array index must be of type Int32" </summary>
        ...
        /// <summary> ArgumentException with message like "Argument must be single-dimensional, zero-based array type" </summary>
        ...
        /// <summary> ArgumentException with message like "Argument types do not match" </summary>
        ...
        /// <summary> InvalidOperationException with message like "Cannot auto initialize elements of value type through property '{0}', use assignment instead" </summary>
        ...
        /// <summary> InvalidOperationException with message like "Cannot auto initialize members of value type through property '{0}', use assignment instead" </summary>
        ...
        /// <summary> ArgumentException with message like "The type used in TypeAs Expression must be of reference or nullable type, {0} is neither" </summary>
        ...
        /// <summary> InvalidOperationException with message like "Coalesce used with type that cannot be null" </summary>
        ...
        /// <summary> InvalidOperationException with message like "An expression of type '{0}' cannot be used to initialize an array of type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like " Argument type '{0}' does not match the corresponding member type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like " The member '{0}' is not declared on type '{1}' being created" </summary>
        ...
        /// <summary> ArgumentException with message like "Expression of type '{0}' cannot be used for return type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Expression of type '{0}' cannot be used for assignment to type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Expression of type '{0}' cannot be used for label of type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Expression of type '{0}' cannot be invoked" </summary>
        ...
        /// <summary> ArgumentException with message like "Field '{0}' is not defined for type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Instance field '{0}' is not defined for type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Field '{0}.{1}' is not defined for type '{2}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Incorrect number of indexes" </summary>
        internal static Exception IncorrectNumberOfIndexes()
        {
            return new ArgumentException(Strings.IncorrectNumberOfIndexes);
        }
        /// <summary> ArgumentException with message like "Incorrect number of parameters supplied for lambda declaration" </summary>
        ...
        /// <summary> ArgumentException with message like " Incorrect number of members for constructor" </summary>
        ...
        /// <summary> ArgumentException with message like "Incorrect number of arguments for the given members " </summary>
        ...
        /// <summary> ArgumentException with message like "Lambda type parameter must be derived from System.MulticastDelegate" </summary>
        ...
        /// <summary> ArgumentException with message like "Member '{0}' not field or property" </summary>
        ...
        /// <summary> ArgumentException with message like "Method {0} contains generic parameters" </summary>
        ...
        /// <summary> ArgumentException with message like "Method {0} is a generic method definition" </summary>
        ...
        /// <summary> ArgumentException with message like "The method '{0}.{1}' is not a property accessor" </summary>
        ...
        /// <summary> ArgumentException with message like "The property '{0}' has no 'get' accessor" </summary>
        ...
        /// <summary> ArgumentException with message like "The property '{0}' has no 'set' accessor" </summary>
        ...
        /// <summary> ArgumentException with message like "The property '{0}' has no 'get' or 'set' accessors" </summary>
        ...
        /// <summary> ArgumentException with message like "'{0}' is not a member of type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "'{0}' is not a member of any type" </summary>
        ...
        /// <summary> ArgumentException with message like "ParameterExpression of type '{0}' cannot be used for delegate parameter of type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Property '{0}' is not defined for type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Instance property '{0}' is not defined for type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Instance property '{0}' that takes no argument is not defined for type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Instance property '{0}{1}' is not defined for type '{2}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Method '{0}' declared on type '{1}' cannot be called with instance of type '{2}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Type '{0}' does not have a default constructor" </summary>
        ...
        /// <summary> ArgumentException with message like "Element initializer method must be named 'Add'" </summary>
        ...
        /// <summary> ArgumentException with message like "Parameter '{0}' of element initializer method '{1}' must not be a pass by reference parameter" </summary>
        ...
        /// <summary> ArgumentException with message like "Element initializer method must have at least 1 parameter" </summary>
        ...
        /// <summary> ArgumentException with message like "Element initializer method must be an instance method" </summary>
        ...
        /// <summary> ArgumentException with message like "Type '{0}' is not IEnumerable" </summary>
        ...
        /// <summary> ArgumentException with message like "Unhandled binary: {0}" </summary>
        ...
        /// <summary> ArgumentException with message like "Unhandled binding " </summary>
        internal static Exception UnhandledBinding()
        {
            return new ArgumentException(Strings.UnhandledBinding);
        }
        /// <summary> ArgumentException with message like "Unhandled Binding Type: {0}" </summary>
        internal static Exception UnhandledBindingType(object p0)
        {
            return new ArgumentException(Strings.UnhandledBindingType(p0));
        }

        /// <summary> ArgumentException with message like "Unhandled unary: {0}" </summary>
        ...
        /// <summary> ArgumentException with message like "Unknown binding type" </summary>
        ...
        /// <summary> ArgumentException with message like "The user-defined operator method '{1}' for operator '{0}' must have identical parameter and return types." </summary>
        ...
        /// <summary> ArgumentException with message like "The user-defined operator method '{1}' for operator '{0}' must return the same type as its parameter or a derived type." </summary>
        ...
        /// <summary> ArgumentException with message like "The user-defined operator method '{1}' for operator '{0}' must have associated boolean True and False operators." </summary>
        ...
        /// <summary> InvalidOperationException with message like "No method '{0}' on type '{1}' is compatible with the supplied arguments." </summary>
        ...
        /// <summary> InvalidOperationException with message like "No generic method '{0}' on type '{1}' is compatible with the supplied type arguments and arguments. No type arguments should be provided if the method is non-generic. " </summary>
        ...
        /// <summary> InvalidOperationException with message like "More than one method '{0}' on type '{1}' is compatible with the supplied arguments." </summary>
        ...
        /// <summary> InvalidOperationException with message like "More than one property '{0}' on type '{1}' is compatible with the supplied arguments." </summary>
        ...
        /// <summary> ArgumentException with message like "An incorrect number of type arguments were specified for the declaration of a Func type." </summary>
        ...
        /// <summary> ArgumentException with message like "An incorrect number of type arguments were specified for the declaration of an Action type." </summary>
        ...
        /// <summary> ArgumentException with message like "Argument type cannot be System.Void." </summary>
        ...
        /// <summary> ArgumentOutOfRangeException with message like "{0} must be greater than or equal to {1}" </summary>
        ...
        /// <summary> InvalidOperationException with message like "Cannot redefine label '{0}' in an inner block." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Cannot jump to undefined label '{0}'." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Control cannot leave a finally block." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Control cannot leave a filter test." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Cannot jump to ambiguous label '{0}'." </summary>
        internal static Exception AmbiguousJump(object p0)
        {
            return new InvalidOperationException(Strings.AmbiguousJump(p0));
        }
        /// <summary> InvalidOperationException with message like "Control cannot enter a try block." </summary>
        internal static Exception ControlCannotEnterTry()
        {
            return new InvalidOperationException(Strings.ControlCannotEnterTry);
        }
        /// <summary> InvalidOperationException with message like "Control cannot enter an expression--only statements can be jumped into." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Cannot jump to non-local label '{0}' with a value. Only jumps to labels defined in outer blocks can pass values." </summary>
        ...
        /// <summary> InvalidOperationException with message like "CompileToMethod cannot compile constant '{0}' because it is a non-trivial value, such as a live object. Instead, create an expression tree that can construct this value." </summary>
        ...
        /// <summary> NotSupportedException with message like "Dynamic expressions are not supported by CompileToMethod. Instead, create an expression tree that uses System.Runtime.CompilerServices.CallSite." </summary>
        internal static Exception CannotCompileDynamic()
        {
            return new NotSupportedException(Strings.CannotCompileDynamic);
        }
        /// <summary> ArgumentException with message like "MethodBuilder does not have a valid TypeBuilder" </summary>
...
#endif
        /// <summary> InvalidOperationException with message like "Invalid lvalue for assignment: {0}." </summary>
        internal static Exception InvalidLvalue(ExpressionType p0)
        {
            return new InvalidOperationException(Strings.InvalidLvalue(p0));
        }

        /// <summary> InvalidOperationException with message like "variable '{0}' of type '{1}' referenced from scope '{2}', but it is not defined" </summary>
        ...
        /// <summary> InvalidOperationException with message like "Cannot close over byref parameter '{0}' referenced in lambda '{1}'" </summary>
        ...
        /// <summary> InvalidOperationException with message like "Unexpected VarArgs call to method '{0}'" </summary>
        ...
        /// <summary> InvalidOperationException with message like "Rethrow statement is valid only inside a Catch block." </summary>
        internal static Exception RethrowRequiresCatch()
        {
            return new InvalidOperationException(Strings.RethrowRequiresCatch);
        }
        /// <summary> InvalidOperationException with message like "Try expression is not allowed inside a filter body." </summary>
        internal static Exception TryNotAllowedInFilter()
        {
            return new InvalidOperationException(Strings.TryNotAllowedInFilter);
        }
        /// <summary> InvalidOperationException with message like "When called from '{0}', rewriting a node of type '{1}' must return a non-null value of the same type. Alternatively, override '{2}' and change it to not visit children of this type." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Rewriting child expression from type '{0}' to type '{1}' is not allowed, because it would change the meaning of the operation. If this is intentional, override '{2}' and change it to allow this rewrite." </summary>
        ...
        /// <summary> InvalidOperationException with message like "Rewritten expression calls operator method '{0}', but the original node had no operator method. If this is intentional, override '{1}' and change it to allow this rewrite." </summary>
        ...
        /// <summary> NotSupportedException with message like "TryExpression is not supported as an argument to method '{0}' because it has an argument with by-ref type. Construct the tree so the TryExpression is not nested inside of this expression." </summary>
        ...
        /// <summary> NotSupportedException with message like "TryExpression is not supported as a child expression when accessing a member on type '{0}' because it is a value type. Construct the tree so the TryExpression is not nested inside of this expression." </summary>
        ...
        /// <summary> ArgumentException with message like "Test value of type '{0}' cannot be used for the comparison method parameter of type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Switch value of type '{0}' cannot be used for the comparison method parameter of type '{1}'" </summary>
        ...
        /// <summary> NotSupportedException with message like "DebugInfoGenerator created by CreatePdbGenerator can only be used with LambdaExpression.CompileToMethod." </summary>
        ...
        /// <summary> ArgumentException with message like "The constructor should not be static" </summary>
        ...
        /// <summary> InvalidOperationException with message like "Can't compile a NewExpression with a constructor declared on an abstract class" </summary>
        ...
        /// <summary> InvalidProgramException with default message. </summary>
        internal static Exception InvalidProgram()
        {
            return new InvalidProgramException();
        }

        /// <summary> InvalidOperationException with message like "Enumeration has either not started or has already finished." </summary>
        internal static Exception EnumerationIsDone()
        {
            return new InvalidOperationException(Strings.EnumerationIsDone);
        }

        /// <summary> ArgumentException with message like "Type {0} contains generic parameters" </summary>
        ...
        /// <summary> ArgumentException with message like "Type {0} is a generic type definition" </summary>
        ...
        /// <summary> ArgumentException with message like "Incorrect number of arguments for constructor" </summary>
        internal static Exception IncorrectNumberOfConstructorArguments()
        {
            return new ArgumentException(Strings.IncorrectNumberOfConstructorArguments);
        }

        /// <summary> ArgumentException with message like "Expression of type '{0}' cannot be used for parameter of type '{1}' of method '{2}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Expression of type '{0}' cannot be used for parameter of type '{1}'" </summary>
        ...
        /// <summary> InvalidOperationException with message like "Incorrect number of arguments supplied for lambda invocation" </summary>
        ...
        /// <summary> ArgumentException with message like "Incorrect number of arguments supplied for call to method '{0}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Expression of type '{0}' cannot be used for constructor parameter of type '{1}'" </summary>
        ...
        /// <summary> ArgumentException with message like "Expression must be readable" </summary>
