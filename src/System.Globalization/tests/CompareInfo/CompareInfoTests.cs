...
namespace System.Globalization.Tests
{
    public class CompareInfoTests
    {
        ...
        public static IEnumerable<object[]> Compare_TestData()
        {
            ...
            // Hungarian
            yield return new object[] { s_hungarianCompare, "dzsdzs", "ddzs", CompareOptions.None, 0 };
        ...
        public void Compare_Issue5463()
        {
            ...
            Compare(s_invariantCompare, "FooBar", "Foo" + NextUnassignedUnicodeCharacter() + "Bar", CompareOptions.None, 0);
            Compare(s_invariantCompare, "FooBar", "Foo" + NextUnassignedUnicodeCharacter() + "Bar", CompareOptions.IgnoreNonSpace, 0);
        ...
        public static IEnumerable<object[]> IndexOf_LigatureÆ_TestData()
        {
        ...
        [Theory]
        [MemberData("IndexOf_LigatureÆ_TestData")]
        [ActiveIssue(5463, PlatformID.AnyUnix)]
        public void IndexOf_ligatureÆ(CompareInfo compareInfo, string source, string value, int startIndex, int count, CompareOptions options, int expected)
        {
        ...
        {
            IndexOf_String(s_invariantCompare, "FooBar", "Foo" + NextUnassignedUnicodeCharacter() + "Bar", 0, 6, CompareOptions.None, 0);
            IndexOf_String(s_invariantCompare, "~FooBar", "Foo" + NextUnassignedUnicodeCharacter() + "Bar", 0, 7, CompareOptions.IgnoreNonSpace, 1);
        }
        ...
        {
            IsPrefix(s_invariantCompare, "FooBar", "Foo" + NextUnassignedUnicodeCharacter() + "Bar", CompareOptions.None, true);
            IsPrefix(s_invariantCompare, "FooBar", "Foo" + NextUnassignedUnicodeCharacter() + "Bar", CompareOptions.IgnoreNonSpace, true);
        }
        ...
        {
            IsSuffix(s_invariantCompare, "FooBar", "Foo" + NextUnassignedUnicodeCharacter() + "Bar", CompareOptions.None, true);
            IsSuffix(s_invariantCompare, "FooBar", "Foo" + NextUnassignedUnicodeCharacter() + "Bar", CompareOptions.IgnoreNonSpace, true);
        }
        ...
        public static IEnumerable<object[]> LastIndexOf_LigatureÆ_TestData()
        {
            // Searches for the ligature Æ;
        ...
        [Theory]
        [MemberData("LastIndexOf_LigatureÆ_TestData")]
        [ActiveIssue(5463, PlatformID.AnyUnix)]
        public void LastIndexOf_LigatureÆ(CompareInfo compareInfo, string source, string value, int startIndex, int count, CompareOptions options, int expected)
        {
        ...
        {
            LastIndexOf_String(s_invariantCompare, "FooBar", "Foo" + NextUnassignedUnicodeCharacter() + "Bar", 5, 6, CompareOptions.None, 0);
            LastIndexOf_String(s_invariantCompare, "~FooBar", "Foo" + NextUnassignedUnicodeCharacter() + "Bar", 6, 7, CompareOptions.IgnoreNonSpace, 1);
        }
        ...
        private static char NextUnassignedUnicodeCharacter()
        {
            for (char ch = '\uFFFF'; ch > '\u0000'; ch++)
            {
