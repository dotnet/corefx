...
{
    public class CompareInfoLastIndexOf
    {
        ...
        [Fact]
        public void Test7() { Test(CultureInfo.InvariantCulture, "foo", "", 2, CompareOptions.None); }

        [Fact]
        public void Test8() { Test(CultureInfo.InvariantCulture, "", "", 0, CompareOptions.None); }

        [Fact]
        public void Test9() { Test(CultureInfo.InvariantCulture, new string('a', 5555) + new string('b', 100), "aaaaaaaaaaaaaaa", 5540, CompareOptions.None); }

        [Fact]
        public void Test10() { Test(CultureInfo.InvariantCulture, new string('b', 101) + new string('a', 5555), new string('a', 5000), 656, CompareOptions.None); }
        ...
        [Fact]
        public void Test36() { Test(CultureInfo.InvariantCulture, "cbabababdbaba", "ab", 10, CompareOptions.None); }
