...
namespace System.Globalization.Tests
{
    public class RegionInfoMiscTests
    {
        public static IEnumerable<object[]> RegionInfo_TestData()
        {
            ...
            yield return new object[] { 0x411, 122, "Japanese Yen", "Japanese Yen", "\u5186", "JPN", "JPN" };
            yield return new object[] { 0x804, 45, "Chinese Yuan", "PRC Yuan Renminbi", "\u4eba\u6c11\u5e01", "CHN", "CHN" };
            yield return new object[] { 0x401, 205, "Saudi Riyal", "Saudi Riyal", "\u0631\u064a\u0627\u0644\u00a0\u0633\u0639\u0648\u062f\u064a", "SAU", "SAU" };
            yield return new object[] { 0x412, 134, "South Korean Won", "Korean Won", "\uc6d0", "KOR", "KOR" };
            yield return new object[] { 0x40d, 117, "Israeli New Shekel", "Israeli New Shekel", "\u05e9\u05e7\u05dc\u0020\u05d7\u05d3\u05e9", "ISR", "ISR" };
        }
