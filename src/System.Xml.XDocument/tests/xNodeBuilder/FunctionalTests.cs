        ...
        public partial class XNodeBuilderTests : XLinqTestCase
        {
            ...
            public partial class TCCData : BridgeHelpers
            {
                ...
                public override void AddChildren()
                {
                    ...
                    this.AddChild(new TestVariation(CData_5) { Attribute = new VariationAttribute("WriteCData with ]]>") { Id = 5, Priority = 1 } });
            ...
            public partial class TCComment : BridgeHelpers
            {
                ...
                public override void AddChildren()
                {
                    ...
                    this.AddChild(new TestVariation(comment_6) { Attribute = new VariationAttribute("WriteComment with -- in value") { Id = 6, Priority = 1 } });
                }
            }
            ...
            public partial class TCPI : BridgeHelpers
            {
                ...
                public override void AddChildren()
                {
                    ...
                    this.AddChild(new TestVariation(pi_11) { Attribute = new VariationAttribute("Include PI end tag ?> as part of the text value") { Id = 11, Priority = 1 } });
