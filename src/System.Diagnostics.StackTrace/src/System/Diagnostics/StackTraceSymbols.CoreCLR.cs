...
namespace System.Diagnostics
{
    public class StackTraceSymbols : IDisposable
    {
            ...
            out string sourceFile, out int sourceLine, out int sourceColumn)
        {
            ...
            MetadataReader reader = GetReader(assemblyPath, loadedPeAddress, loadedPeSize, null, inMemoryPdbAddress, inMemoryPdbSize, null);
            if (reader != null)
            {
        ...
        /// </remarks>
        internal unsafe MetadataReader GetReader(string assemblyPath, IntPtr loadedPeAddress, int loadedPeSize, Stream peStream, 
            IntPtr inMemoryPdbAddress, int inMemoryPdbSize, Stream pdbStream)
        {
            ...
            openedReader = (inMemoryPdbAddress != IntPtr.Zero) ?
                TryOpenReaderForInMemoryPdb(inMemoryPdbAddress, inMemoryPdbSize, pdbStream) :
                TryOpenReaderFromAssemblyFile(assemblyPath, loadedPeAddress, loadedPeSize, peStream);
        ...
        private unsafe static OpenedReader TryOpenReaderForInMemoryPdb(IntPtr inMemoryPdbAddress, int inMemoryPdbSize, Stream pdbStream)
        {
            ...
            {
                signature = *(uint*)inMemoryPdbAddress;
            }

            if (inMemoryPdbSize < sizeof(uint) || signature != ManagedMetadataSignature)
            {
                // not a Portable PDB
                return null;
            }
        ...
        private static OpenedReader TryOpenReaderFromAssemblyFile(string assemblyPath, IntPtr loadedPeAddress, int loadedPeSize, Stream peStream)
        {
            Debug.Assert(assemblyPath != null || peStream != null);
