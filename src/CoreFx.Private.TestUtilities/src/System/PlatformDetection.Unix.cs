...
namespace System
{
    public static partial class PlatformDetection
    {
        ...
        /// <param name="major">The distro major version.  If omitted, compares the distro only.</param>
        /// <param name="minor">The distro minor version.  If omitted, compares the distro only.</param>
        /// <param name="build">The distro build version.  If omitted, compares the distro only.</param>
        /// <param name="revision">The distro revision version.  If omitted, compares the distro only.</param>
