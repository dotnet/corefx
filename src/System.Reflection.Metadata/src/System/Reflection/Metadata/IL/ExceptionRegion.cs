...
namespace System.Reflection.Metadata
{
    public readonly struct ExceptionRegion
    {
        ...
        /// <summary> IL offset of the start of the filter block, or -1 if the region is not a filter. </summary>
        public int FilterOffset
        {
            get { return (Kind == ExceptionRegionKind.Filter) ? _classTokenOrFilterOffset : -1; }
        }

        /// <summary> Returns a TypeRef, TypeDef, or TypeSpec handle if the region represents a catch, nil token otherwise. </summary>
