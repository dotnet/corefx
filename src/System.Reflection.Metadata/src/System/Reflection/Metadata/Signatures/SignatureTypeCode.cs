...
{
    /// <summary> Represents the type codes that are used in signature encoding. </summary>
    public enum SignatureTypeCode : byte
    {
        ...
        /// <summary> Represents <see cref="bool"/> in signatures. </summary>
        Boolean = CorElementType.ELEMENT_TYPE_BOOLEAN,

        /// <summary> Represents <see cref="char"/> in signatures. </summary>
        Char = CorElementType.ELEMENT_TYPE_CHAR,

        /// <summary> Represents <see cref="sbyte"/> in signatures. </summary>
        SByte = CorElementType.ELEMENT_TYPE_I1,

        /// <summary> Represents <see cref="byte"/> in signatures. </summary>
        Byte = CorElementType.ELEMENT_TYPE_U1,

        /// <summary> Represents <see cref="short"/> in signatures. </summary>
        Int16 = CorElementType.ELEMENT_TYPE_I2,

        /// <summary> Represents <see cref="ushort"/> in signatures. </summary>
        UInt16 = CorElementType.ELEMENT_TYPE_U2,

        /// <summary> Represents <see cref="int"/> in signatures. </summary>
        Int32 = CorElementType.ELEMENT_TYPE_I4,

        /// <summary> Represents <see cref="uint"/> in signatures. </summary>
        UInt32 = CorElementType.ELEMENT_TYPE_U4,

        /// <summary> Represents <see cref="long"/> in signatures. </summary>
        Int64 = CorElementType.ELEMENT_TYPE_I8,

        /// <summary> Represents <see cref="ulong"/> in signatures. </summary>
        UInt64 = CorElementType.ELEMENT_TYPE_U8,

        /// <summary> Represents <see cref="float"/> in signatures. </summary>
        Single = CorElementType.ELEMENT_TYPE_R4,

        /// <summary> Represents <see cref="double"/> in signatures. </summary>
        Double = CorElementType.ELEMENT_TYPE_R8,

        /// <summary> Represents <see cref="string"/> in signatures. </summary>
        ...
        /// <summary> Represents <see cref="object"/> </summary>
        Object = CorElementType.ELEMENT_TYPE_OBJECT,

        /// <summary> Represents a single dimensional <see cref="System.Array"/> with 0 lower bound. </summary>
