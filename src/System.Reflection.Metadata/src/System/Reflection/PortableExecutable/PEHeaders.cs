...
namespace System.Reflection.PortableExecutable
{
    ...
    public sealed class PEHeaders
    {
        ...
        private PEHeaders(Stream peStream, int? sizeOpt)
        {
            ...
            CalculateMetadataLocation(size, out this._metadataStartOffset, out this._metadataSize);
        }
        ...
        {
            get { return this._peHeader == null; }
        }
        ...
        {
            int numberOfSections = this._coffHeader.NumberOfSections;
