...
namespace System.Reflection
{
    ...
    public enum DeclarativeSecurityAction : short
    {
        ...
        /// <summary> Check that all callers in the call chain have been granted specified permission, </summary>
        Demand = 0x0002,
        ...
        /// <summary> Without further checks, refuse Demand for all permissions other than those specified. </summary>
        PermitOnly = 0x0005,
    ...
    /// <summary> Specifies all the hash algorithms used for hashing assembly files and for generating the strong name. </summary>
    ...
    public enum AssemblyFlags
    {
        ...
        /// <summary> Content type mask. Masked bits correspond to values of <see cref="System.Reflection.AssemblyContentType"/>. </summary>
