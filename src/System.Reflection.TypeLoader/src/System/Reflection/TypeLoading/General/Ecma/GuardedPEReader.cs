...
namespace System.Reflection.TypeLoading.Ecma
{
    ...
    // created by TypeLoader objects are sitting in the watch window after disposal.
    //
    ...
    internal readonly struct GuardedPEReader
    {
        ...
        public GuardedPEReader(TypeLoader loader, PEReader peReader, MetadataReader reader)
        {
