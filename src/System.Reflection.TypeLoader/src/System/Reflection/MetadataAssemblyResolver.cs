...
namespace System.Reflection
{
    ...
    {
        /// <summary>
        /// The binding algorithm. It should use TypeLoader.LoadFromStream(), LoadFromAssemblyPath()
        ...
        /// </summary>
        public abstract Assembly Resolve(TypeLoader context, AssemblyName assemblyName);
    }
}
