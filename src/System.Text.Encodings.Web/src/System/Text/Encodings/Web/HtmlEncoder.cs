...
{
    /// <summary> Represents a type used to do HTML encoding. </summary>
    public abstract class HtmlEncoder : TextEncoder
    {
        /// <summary> Returns a default built-in instance of <see cref="HtmlEncoder"/>. </summary>
        public static HtmlEncoder Default
        {
            get { return DefaultHtmlEncoder.Singleton; }
        }

        /// <summary> Creates a new instance of HtmlEncoder with provided settings. </summary>
        ...
        /// <summary> Creates a new instance of HtmlEncoder specifying character to be encoded. </summary>
