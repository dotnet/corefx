...
{
    /// <summary> Represents a filter which allows only certain Unicode code points through. </summary>
    public class TextEncoderSettings
    {
        ...
        /// <summary> Instantiates the filter by cloning the allow list of another <see cref="TextEncoderSettings"/>. </summary>
        ...
        /// <summary> Resets this settings object by disallowing all characters. </summary>
        ...
        /// <summary> Gets an enumeration of all allowed code points. </summary>
