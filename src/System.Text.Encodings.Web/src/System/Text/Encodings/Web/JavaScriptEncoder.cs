...
namespace System.Text.Encodings.Web
{
    ...
    public abstract class JavaScriptEncoder : TextEncoder
    {
        ...
        {
            get { return UnsafeRelaxedJavaScriptEncoder.Singleton; }
        }
    ...
    internal sealed class UnsafeRelaxedJavaScriptEncoder : JavaScriptEncoder
    {
        ...
        internal static readonly UnsafeRelaxedJavaScriptEncoder Singleton = new UnsafeRelaxedJavaScriptEncoder(new TextEncoderSettings(UnicodeRanges.All));

        public UnsafeRelaxedJavaScriptEncoder(TextEncoderSettings filter)
        {
            if (filter == null)
            {
                throw new ArgumentNullException(nameof(filter));
        ...
        public UnsafeRelaxedJavaScriptEncoder(params UnicodeRange[] allowedRanges) : this(new TextEncoderSettings(allowedRanges))
        { }
        ...
        static readonly char[] s_r = new char[] { '\\', 'r' };
        static readonly char[] s_back = new char[] { '\\', '\\' };
        static readonly char[] s_doubleQuote = new char[] { '\\', '"' };
        static readonly char[] s_singleQuote = new char[] { '\\', '\'' };
