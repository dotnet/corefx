...
{
    /// <summary> Represents a type used to do URL encoding. </summary>
    public abstract class UrlEncoder : TextEncoder
    {
        /// <summary> Returns a default built-in instance of <see cref="UrlEncoder"/>. </summary>
        public static UrlEncoder Default
        {
            get { return DefaultUrlEncoder.Singleton; }
        }

        /// <summary> Creates a new instance of UrlEncoder with provided settings. </summary>
        ...
        /// <summary> Creates a new instance of UrlEncoder specifying character to be encoded. </summary>
