...
namespace System.Net.NetworkInformation
{
    public abstract class NetworkInterface
    {
        ...
        /// <summary> Provides Internet Protocol (IP) statistical data for this network interface. </summary>
        ...
        /// <summary> Gets the speed of the interface in bits per second as reported by the interface. </summary>
        public virtual long Speed { get { throw NotImplemented.ByDesignWithMessage(SR.net_PropertyNotImplementedException); } }

        /// <summary> Gets a bool value that indicates whether the network interface is set to only receive data packets. </summary>
        public virtual bool IsReceiveOnly { get { throw NotImplemented.ByDesignWithMessage(SR.net_PropertyNotImplementedException); } }

        /// <summary> Gets a bool value that indicates whether this network interface is enabled to receive multicast packets. </summary>
        ...
        /// <summary> Gets the physical address of this network interface </summary>
