...
namespace System.Net.NetworkInformation
{
    ...
    public abstract class MulticastIPAddressInformation : IPAddressInformation
    {
        ...
        /// <summary> Gets a value that identifies the source of a unicast IP address prefix. </summary>
        public abstract PrefixOrigin PrefixOrigin { get; }

        /// <summary> Gets a value that identifies the source of a unicast IP address suffix. </summary>
