...
namespace System.Net.NetworkInformation
{
    ...
    public abstract class IPGlobalProperties
    {
        ...
        /// <summary> Gets the Active Udp Listeners on this machine. </summary>
        public abstract IPEndPoint[] GetActiveUdpListeners();

        /// <summary> Gets the Active Tcp Listeners on this machine. </summary>
        ...
        /// <summary> Gets a bool value that specifies whether the local computer is acting as a Windows Internet Name Service (WINS) proxy. </summary>
        ...
        /// <summary> Provides User Datagram Protocol (UDP) statistical data for the local computer. </summary>
        ...
        /// <summary> Provides Internet Protocol (IP) statistical data for the local computer. </summary>
        ...
        /// <summary> Returns a list of all unicast IP addresses after ensuring they are all stable. </summary>
