...
namespace System.Net.NetworkInformation
{
    ...
    /// <summary>
    /// A wrapper over LinuxIPInterfaceStatistics. Returns the exact same information.
    /// </summary>
    internal class LinuxIpv4InterfaceStatisticsWrapper : IPv4InterfaceStatistics
    {
        private LinuxIPInterfaceStatistics _statistics;

        public LinuxIpv4InterfaceStatisticsWrapper(string name)
        {
        ...
        public override long BytesReceived
        {
            get
            {
                return _statistics.BytesReceived;
            }
        }
        ...
        public override long IncomingPacketsDiscarded
        {
            get
            {
                return _statistics.IncomingPacketsDiscarded;
            }
        }
        ...
        public override long IncomingPacketsWithErrors
        {
            get
            {
                return _statistics.IncomingPacketsWithErrors;
            }
        }
        ...
        public override long IncomingUnknownProtocolPackets
        {
            get
            {
                return _statistics.IncomingUnknownProtocolPackets;
            }
        }
        ...
        public override long NonUnicastPacketsReceived
        {
            get
            {
                return _statistics.NonUnicastPacketsReceived;
            }
        }
        ...
        public override long NonUnicastPacketsSent
        {
            get
            {
                return _statistics.NonUnicastPacketsSent;
            }
        }
        ...
        public override long OutgoingPacketsDiscarded
        {
            get
            {
                return _statistics.OutgoingPacketsDiscarded;
            }
        }
        ...
        public override long OutgoingPacketsWithErrors
        {
            get
            {
                return _statistics.OutgoingPacketsWithErrors;
            }
        }
        ...
        public override long OutputQueueLength
        {
            get
            {
                return _statistics.OutputQueueLength;
            }
        }
        ...
        public override long UnicastPacketsReceived
        {
            get
            {
                return _statistics.UnicastPacketsReceived;
            }
        }
        ...
        public override long UnicastPacketsSent
        {
            get
            {
                return _statistics.UnicastPacketsSent;
            }
        }
    }
}