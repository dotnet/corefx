...
{
    /// <summary> Provides Internet Protocol (IP) statistical data for the local machine. </summary>
    public abstract class IPGlobalStatistics
    {
        /// <summary> Gets the default time-to-live (TTL) value for Internet Protocol (IP) packets. </summary>
        public abstract int DefaultTtl { get; }

        /// <summary> Gets a bool value that specifies whether Internet Protocol (IP) packet forwarding is enabled. </summary>
        ...
        /// <summary> Gets the number of routes in the routing table that have been discarded. </summary>
        ...
        /// <summary> Gets the number of Internet Protocol(IP) packets received and delivered. </summary>
