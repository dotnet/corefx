...
namespace System.Runtime.InteropServices.WindowsRuntime
{
    ...
    public static class AsyncInfo
    {
        ...
        /// <summary>
        /// Creates and starts an <see cref="T:Windows.Foundation.IAsyncActionWithProgress{TProgress}"/> instance from a function
        ...
        /// <returns>An unstarted <see cref="T:Windows.Foundation.IAsyncActionWithProgress{TProgress}"/> instance.</returns>
        ...
        /// <summary>
        /// Creates and starts  an <see cref="T:Windows.Foundation.IAsyncOperation{TResult}"/> instance from a function
        ...
        /// to be notified of a cancellation request;
        /// you may ignore the <code>CancellationToken</code> if your task does not support cancellation.</param>
        /// <returns>An unstarted <see cref="T:Windows.Foundation.IAsyncOperation{TResult}"/> instance.</returns>
        ...
        /// <summary>
        /// Creates and starts  an <see cref="T:Windows.Foundation.IAsyncOperationWithProgress{TResult,TProgress}"/> instance
        ...
        /// It is also passed a <see cref="System.IProgress{TProgress}"/> instance to which progress updates may be published;
        /// you may ignore the <code>IProgress</code> if your task does not support progress reporting.</param>
        /// <returns>An unstarted <see cref="T:Windows.Foundation.IAsyncOperationWithProgress{TResult,TProgress}"/> instance.</returns>
