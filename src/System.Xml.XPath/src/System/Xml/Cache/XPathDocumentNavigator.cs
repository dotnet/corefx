    ...
    internal sealed class XPathDocumentNavigator : XPathNavigator, IXmlLineInfo
    {
        ...
        public override string Value
        {
            get
            {
                ...
                value = this._pageCurrent[this._idxCurrent].Value;
                if (value != null)
                    return value;
                ...
                {
                    Debug.Assert(this._pageCurrent[this._idxCurrent].NodeType == XPathNodeType.Text);
                ...
                page = pageEnd = this._pageCurrent;
                idx = idxEnd = this._idxCurrent;
        ...
        {
            get { return this._pageCurrent[this._idxCurrent].NodeType; }
        }
        ...
        {
            get { return this._pageCurrent[this._idxCurrent].LocalName; }
        }
        ...
        {
            get { return this._pageCurrent[this._idxCurrent].NamespaceUri; }
        }
        ...
        {
            get { return this._pageCurrent[this._idxCurrent].Name; }
        }
        ...
        {
            get { return this._pageCurrent[this._idxCurrent].Prefix; }
        }
        ...
        public override string BaseURI
        {
            get
            {
                ...
                if (this._idxParent != 0)
                {
                    ...
                    page = this._pageParent;
                    idx = this._idxParent;
                }
                else
                {
                    page = this._pageCurrent;
                    idx = this._idxCurrent;
                }
        ...
        {
            get { return this._pageCurrent[this._idxCurrent].AllowShortcutTag; }
        }
        ...
        {
            get { return this._pageCurrent[this._idxCurrent].Document.NameTable; }
        }
        ...
        {
            XPathNode[] page = this._pageCurrent;
            int idx = this._idxCurrent;
        ...
        {
            get { return this._pageCurrent[this._idxCurrent].HasAttribute; }
        }
        ...
        public override bool MoveToAttribute(string localName, string namespaceURI)
        {
            ...
            if ((object)localName != (object)this._atomizedLocalName)
                this._atomizedLocalName = (localName != null) ? NameTable.Get(localName) : null;
        ...
        public override bool MoveToFirstNamespace(XPathNamespaceScope namespaceScope)
        {
            ...
            if (namespaceScope == XPathNamespaceScope.Local)
            {
                ...
                idx = XPathNodeHelper.GetLocalNamespaces(this._pageCurrent, this._idxCurrent, out page);
            }
            else
            {
                // Get all in-scope namespaces
                idx = XPathNodeHelper.GetInScopeNamespaces(this._pageCurrent, this._idxCurrent, out page);
            }
        ...
        {
            XPathNode[] page = this._pageCurrent, pageParent;
            int idx = this._idxCurrent, idxParent;
            ...
            while (true)
            {
                ...
                switch (scope)
                {
                    case XPathNamespaceScope.Local:
                        ...
                        if (idxParent != this._idxParent || (object)pageParent != (object)this._pageParent)
                            return false;
                        break;
        ...
        public override bool MoveToPrevious()
        {
            ...
            return XPathNodeHelper.GetPreviousContentSibling(ref this._pageCurrent, ref this._idxCurrent);
        }
        ...
        public override bool MoveToParent()
        {
            if (this._idxParent != 0)
            {
                ...
                Debug.Assert(this._pageParent != null);
        ...
        public override bool MoveTo(XPathNavigator other)
        {
            ...
            if (that != null)
            {
                this._pageCurrent = that._pageCurrent;
                this._idxCurrent = that._idxCurrent;
                this._pageParent = that._pageParent;
                this._idxParent = that._idxParent;
                return true;
            }
            return false;
        }
        ...
        public override bool MoveToId(string id)
        {
            ...
            idx = this._pageCurrent[this._idxCurrent].Document.LookupIdElement(id, out page);
            if (idx != 0)
            {
        ...
        public override bool IsSamePosition(XPathNavigator other)
        {
            ...
            if (that != null)
            {
                return this._idxCurrent == that._idxCurrent && this._pageCurrent == that._pageCurrent &&
                       this._idxParent == that._idxParent && this._pageParent == that._pageParent;
            }
            return false;
        }
        ...
        {
            get { return this._pageCurrent[this._idxCurrent].HasContentChild; }
        }
        ...
        public override bool MoveToFollowing(string localName, string namespaceURI, XPathNavigator end)
        {
            ...
            if (this._idxParent != 0)
            {
                if (!XPathNodeHelper.GetElementFollowing(ref this._pageParent, ref this._idxParent, pageEnd, idxEnd, this._atomizedLocalName, namespaceURI))
                    return false;
            ...
            return XPathNodeHelper.GetElementFollowing(ref this._pageCurrent, ref this._idxCurrent, pageEnd, idxEnd, this._atomizedLocalName, namespaceURI);
        }
        ...
        public override bool MoveToFollowing(XPathNodeType type, XPathNavigator end)
        {
            ...
            if (type == XPathNodeType.Text || type == XPathNodeType.All)
            {
                if (this._pageCurrent[this._idxCurrent].HasCollapsedText)
                {
                    ...
                    if (endTiny != null && this._idxCurrent == endTiny._idxParent && this._pageCurrent == endTiny._pageParent)
                    {
                ...
                if (type == XPathNodeType.Text)
                {
                    ...
                    if (page[idx].NodeType == XPathNodeType.Element)
                    {
                        ...
                        this._idxCurrent = page[idx].Document.GetCollapsedTextNode(out this._pageCurrent);
                        this._pageParent = page;
                        this._idxParent = idx;
                    }
                    else
            ...
            if (this._idxParent != 0)
            {
                if (!XPathNodeHelper.GetContentFollowing(ref this._pageParent, ref this._idxParent, pageEnd, idxEnd, type))
                    return false;
            ...
            return XPathNodeHelper.GetContentFollowing(ref this._pageCurrent, ref this._idxCurrent, pageEnd, idxEnd, type);
        }
        ...
        public override XmlNodeOrder ComparePosition(XPathNavigator other)
        {
            ...
            if (that != null)
            {
                XPathDocument thisDoc = this._pageCurrent[this._idxCurrent].Document;
        ...
        public override bool IsDescendant(XPathNavigator other)
        {
            ...
            if (that != null)
            {
                ...
                while (idxThat != 0)
                {
                    if (idxThat == this._idxCurrent && pageThat == this._pageCurrent)
                        return true;
        ...
        private int GetSecondaryLocation()
        {
            ...
            switch (this._pageCurrent[this._idxCurrent].NodeType)
            {
                case XPathNodeType.Namespace:
                    // Namespace nodes come first (make location negative, but greater than int.MinValue)
                    return int.MinValue + 1 + XPathNodeHelper.GetLocation(this._pageCurrent, this._idxCurrent);
        ...
        internal override string UniqueId
        {
            get
            {
                ...
                buf[idx++] = NodeTypeLetter[(int)this._pageCurrent[this._idxCurrent].NodeType];

                // If the current node is virtualized, code its parent
                if (this._idxParent != 0)
                {
                    loc = (this._pageParent[0].PageInfo.PageNumber - 1) << 16 | (this._idxParent - 1);
                    do
                    {
                ...
                loc = (this._pageCurrent[0].PageInfo.PageNumber - 1) << 16 | (this._idxCurrent - 1);
                do
                {
                    buf[idx++] = UniqueIdTbl[loc & 0x1f];
                    loc >>= 5;
        ...
        public int LineNumber
        {
            get
            {
                ...
                if (this._idxParent != 0 && NodeType == XPathNodeType.Text)
        ...
        public bool IsElementMatch(string localName, string namespaceURI)
        {
            ...
            return this._pageCurrent[this._idxCurrent].ElementMatch(this._atomizedLocalName, namespaceURI);
        }
        ...
        {
            return (((1 << (int)this._pageCurrent[this._idxCurrent].NodeType) & XPathNavigatorEx.GetKindMask(typ)) != 0);
        }
