...
namespace XPathTests.FunctionalTests.MiscellaneousCases
{
    ...
    {
        /// <summary>
        /// translate() cannot handle surrogate pair mapping correctly bug #108661
        /// translate() cannot handle surrogate pair mapping correctly bug #108661
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// translate() cannot handle surrogate pair mapping correctly bug #216439
        /// translate() cannot handle surrogate pair mapping correctly bug #216439 (won't fix)
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// //book[starts-with(@stype,'text')] bug#54065
        ...
        /// <summary>
        /// //book[starts-with(@stype,'glo')] bug#54065
        ...
        /// <summary>
        /// //book[starts-with(@stype,'')] bug#54065
        ...
        /// <summary>
        /// /child::MyComputer/descendant::UIntData/descendant::Value//@value bug#114730
        /// last()
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Execution of XPath expressions like that compare string to node-set with arithmetic operators in context of parent expression results in NRE. bug#349376
        /// Regression for 349376 NullReferenceException on expression
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Match() String functions inside predicate use wrong context node bug#364578
        /// Regression for 364578 Match() inside predicate uses wrong context node
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Expected: Line 1 == Line 3, Actual Line 1 == Line 2 (this test cases is Line1==Line2?) bug#371348
        /// Regression for 371348: count(/*[1]//node()[1]) = count(/*[1]/descendant::node()[1])
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Expected: Line 1 == Line 3, Actual Line 1 == Line 2 (this test cases is Line1==Line3?) bug#371348
        /// Regression for 371348: count(/*[1]//node()[1]) = count(/*//node()[1])
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Bug 411341 - Numeric operators are incorrectly treated as returning boolean
        /// Regression for 411341 - not(0+0)
        /// </summary>
        [Fact]
