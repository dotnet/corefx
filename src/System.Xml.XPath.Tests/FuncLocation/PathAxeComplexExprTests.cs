...
namespace XPathTests.FunctionalTests.Location.Paths.Axes
{
    ...
    public static partial class ComplexExpressionsTests
    {
        ...
        /// <summary>
        /// Regression for bug 62968. Checks for other axes with the same direction.
