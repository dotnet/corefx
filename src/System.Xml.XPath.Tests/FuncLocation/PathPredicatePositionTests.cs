...
namespace XPathTests.FunctionalTests.Location.Paths.Predicates
{
    ...
    public static partial class UsingPositionFunctionTests
    {
        ...
        /// <summary>
        /// Use position with a range of numbers. Selects all nodes. (bug #305957 fixed in Whidbey) In Old Xpath it is a bug that we convert the string ""Infinity"" to the realy infinity. XPath spec under Number function states that only number in string are converted back to number all other string should be converted to NaN.
