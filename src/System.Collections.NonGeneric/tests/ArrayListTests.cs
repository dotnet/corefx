    ...
    public static class ArrayListTests
    {
        ...
        public static void CopyTo_Int_Invalid()
        {
            ...
            Helpers.PerformActionOnAllArrayListWrappers(arrList1, arrList2 =>
            {
                ...
                Assert.Throws<ArgumentException>(Helpers.IsDesktopJob? null : "array", () => arrList2.CopyTo(new object[10, 10])); // Array is multidimensional
        ...
        public static void CopyTo_Int_Int_Invalid()
        {
            ...
            Helpers.PerformActionOnAllArrayListWrappers(arrList1, arrList2 =>
            {
                ...
                Assert.Throws<ArgumentException>(Helpers.IsDesktopJob ? null : "array", () => arrList2.CopyTo(0, new object[arrList2.Count, arrList2.Count], 0, arrList2.Count)); // Array is multidimensional
