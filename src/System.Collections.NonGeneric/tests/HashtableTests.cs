...
namespace System.Collections.Tests
{
    public static class HashtableTests
    {
        ...
        public static void Ctor_Int_Invalid()
        {
            ...
            Assert.Throws<ArgumentException>(Helpers.IsDesktopJob ? null : "capacity", () => new Hashtable(int.MaxValue)); // Capacity / load factor > int.MaxValue
        }
        ...
        public static void Ctor_Int_Int_Invalid()
        {
            ...
            Assert.Throws<ArgumentException>(Helpers.IsDesktopJob ? null : "capacity", () => new Hashtable(int.MaxValue, 0.1f)); // Capacity / load factor > int.MaxValue
        ...
        public static void Ctor_Int_IEqualityComparer_Invalid()
        {
            ...
            Assert.Throws<ArgumentException>(Helpers.IsDesktopJob ? null : "capacity", () => new Hashtable(int.MaxValue, null)); // Capacity / load factor > int.MaxValue
        }
        ...
        public static void Ctor_Capacity_LoadFactor_IEqualityComparer_Invalid()
        {
            ...
            Assert.Throws<ArgumentException>(Helpers.IsDesktopJob ? null : "capacity", () => new Hashtable(int.MaxValue, 0.1f, null)); // Capacity / load factor > int.MaxValue
