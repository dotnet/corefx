    ...
    public static class SortedListTests
    {
        ...
        public static void CopyTo_Invalid()
        {
            ...
            Helpers.PerformActionOnAllSortedListWrappers(sortList1, sortList2 =>
            {
                ...
                Assert.Throws<ArgumentException>(Helpers.IsDesktopJob ? null : "array", () => sortList2.CopyTo(new object[10, 10], 0)); // Array is multidimensional
        ...
        public static void GetKeyList_CopyTo_Invalid()
        {
            ...
            Helpers.PerformActionOnAllSortedListWrappers(sortList1, sortList2 =>
            {
                ...
                Assert.Throws<ArgumentException>(Helpers.IsDesktopJob ? null : "array", () => keys.CopyTo(new object[10, 10], 0)); // Array is multidimensional
        ...
        public static void GetValueList_CopyTo_Invalid()
        {
            ...
            Helpers.PerformActionOnAllSortedListWrappers(sortList1, sortList2 =>
            {
                ...
                Assert.Throws<ArgumentException>(Helpers.IsDesktopJob ? null : "array", () => values.CopyTo(new object[10, 10], 0)); // Array is multidimensional
