...
namespace System.IO.Pipelines
{
    ...
    public abstract partial class PipeReader
    {
        ...
        /// <summary> Attempt to synchronously read data the <see cref="PipeReader"/>. </summary>
        ...
        /// <summary> Returns a <see cref="Stream"/> that wraps the <see cref="PipeReader"/>. </summary>
        ...
        /// <summary> Cancel to currently pending or if none is pending next call to <see cref="ReadAsync"/>, without completing the <see cref="PipeReader"/>. </summary>
        public abstract void CancelPendingRead();

        /// <summary> Marks the <see cref="PipeReader"/> as being complete, meaning no more data will be read from it. </summary>
        ...
        /// <summary> Registers a callback that gets executed when the <see cref="PipeWriter"/> side of the pipe is completed </summary>
        ...
        /// <summary> Creates a <see cref="PipeReader"/> wrapping the specified <see cref="Stream"/>. </summary>
        ...
        /// <summary> Asynchronously reads the bytes from the <see cref="PipeReader"/> and writes them to the specified stream, using a specified buffer size and cancellation token. </summary>
