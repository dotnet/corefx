...
{
    /// <summary> Abstraction for running <see cref="PipeReader"/> and <see cref="PipeWriter"/> callbacks and continuations </summary>
    public abstract class PipeScheduler
    {
        ...
        /// <summary> The <see cref="PipeScheduler"/> implementation that queues callbacks to thread pool </summary>
        public static PipeScheduler ThreadPool => s_threadPoolScheduler;

        /// <summary> The <see cref="PipeScheduler"/> implementation that runs callbacks inline </summary>
