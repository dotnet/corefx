...
{
    /// <summary> Represents a set of options for controlling the creation of the <see cref="PipeWriter"/>. </summary>
    public class StreamPipeWriterOptions
    {
        ...
        /// <summary> Creates a new instance of <see cref="StreamPipeWriterOptions"/>. </summary>
        ...
        /// <summary> Leave underlying stream open after pipe writer completes. </summary>
