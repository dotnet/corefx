...
namespace System.Security.Cryptography.Encoding.Tests
{
    public class DerSequenceReaderTests
    {
        ...
        public static void FalseEncodedLength_MultiByteLength()
        {
            ...
            Assert.Throws<CryptographicException>(()=>DerSequenceReader.CreateForPayload(encodedMessage).ReadSequence());
        }
        ...
        public static void FalseEncodedLength_SingleByte()
        {
            ...
            Assert.Throws<CryptographicException>(() => DerSequenceReader.CreateForPayload(encodedMessage).ReadOid());
        }
    }
}
