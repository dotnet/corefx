...
namespace System.Text.RegularExpressions.Tests
{
    public class RegexParserTests
    {
        ...
        [InlineData(@"\p{cat}", RegexOptions.None, RegexParseError.UnknownProperty)]
        [InlineData(@"\P{", RegexOptions.None, RegexParseError.IncompleteSlashP)]
        [InlineData(@"\P{cat", RegexOptions.None, RegexParseError.IncompleteSlashP)]
        [InlineData(@"\P{cat}", RegexOptions.None, RegexParseError.UnknownProperty)]
        ...
        [InlineData("(?<", RegexOptions.None, RegexParseError.UnrecognizedGrouping)]
        [InlineData("(?<cat>", RegexOptions.None, RegexParseError.NotEnoughParens)]
        [InlineData("(?'", RegexOptions.None, RegexParseError.UnrecognizedGrouping)]
        [InlineData("(?'cat'", RegexOptions.None, RegexParseError.NotEnoughParens)]
        [InlineData("(?:", RegexOptions.None, RegexParseError.NotEnoughParens)]
        ...
        {
            Throws((RegexParseError)error, () => new Regex(pattern, options));
        }
        ...
        [InlineData(@"""(a)""", RegexOptions.None, null)]
        [InlineData(@"""(""", RegexOptions.None, RegexParseError.NotEnoughParens)]
        [InlineData(@"""(a""", RegexOptions.None, RegexParseError.NotEnoughParens)]
        [InlineData(@"""|""", RegexOptions.None, null)]
        [InlineData(@""" |""", RegexOptions.None, null)]
        [InlineData(@"""| """, RegexOptions.None, null)]
        [InlineData(@""" | """, RegexOptions.None, null)]
        ...
        [InlineData(@"""\\p{ Cc }""", RegexOptions.None, null)]
        [InlineData(@"""\\p{ Cc }""", RegexOptions.IgnorePatternWhitespace, null)]
        [InlineData(@"""\\p {Cc}""", RegexOptions.IgnorePatternWhitespace, null)]
        [InlineData(@"""\\p{xxx}""", RegexOptions.None, null)]
        [InlineData(@"""\\p""", RegexOptions.None, null)]
        [InlineData(@"""\\p{""", RegexOptions.None, null)]
        [InlineData(@"""\\p{}""", RegexOptions.None, null)]
        [InlineData(@"""\\p{} """, RegexOptions.None, null)]
        [InlineData(@"""\\p {} """, RegexOptions.None, null)]
        ...
        [InlineData(@"""(?:a)""", RegexOptions.None, null)]
        [InlineData(@"""(?:""", RegexOptions.None, RegexParseError.NotEnoughParens)]
        [InlineData(@"""(?: """, RegexOptions.IgnorePatternWhitespace, RegexParseError.NotEnoughParens)]
        [InlineData(@"""(?=)""", RegexOptions.None, null)]
        [InlineData(@"""(?=a)""", RegexOptions.None, null)]
        [InlineData(@"""(?=""", RegexOptions.None, RegexParseError.NotEnoughParens)]
        [InlineData(@"""(?= """, RegexOptions.IgnorePatternWhitespace, RegexParseError.NotEnoughParens)]
        ...
        [InlineData(@"""(?<>""", RegexOptions.IgnorePatternWhitespace, RegexParseError.InvalidGroupName)]
        [InlineData(@"""(?<a""", RegexOptions.IgnorePatternWhitespace, RegexParseError.InvalidGroupName)]
        [InlineData(@"""(?<a>""", RegexOptions.IgnorePatternWhitespace, RegexParseError.NotEnoughParens)]
        [InlineData(@"""(?<a>a""", RegexOptions.IgnorePatternWhitespace, RegexParseError.NotEnoughParens)]
        ...
        [InlineData(@"""(?<-0)""", RegexOptions.IgnorePatternWhitespace, RegexParseError.InvalidGroupName)]
        [InlineData(@"""(?<-0>""", RegexOptions.IgnorePatternWhitespace, RegexParseError.NotEnoughParens)]
        ...
        [InlineData(@"""(?<a-0)""", RegexOptions.IgnorePatternWhitespace, RegexParseError.InvalidGroupName)]
        [InlineData(@"""(?<a-0>""", RegexOptions.IgnorePatternWhitespace, RegexParseError.NotEnoughParens)]
        [InlineData(@"""(?<a-0>)""", RegexOptions.IgnorePatternWhitespace, null)]
        [InlineData(@"""(?<a-0 >)""", RegexOptions.IgnorePatternWhitespace, RegexParseError.InvalidGroupName)]
        [InlineData(@"""(?<a- 0 >)""", RegexOptions.IgnorePatternWhitespace, RegexParseError.InvalidGroupName)]
        [InlineData(@"""(?<a- 0>)""", RegexOptions.IgnorePatternWhitespace, RegexParseError.InvalidGroupName)]
        ...
        [InlineData(@"@""[\p{llll}-a] """, RegexOptions.None, RegexParseError.UnknownProperty)]
        ...
        [InlineData(@"@""[a-[:L:""", RegexOptions.None, RegexParseError.UnterminatedBracket)]
        [InlineData(@"@""[a-[:L:]""", RegexOptions.None, RegexParseError.SubtractionMustBeLast)]
        [InlineData(@"@""[\-]""", RegexOptions.None, null)]
        [InlineData(@"@""[a-b-c] """, RegexOptions.None, null)]
        ...
        [InlineData(@"@""((\w+(\s?)){2,}""", RegexOptions.None, RegexParseError.NotEnoughParens)]
        ...
        [InlineData(@"@""?(a|b)""", RegexOptions.None, null)]
        [InlineData(@"@""?((a)""", RegexOptions.None, RegexParseError.NotEnoughParens)]
        [InlineData(@"@""?((a)a""", RegexOptions.None, RegexParseError.NotEnoughParens)]
        [InlineData(@"@""?((a)a|""", RegexOptions.None, RegexParseError.NotEnoughParens)]
        [InlineData(@"@""?((a)a|b""", RegexOptions.None, RegexParseError.NotEnoughParens)]
        [InlineData(@"@""(?(?i))""", RegexOptions.None, RegexParseError.UnrecognizedGrouping)]
        [InlineData(@"@""?(a)""", RegexOptions.None, null)]
        [InlineData(@"@""(?(?I))""", RegexOptions.None, RegexParseError.UnrecognizedGrouping)]
        [InlineData(@"@""(?(?M))""", RegexOptions.None, RegexParseError.UnrecognizedGrouping)]
        ...
        [InlineData(@"@""(cat)(\c\|*)(dog)""", RegexOptions.None, RegexParseError.QuantifyAfterNothing)]
        [InlineData(@"@""^[abcd]{0,16}*$""", RegexOptions.None, RegexParseError.NestedQuantify)]
        [InlineData(@"@""(cat)\c""", RegexOptions.None, RegexParseError.UnrecognizedControl)]
        public void ParseWithSubTree(string stringText, RegexOptions options, object error)
        {
            Test(stringText, options, (RegexParseError?)error, runSubTreeTests: true);
        }
...
(((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((
(((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((
(((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((""", RegexOptions.None, RegexParseError.NotEnoughParens)]
        // Negative
        [InlineData(@"@""(cat)(\c\[*)(dog)""", RegexOptions.None, RegexParseError.UnterminatedBracket)]
        public void ParseWithoutSubTree(string stringText, RegexOptions options, object error)
        {
            Test(stringText, options, (RegexParseError?)error, runSubTreeTests: false);
        }
