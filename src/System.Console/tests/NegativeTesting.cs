...
{
    [ConditionalFact("System.PlatformDetection, CoreFx.Private.TestUtilities!" + nameof(PlatformDetection.IsWinRT))] // In appcontainer, the stream cannot be opened: there is no Console
