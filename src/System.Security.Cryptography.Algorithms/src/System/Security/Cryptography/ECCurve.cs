...
{
    /// <summary> An elliptic curve. </summary>
    /// <remarks>
    ...
    {
        /// <summary> Coefficient A. Applies only to Explicit curves. </summary>
        public byte[] A;

        /// <summary> Coefficient B. Applies only to Explicit curves. </summary>
        public byte[] B;

        /// <summary> Base Point. Applies only to Explicit curves. </summary>
        public ECPoint G;

        /// <summary> Order of the group generated by G = (x,y). Applies only to Explicit curves. </summary>
        public byte[] Order;

        /// <summary> Cofactor (optional). Applies only to Explicit curves. </summary>
        public byte[] Cofactor;

        /// <summary> Seed of the curve (optional). Applies only to Explicit curves. </summary>
        public byte[] Seed;

        /// <summary> Curve Type. </summary>
        public ECCurveType CurveType;

        /// <summary> The hash algorithm used to generate A and B from the Seed. Applies only to Explicit curves. </summary>
        public HashAlgorithmName? Hash;

        /// <summary> The binary polynomial. Applies only to Characteristic2 curves. </summary>
        ...
        private Oid _oid;
        /// <summary> The Oid representing the named curve. Applies only to Named curves. </summary>
        ...
        /// <summary> Create a curve without having to make a copy of the Oid </summary>
        ...
        /// <summary> Create a curve from the given cref="Oid". </summary>
        ...
        /// <summary> Create a curve from the given cref="Oid" friendly name. </summary>
        ...
        /// <summary> Create a curve from the given cref="Oid" value. </summary>
        ...
        /// <summary> Validate the current curve. </summary>
