...
public static class DataContractJsonSerializerTests
{
    ...
    {
        Assert.StrictEqual(SerializeAndDeserialize<DateTime>(new DateTime(2013, 1, 2), "\"\\/Date(1357113600000-0800)\\/\""), new DateTime(2013, 1, 2));
        Assert.StrictEqual(SerializeAndDeserialize<DateTime>(new DateTime(2013, 1, 2, 3, 4, 5, 6, DateTimeKind.Local), "\"\\/Date(1357124645006-0800)\\/\""), new DateTime(2013, 1, 2, 3, 4, 5, 6, DateTimeKind.Local));
        Assert.StrictEqual(SerializeAndDeserialize<DateTime>(new DateTime(2013, 1, 2, 3, 4, 5, 6, DateTimeKind.Unspecified), "\"\\/Date(1357124645006-0800)\\/\""), new DateTime(2013, 1, 2, 3, 4, 5, 6, DateTimeKind.Unspecified));
        ...
        Assert.StrictEqual(SerializeAndDeserialize<DateTime>(DateTime.MinValue.ToUniversalTime(), "\"\\/Date(-62135568000000)\\/\""), DateTime.MinValue.ToUniversalTime());
        SerializeAndDeserialize<DateTime>(DateTime.MaxValue.ToUniversalTime(), "\"\\/Date(253402300799999)\\/\"");
    }
    ...
    public static void DCJS_JaggedArrayAsRoot()
    {
        ...
        var actualObjectArray = SerializeAndDeserialize<object[]>(objectArray, "[1,1,1,\"string\",\"2054fd3e-e118-476a-9962-1a882be51860\",\"\\/Date(1357113600000-0800)\\/\"]");
        ...
        Assert.StrictEqual("/Date(1357113600000-0800)/", actualObjectArray[5].ToString());
    ...
    public static void DCJS_EnumerableCollection()
    {
        ...
        original.Add(new DateTime(2000, 1, 1));
        original.Add(new DateTime(2000, 1, 2));
        original.Add(new DateTime(2000, 1, 3));
        var actual = SerializeAndDeserialize<EnumerableCollection>(original, "[\"\\/Date(946713600000-0800)\\/\",\"\\/Date(946800000000-0800)\\/\",\"\\/Date(946886400000-0800)\\/\"]");
