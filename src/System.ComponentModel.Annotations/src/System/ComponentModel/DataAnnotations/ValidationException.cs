...
{
    /// <summary> Exception used for validation using <see cref="ValidationAttribute" />. </summary>
    [Serializable]
    ...
    public class ValidationException : Exception
    {
        ...
        /// <summary> Constructor that accepts a structured <see cref="ValidationResult" /> describing the problem. </summary>
        ...
        /// <summary> Constructor that accepts an error message, the failing attribute, and the invalid value. </summary>
        ...
        /// <summary> Constructor that accepts only a localized message </summary>
        /// <remarks>The long form of this constructor is preferred because it gives better error reporting.</remarks>
        ...
        /// <summary> Constructor that accepts a localized message and an inner exception </summary>
        /// <remarks>The long form of this constructor is preferred because it gives better error reporting</remarks>
        ...
        /// <summary> Constructor that takes a SerializationInfo. </summary>
        ...
        /// <summary> Gets the <see>ValidationAttribute</see> instance that triggered this exception. </summary>
        public ValidationAttribute ValidationAttribute { get; }

        /// <summary> Gets the <see cref="ValidationResult" /> instance that describes the validation error. </summary>
        /// <value>
