...
{
    /// <summary> Validation attribute to indicate that a property field or parameter is required. </summary>
    ...
    public class RequiredAttribute : ValidationAttribute
    {
        ...
        /// <summary> Gets or sets a flag indicating whether the attribute should allow empty strings. </summary>
