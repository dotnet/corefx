...
namespace System.ComponentModel.DataAnnotations.Schema
{
    ...
    {
        /// <summary> Initializes a new instance of the <see cref="DatabaseGeneratedAttribute" /> class. </summary>
        ...
        /// <summary> The pattern used to generate values for the property in the database. </summary>
