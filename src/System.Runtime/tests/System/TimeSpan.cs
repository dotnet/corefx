...
namespace System.Runtime.Tests
{
    public static class TimeSpanTests
    {
        ...
        [Theory, MemberData("Total_Days_Hours_Minutes_Seconds_Milliseconds_TestData")]
        ...
        public static void TestCompareTo(TimeSpan timeSpan1, object obj, int expected)
        {
            if (obj is TimeSpan)
            {
                ...
                Assert.Equal(expected, CompareHelper.NormalizeCompare(timeSpan1.CompareTo(timeSpan2)));
                Assert.Equal(expected, CompareHelper.NormalizeCompare(TimeSpan.Compare(timeSpan1, timeSpan2)));
        ...
        [Theory, MemberData("DurationTestData")]
        ...
        public static IEnumerable<object[]> FromDaysTestData()
        {
        ...
        [Theory, MemberData("FromDaysTestData")]
        ...
        public static IEnumerable<object[]> FromHoursTestData()
        {
        ...
        [Theory, MemberData("FromHoursTestData")]
        ...
        [Theory, MemberData("FromMinutesTestData")]
        ...
        public static IEnumerable<object[]> FromSecondsTestData()
        {
        ...
        [Theory, MemberData("FromSecondsTestData")]
        ...
        public static IEnumerable<object[]> FromMillisecondsTestData()
        {
        ...
        [Theory, MemberData("FromMillisecondsTestData")]
        ...
        public static IEnumerable<object[]> FromTicksTestData()
        {
        ...
        [Theory, MemberData("FromTicksTestData")]
