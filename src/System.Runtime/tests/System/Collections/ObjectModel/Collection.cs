...
namespace System.Collections.ObjectModel.Tests
{
    ...
    public class CollectionTests : CollectionTestBase
    {
        ...
        {
            Assert.Throws<ArgumentNullException>("list", () => new Collection<int>(null)); // List is null
        }
        ...
        public static void Indexer()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>("index", () => collection[-1]); // Index < 0
            Assert.Throws<ArgumentOutOfRangeException>("index", () => collection[s_intArray.Length]); // Index >= collection.Count
            Assert.Throws<ArgumentOutOfRangeException>("index", () => s_empty[0]); // Index >= collection.Count

            Assert.Throws<ArgumentOutOfRangeException>("index", () => collection[-1] = 0); // Index < 0
            Assert.Throws<ArgumentOutOfRangeException>("index", () => collection[s_intArray.Length] = 0); // Index >= collection.Count
        }
        ...
        public static void IndexerSetInvalidType()
        {
            ...
            Assert.Throws<ArgumentException>("value", () => ((IList)collection)[1] = "Two"); // Object type is not an int
        }
        ...
        {
            var collection = new ModifiableCollection<int>(s_intArray);
            Assert.Throws<ArgumentOutOfRangeException>("index", () => collection.Insert(-1, 0)); // Index < 0
            Assert.Throws<ArgumentOutOfRangeException>("index", () => collection.Insert(s_intArray.Length + 1, 0)); // Index > collection.Count
        }
        ...
        public static void CopyTo()
        {
            ...
            var intArray = new int[s_intArray.Length + targetIndex];

            Assert.Throws<ArgumentNullException>("dest", () => collection.CopyTo(null, 0)); // Array is null
            Assert.Throws<ArgumentException>(null, () => ((ICollection)collection).CopyTo(new int[s_intArray.Length, s_intArray.Length], 0)); // Array is multidimensional
            Assert.Throws<ArgumentOutOfRangeException>("dstIndex", () => collection.CopyTo(intArray, -1)); // Index < 0
            Assert.Throws<ArgumentException>("", () => collection.CopyTo(intArray, s_intArray.Length - 1)); // Index >= colection.Length - 1
            ...
            var objectArray = new object[s_intArray.Length + targetIndex];
        ...
        {
            VerifyRemoveAt(0, 1, new int[] { 1, 2, 3, 4, 5 });
            VerifyRemoveAt(3, 2, new int[] { 0, 1, 2, 5 });
            VerifyRemoveAt(4, 1, new int[] { 0, 1, 2, 3, 5 });
            VerifyRemoveAt(5, 1, new int[] { 0, 1, 2, 3, 4 });
        ...
        {
            var collection = new ModifiableCollection<int>(s_intSequence);
            Assert.Throws<ArgumentOutOfRangeException>("index", () => collection.RemoveAt(-1)); // Index < 0
            Assert.Throws<ArgumentOutOfRangeException>("index", () => collection.RemoveAt(s_intArray.Length)); // Index >= collection.Count
        }
