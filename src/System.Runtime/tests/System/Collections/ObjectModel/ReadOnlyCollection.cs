...
namespace System.Collections.ObjectModel.Tests
{
    ...
    public class ReadOnlyCollection : CollectionTestBase
    {
        ...
        {
            IList collection = new ReadOnlyCollection<int>(s_intArray);
        ...
        public static void CopyTo()
        {
            ...
            Assert.Throws<ArgumentException>("", () => collection.CopyTo(intArray, s_intArray.Length - 1)); // Index >= collection.Count - 1
