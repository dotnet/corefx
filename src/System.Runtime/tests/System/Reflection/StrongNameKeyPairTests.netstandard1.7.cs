...
namespace System.Reflection.Tests
{
    ...
    public class StrongNameKeyPairTests
    {
        ...
        [Fact]
        public void StrongNameKeyPairPosTest()
        {

            var m_sKeyPair = new StrongNameKeyPair(SNKeyPairDerived.s_data);
            Assert.True(m_sKeyPair != null);
        }
        ...
        public void StrongNameKeyPairNegTest()
        {
            ...
            Assert.Throws<PlatformNotSupportedException>(() => m_sKeyPair.PublicKey);
