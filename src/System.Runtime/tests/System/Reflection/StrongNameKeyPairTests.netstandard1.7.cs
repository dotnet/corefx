...
namespace System.Reflection.Tests
{
    ...
    public class StrongNameKeyPairTests
    {
        ...
        public void StrongNameKeyPairPosTest()
        {
            ...
            RunActionWithDataFileStream(fileStream => sKeyPair = new StrongNameKeyPair(fileStream));
        }
        ...
        private static void RunActionWithDataFileStream(Action<FileStream> action)
        {
            string filePath = Path.GetTempFileName();
            try
            {
                File.WriteAllBytes(filePath, s_data);
