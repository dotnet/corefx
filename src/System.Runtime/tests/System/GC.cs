...
namespace System.Runtime.Tests
{
    public static class GCTests
    {
        ...
        [Fact]
        public static void AddMemoryPressure_Invalid()
        {
        ...
        [Fact]
        public static void TestCollection_Int()
        {
        ...
        public static void TestCollect_Int_GCCollectionMode_Invalid()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>("Enum value was out of legal range.", () => GC.Collect(2, GCCollectionMode.Default - 1)); // Invalid collection mode
            Assert.Throws<ArgumentOutOfRangeException>("Enum value was out of legal range.", () => GC.Collect(2, GCCollectionMode.Optimized + 1)); // Invalid collection mode
        }
        ...
        public static void TestCollect_Int_GCCollectionMode_Bool_Invalid()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>("Enum value was out of legal range.", () => GC.Collect(2, GCCollectionMode.Default - 1, false)); // Invalid collection mode
            Assert.Throws<ArgumentOutOfRangeException>("Enum value was out of legal range.", () => GC.Collect(2, GCCollectionMode.Optimized + 1, false)); // Invalid collection mode
        }
        ...
        [Fact]
        public static void TestSurpressFinalizer_Invalid()
        {
