...
namespace System.Runtime.Tests
{
    public static class EnumTests
    {
        ...
        {
            Assert.Equal(expected, CompareHelper.NormalizeCompare(e.CompareTo(target)));
        }
        ...
        public static void TestFormat_Invalid()
        {
            ...
            Assert.Throws<FormatException>(() => Enum.Format(typeof(SimpleEnum), SimpleEnum.Red, "y")); // No such format
        }
        ...
        {
            Assert.Equal(expected, Enum.GetName(typeof(SimpleEnum), value));
        }
        ...
        [InlineData(typeof(SByteEnum), SimpleEnum.Red, "One")] // API doesnt't care if you pass in a completely different enum
        public static void TestGetNameNonIntegralTypes(Type enumType, object value, string expected)
        {
        ...
        [InlineData(typeof(SimpleEnum),
            ...
            new object[] { SimpleEnum.Red, SimpleEnum.Blue, SimpleEnum.Green, SimpleEnum.Green_a, SimpleEnum.Green_b, SimpleEnum.Yellow })]
