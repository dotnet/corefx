...
{
    /// <summary> A buffer into which the contents of an <see cref="IEnumerable{TElement}"/> can be stored. </summary>
    ...
    internal readonly struct Buffer<TElement>
    {
        ...
        /// <summary> The number of stored items. </summary>
        internal readonly int _count;

        /// <summary> Fully enumerates the provided enumerable and stores its items into an array. </summary>
