...
internal static partial class Interop
{
    internal static partial class Sys
    {
        ...
        private static extern int GetUnixVersion(sbyte[] version, ref int capacity);
        ...
        internal static string GetUnixVersion()
        {
            ...
            var version = new sbyte[capacity];
            ...
            Debug.Assert(Array.IndexOf(version, 0) != -1);
            unsafe
            {
