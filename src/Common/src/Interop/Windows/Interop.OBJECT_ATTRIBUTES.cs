...
internal static partial class Interop
{
    ...
    internal unsafe struct OBJECT_ATTRIBUTES
    {
        ...
        /// <summary> If null, object will receive default security settings. </summary>
        ...
        /// <summary> Equivalent of InitializeObjectAttributes macro with the exception that you can directly set SQOS. </summary>
    ...
    public enum ObjectAttributes : uint
    {
        ...
        /// <summary> Only a single handle can be open for this object. </summary>
        OBJ_EXCLUSIVE = 0x00000020,

        /// <summary> Lookups for this object should be case insensitive. </summary>
        OBJ_CASE_INSENSITIVE = 0x00000040,

        /// <summary> Create on existing object should open, not fail with STATUS_OBJECT_NAME_COLLISION. </summary>
        OBJ_OPENIF = 0x00000080,

        /// <summary> Open the symbolic link, not its target. </summary>
