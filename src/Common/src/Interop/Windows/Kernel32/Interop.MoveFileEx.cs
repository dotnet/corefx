...
internal partial class Interop
{
    internal partial class Kernel32
    {
        ...
        /// <summary> WARNING: This method does not implicitly handle long paths. Use MoveFile. </summary>
        ...
        /// <summary> Moves a file or directory, optionally overwriting existing destination file. NOTE: overwrite must be false for directories. </summary>
