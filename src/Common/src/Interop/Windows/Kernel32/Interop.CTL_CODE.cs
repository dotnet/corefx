...
internal partial class Interop
{
    ...
    {
        /// <summary> <a href="https://docs.microsoft.com/windows-hardware/drivers/kernel/defining-i-o-control-codes">CTL_CODE</a> method.</summary>
            ...
            byte access)
        {
            ...
            // See https://docs.microsoft.com/windows-hardware/drivers/develop/how-to-select-and-configure-the-device-fundamental-tests
            if (function > 4095)
