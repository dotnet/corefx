...
internal static partial class Interop
{
    private static class Libraries
    {
        ...
        internal const string ProcessEnviornment = "api-ms-win-core-processenvironment-l1-1-0.dll";
        internal const string ProcessThread = "api-ms-win-core-processthreads-l1-1-0.dll";
