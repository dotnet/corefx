...
namespace System.Security.Cryptography.Asn1
{
    ...
    internal partial struct PrivateKeyInfo
    {
        ...
        internal static PrivateKeyInfo Decode(ReadOnlyMemory<byte> encoded, AsnEncodingRules ruleSet)
        {
            return Decode(Asn1Tag.Sequence, encoded, ruleSet);
        }
        
        internal static PrivateKeyInfo Decode(Asn1Tag expectedTag, ReadOnlyMemory<byte> encoded, AsnEncodingRules ruleSet)
        {
            AsnReader reader = new AsnReader(encoded, ruleSet);
            
            Decode(reader, expectedTag, out PrivateKeyInfo decoded);
            reader.ThrowIfNotEmpty();
            return decoded;
        }

        internal static void Decode(AsnReader reader, out PrivateKeyInfo decoded)
        {
            if (reader == null)
        ...
        internal static void Decode(AsnReader reader, Asn1Tag expectedTag, out PrivateKeyInfo decoded)
        {
            if (reader == null)
                throw new ArgumentNullException(nameof(reader));
