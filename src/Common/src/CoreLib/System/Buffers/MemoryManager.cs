...
{
    /// <summary> Manager of <see cref="System.Memory{T}"/> that provides the implementation. </summary>
    public abstract class MemoryManager<T> : IMemoryOwner<T>, IPinnable
    {
        /// <summary> Returns a <see cref="System.Memory{T}"/>. </summary>
        public virtual Memory<T> Memory => new Memory<T>(this, GetSpan().Length);

        /// <summary> Returns a span wrapping the underlying memory. </summary>
        public abstract Span<T> GetSpan();

        /// <summary> Returns a handle to the memory that has been pinned and hence its address can be taken. </summary>
        ...
        /// <summary> Lets the garbage collector know that the object is free to be moved now. </summary>
        public abstract void Unpin();

        /// <summary> Returns a <see cref="System.Memory{T}"/> for the current <see cref="MemoryManager{T}"/>. </summary>
        ...
        /// <summary> Clean up of any leftover managed and unmanaged resources. </summary>
