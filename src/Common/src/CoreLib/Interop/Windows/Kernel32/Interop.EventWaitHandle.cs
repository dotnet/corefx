...
internal static partial class Interop
{
    internal static partial class Kernel32
    {
        ...
        [DllImport(Libraries.Kernel32, EntryPoint = "CreateEventExW", SetLastError = true, CharSet = CharSet.Unicode, BestFitMapping = false)]
        internal static extern SafeWaitHandle CreateEvent(ref SECURITY_ATTRIBUTES lpSecurityAttributes, string? name, uint flags, uint desiredAccess);
    }
}
