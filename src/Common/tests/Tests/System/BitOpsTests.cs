...
namespace Tests.System
{
    public static class BitOpsTests
    {
        ...
        [InlineData((uint)byte.MaxValue << 24 - 2, 24 - 2)]
        [InlineData((uint)ushort.MaxValue << 16, 16)]
        [InlineData((uint)ushort.MaxValue << 16 + 3, 16 + 3)]
        ...
        [InlineData(byte.MaxValue << 24 - 2, 24 - 2)]
        [InlineData(ushort.MaxValue << 16, 16)]
        [InlineData(ushort.MaxValue << 16 + 3, 16 + 3)]
