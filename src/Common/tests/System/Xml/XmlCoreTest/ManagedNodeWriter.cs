...
namespace XmlCoreTest.Common
{
    public class ManagedNodeWriter
    {
        ...
        /// <summary> Similar to the XmlWriter WriteDocType </summary>
        ...
        /// <summary> GetNodes returns the existing XML string thats been written so far. </summary>
        ...
        /// <summary> Finish allows user to complete xml file with the end element tags that were so far open. </summary>
        public void Finish()
        {
        ...
        /// <summary> AutoGenerated Text </summary>
        public void PutText()
        {
            _q.Append(TEXT + _tCount++);
        }

        /// <summary> Writing a Byte Array. </summary>
        ...
        /// <summary> Writes out CDATA Node. </summary>
        public void PutCData()
        {
            _q.Append("<![CDATA[" + CDATA + _cCount++ + "]]>");
        }

        /// <summary> Writes out a PI Node. </summary>
        public void PutPI()
        {
            _q.Append("<?" + PI + _pCount++ + "?>");
        }

        /// <summary> Writes out a Comment Node. </summary>
        public void PutComment()
        {
            _q.Append("<!--" + COMMENT + _mCount++ + " -->");
        }

        /// <summary> Writes out a single whitespace </summary>
