...
{
    public class RSAKeyExchangeFormatterTests
    {
        [Fact]
        public static void RSAOAEPFormatterArguments()
        {
            AsymmetricKeyExchangeFormatterTests.FormatterArguments(new RSAOAEPKeyExchangeFormatter());
        }

        [Fact]
        public static void RSAOAEPDeformatterArguments()
        {
            AsymmetricKeyExchangeFormatterTests.DeformatterArguments(new RSAOAEPKeyExchangeDeformatter());
        }

        [Fact]
        public static void RSAPKCS1FormatterArguments()
        {
            AsymmetricKeyExchangeFormatterTests.FormatterArguments(new RSAPKCS1KeyExchangeFormatter());
        }

        [Fact]
        public static void RSAPKCS1DeformatterArguments()
        {
            AsymmetricKeyExchangeFormatterTests.DeformatterArguments(new RSAPKCS1KeyExchangeDeformatter());
        }
        ...
        public static void VerifyDecryptKeyExchangeOaep()
        {
            using (RSA rsa = RSAFactory.Create(1024))
            {
                ...
                AsymmetricKeyExchangeFormatterTests.VerifyDecryptKeyExchange(formatter, deformatter);
            }
        }
