...
namespace System.CodeDom.Compiler
{
    public abstract class CodeGenerator : ICodeGenerator
    {
        ...
        public static bool IsValidLanguageIndependentIdentifier(string value) => IsValidTypeNameOrIdentifier(value, false);

        internal static bool IsValidLanguageIndependentTypeName(string value) => IsValidTypeNameOrIdentifier(value, true);
