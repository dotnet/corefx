    ...
    partial class ADStoreCtx : StoreCtx
    {
        ...
        { 
            ...
            try
            {
                ...
                Hashtable mappingTableByProp = (Hashtable)propertyMappingTableByProperty[this.MappingTableIndex];
        ...
        internal override void Load(Principal p, string principalPropertyName)
        {
            ...
            Hashtable propertyMappingTable = (Hashtable)propertyMappingTableByPropertyFull[this.MappingTableIndex];
        ...
        internal override void Load(Principal p)
        {
            ...
            Hashtable ldapMappingTable = (Hashtable)propertyMappingTableByLDAP[this.MappingTableIndex];
...
/************************/
        ...
        static Hashtable propertyMappingTableByProperty = null;
        static Hashtable propertyMappingTableByLDAP = null;
        protected static Dictionary<string,bool> NonPresentAttrDefaultStateMapping = null;
        static Hashtable propertyMappingTableByPropertyFull = null;
        
        protected static Dictionary<int, Dictionary<Type, StringCollection>> TypeToLdapPropListMap = null;

        class PropertyMappingTableEntry
        {
        ...
        const string SelfSddl  = "S-1-5-10";  // NT AUTHORITY\SELF
        const string WorldSddl = "S-1-1-0";   // EVERYONE
        static readonly Guid ChangePasswordGuid = new Guid("{ab721a53-1e2f-11d0-9819-00aa0040529b}");
        ...
        {   
            ...
            foreach (ActiveDirectoryAccessRule rule in adsSecurity.GetAccessRules(true, true, typeof(MACLPrinc.SecurityIdentifier)))
            {
                ...
                if (rule.ObjectType == ChangePasswordGuid)
                {
