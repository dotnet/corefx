...
namespace System.DirectoryServices.AccountManagement
{
    ...
    static class DefaultContextOptions
    {
    ...
    class PropertyNamesExternal
    {
        private PropertyNamesExternal() { }    
    
        static int AcctInfoPrefixLength = PropertyNames.AcctInfoPrefix.Length;
        static int PwdInfoPrefixLength = PropertyNames.PwdInfoPrefix.Length;
        ...
        {        
            ...
            {
                return "AuthenticablePrincipal" + propertyName.Substring(AcctInfoPrefixLength);
            }
            else if (propertyName.StartsWith(PropertyNames.PwdInfoPrefix, StringComparison.Ordinal))
            {
                return "AuthenticablePrincipal" + propertyName.Substring(PwdInfoPrefixLength);
            }
            else
            {
                return propertyName;
