...
#pragma warning restore 618
    ...
    public class AuthenticablePrincipal : Principal
    {
        ...
        // Enabled property
        bool enabled = false;          // the actual property value
        LoadState enabledChanged = LoadState.NotSet;   // change-tracking
        ...
        public Nullable<bool> Enabled
        {
            get 
            {
                ...
                return HandleGet<bool>(ref this.enabled, PropertyNames.AuthenticablePrincipalEnabled, ref enabledChanged);
            }
            ...
            set 
            {
                ...
                HandleSet<bool>(ref this.enabled, value.Value, ref this.enabledChanged, 
        ...
        List<string> certificateOriginalThumbprints = new List<string>();
        LoadState X509Certificate2CollectionLoaded = LoadState.NotSet;
        ...
        public X509Certificate2Collection Certificates
        {
            get
            {                
                return HandleGet<X509Certificate2Collection>(ref this.certificates,
                                    PropertyNames.AuthenticablePrincipalCertificates, ref X509Certificate2CollectionLoaded);
            }
        }
        ...
        static void CheckFindByArgs(PrincipalContext context, DateTime time, MatchType type, Type subtype)
        {
        ...
        internal override void LoadValueIntoProperty(string propertyName, object value)
        {
            switch (propertyName)
            {
                case PropertyNames.AuthenticablePrincipalCertificates:
                    ...
                    X509Certificate2CollectionLoaded = LoadState.Loaded;
                    break;
        ...
        internal override void ResetAllChangeStatus()
        {
            ...
            this.enabledChanged =  ( this.enabledChanged ==  LoadState.Changed ) ?  LoadState.Loaded : LoadState.NotSet;
        ...
        void LoadCertificateCollection(List<byte[]> certificatesToLoad)
        {
            // To support reload
            this.certificates.Clear();
            Debug.Assert(this.certificates.Count == 0);
            ...
            foreach (byte[] rawCert in certificatesToLoad)
            {
                try
                {
                    this.certificates.Import(rawCert);
                }
        ...
        void RefreshOriginalThumbprintList()
        {
            ...
            {
                this.certificateOriginalThumbprints.Add(certificate.Thumbprint);
            }
        }
        ...
        bool HasCertificateCollectionChanged()
        {
            ...
            if (this.certificates.Count != this.certificateOriginalThumbprints.Count)
            {
                GlobalDebug.WriteLineIf(
                            ...
                            this.certificateOriginalThumbprints.Count,
                            this.certificates.Count);
                return true;
            }

            // Make a copy of the thumbprint list, so we can alter the copy without effecting the original.
            List<string> remainingOriginalThumbprints = new List<string>(this.certificateOriginalThumbprints);
