    ...
    internal sealed partial class ExpressionBinder
    {
        ...
        */
        ...
        private bool GetStandardAndLiftedBinopSignatures(List<BinOpFullSig> rgbofs, BinOpArgInfo info)
        {
            ...
            for (ibos = 0; ibos < g_binopSignatures.Length; ibos++)
            {
                ...
                CType typeSig1 = GetPDT(bos.pt1);
                CType typeSig2 = GetPDT(bos.pt2);
        ...
        private ExprBinOp bindNullEqualityComparison(ExpressionKind ek, BinOpArgInfo info)
        {
            ...
            {
                CType typeBool = GetPDT(PredefinedType.PT_BOOL);
        ...
        */
        ...
        private ExprBinOp BindLiftedStandardBinOp(BinOpArgInfo info, BinOpFullSig bofs, ExpressionKind ek, EXPRFLAG flags)
        {
            ...
            {
                resultType = GetPDT(PredefinedType.PT_BOOL);
            }
            else
            {
        ...
        */
        private bool GetPtrBinOpSigs(List<BinOpFullSig> prgbofs, BinOpArgInfo info)
        {
            ...
            if (info.type1 is PointerType)
            {
                ...
                {
                    if (canConvert(info.arg2, typeT = GetPDT(s_rgptIntOp[i])))
                    {
            ...
            for (uint i = 0; i < s_rgptIntOp.Length; i++)
            {
                if (canConvert(info.arg1, typeT = GetPDT(s_rgptIntOp[i])))
                {
        ...
        */
        private bool GetRefEqualSigs(List<BinOpFullSig> prgbofs, BinOpArgInfo info)
        {
            ...
            CType typeObj = GetPDT(PredefinedType.PT_OBJECT);
            CType typeCls = null;
            ...
            CType typeDel = GetPDT(PredefinedType.PT_DELEGATE);
            ...
            if (type1.isInterfaceType() || type1.isPredefType(PredefinedType.PT_STRING) || GetSymbolLoader().HasBaseConversion(type1, typeDel))
                ...
                type1 = GetPDT(PredefinedType.PT_ARRAY);
            ...
            if (type2.isInterfaceType() || type2.isPredefType(PredefinedType.PT_STRING) || GetSymbolLoader().HasBaseConversion(type2, typeDel))
                ...
                type2 = GetPDT(PredefinedType.PT_ARRAY);
            ...
            for (int index = 0; index < g_rguos.Length; index++)
            {
                ...
                switch (cv)
                {
                    ...
                    case ConvKind.Explicit:
                        ...
                        if (canConvert(pArgument, typeSig = GetPDT(uos.pt)))
                        {
                            break;
                        }
        ...
        */
        ...
        private Expr BindIncOpCore(ExpressionKind ek, EXPRFLAG flags, Expr exprVal, CType type)
        {
            ...
            if (type.isEnumType() && type.fundType() > FUNDTYPE.FT_LASTINTEGRAL)
            {
                ...
                type = GetPDT(PredefinedType.PT_INT);
            }
            ...
            switch (ft)
            {
                ...
                case FUNDTYPE.FT_PTR:
                    cv = ConstVal.Get(1);
                    pExprResult = BindPtrBinOp(ek, flags, exprVal, GetExprFactory().CreateConstant(GetPDT(PredefinedType.PT_INT), cv));
                    break;
                case FUNDTYPE.FT_I1:
                case FUNDTYPE.FT_I2:
                case FUNDTYPE.FT_U1:
                case FUNDTYPE.FT_U2:
                    typeTmp = GetPDT(PredefinedType.PT_INT);
                    cv = ConstVal.Get(1);
        ...
        */
        private ExprBinOp BindDecBinOp(ExpressionKind ek, EXPRFLAG flags, Expr arg1, Expr arg2)
        {
            ...
            CType typeDec = GetPDT(PredefinedType.PT_DECIMAL);
            ...
            switch (ek)
            {
                ...
                case ExpressionKind.NotEq:
                    typeRet = GetPDT(PredefinedType.PT_BOOL);
                    break;
            }
        ...
        */
        private ExprBinOp BindBoolBinOp(ExpressionKind ek, EXPRFLAG flags, Expr arg1, Expr arg2)
        {
            ...
            return GetExprFactory().CreateBinop(ek, GetPDT(PredefinedType.PT_BOOL), arg1, arg2);
        }
        ...
        */
        private ExprBinOp BindStrCmpOp(ExpressionKind ek, EXPRFLAG flags, Expr arg1, Expr arg2)
        {
            ...
            return CreateBinopForPredefMethodCall(ek, predefMeth, GetPDT(PredefinedType.PT_BOOL), arg1, arg2);
        }
        ...
        */
        private ExprBinOp BindRefCmpOp(ExpressionKind ek, EXPRFLAG flags, Expr arg1, Expr arg2)
        {
            ...
            arg1 = mustConvert(arg1, GetPDT(PredefinedType.PT_OBJECT), CONVERTTYPE.NOUDC);
            arg2 = mustConvert(arg2, GetPDT(PredefinedType.PT_OBJECT), CONVERTTYPE.NOUDC);
        ...
        private Expr BindDelBinOp(ExpressionKind ek, EXPRFLAG flags, Expr arg1, Expr arg2)
        {
            ...
            switch (ek)
            {
                ...
                case ExpressionKind.Eq:
                    ...
                    RetType = GetPDT(PredefinedType.PT_BOOL);
        ...
        */
        ...
        private Expr BindLiftedEnumArithmeticBinOp(ExpressionKind ek, EXPRFLAG flags, Expr arg1, Expr arg2)
        {
            ...
            NullableType typeOp = GetTypes().GetNullable(GetPDT(ptOp));
            arg1 = mustCast(arg1, typeOp, CONVERTTYPE.NOUDC);
            arg2 = mustCast(arg2, typeOp, CONVERTTYPE.NOUDC);
        ...
        */
        private ExprOperator BindIntOp(ExpressionKind kind, EXPRFLAG flags, Expr op1, Expr op2, PredefinedType ptOp)
        {
            ...
            CType typeDest = kind.IsRelational() ? GetPDT(PredefinedType.PT_BOOL) : typeOp;
        ...
        private ExprOperator BindIntegerNeg(EXPRFLAG flags, Expr op, PredefinedType ptOp)
        {
            ...
            {
                ExprClass exprObj = GetExprFactory().CreateClass(GetPDT(PredefinedType.PT_LONG));
        ...
        private ExprOperator bindFloatOp(ExpressionKind kind, EXPRFLAG flags, Expr op1, Expr op2)
        {
            ...
            CType typeDest = kind.IsRelational() ? GetPDT(PredefinedType.PT_BOOL) : op1.Type;
        ...
        private Expr BindUserBoolOp(ExpressionKind kind, ExprCall pCall)
        {
            ...
            pCallT = mustConvert(pCallT, GetPDT(PredefinedType.PT_BOOL));
            pCallF = mustConvert(pCallF, GetPDT(PredefinedType.PT_BOOL));
        ...
        private AggregateType GetEnumBinOpType(ExpressionKind ek, CType argType1, CType argType2, out AggregateType ppEnumType)
        {
            ...
            switch (ek)
            {
                ...
                default:
                    ...
                    typeDst = GetPDT(PredefinedType.PT_BOOL);
                    break;
            }
