...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    internal sealed class ExpressionTreeRewriter : ExprVisitorBase
    {
        ...
        protected override Expr VisitBOUNDLAMBDA(ExprBoundLambda anonmeth)
        {
            ...
            AggregateType expressionType = GetSymbolLoader().GetPredefType(PredefinedType.PT_EXPRESSION);
        ...
        protected override Expr VisitCONCAT(ExprConcat expr)
        {
            ...
            Expr methodInfo = GetExprFactory().CreateMethodInfo(method, GetSymbolLoader().GetPredefType(PredefinedType.PT_STRING), null);
        ...
        {
            GetSymbolLoader().GetPredefType(PredefinedType.PT_STRING);  // force an ensure state
        ...
        private Expr GenerateDelegateConstructor(ExprCall expr)
        {
            ...
            AggregateType delegateType = GetSymbolLoader().GetPredefType(PredefinedType.PT_DELEGATE);
        ...
        {
            CType intType = symbolLoader.GetPredefType(PredefinedType.PT_INT);
        ...
        private Expr GenerateConstant(Expr expr)
        {
            ...
            AggregateType pObject = GetSymbolLoader().GetPredefType(PredefinedType.PT_OBJECT);
            ...
            AggregateType stringType = GetSymbolLoader().GetPredefType(PredefinedType.PT_STRING);
        ...
        private ExprArrayInit GenerateParamsArray(Expr args, PredefinedType pt)
        {
            ...
            AggregateType paramsArrayElementType = GetSymbolLoader().GetPredefType(pt);
