...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    ...
    internal partial class ExpressionBinder
    {
        ...
        {
            Debug.Assert(grp.sk == SymbolKind.SK_MethodSymbol || grp.sk == SymbolKind.SK_PropertySymbol && ((grp.flags & EXPRFLAG.EXF_INDEXER) != 0));
            ...
            if (grp.sk == SymbolKind.SK_PropertySymbol)
            {
