    ...
    internal sealed class TypeManager
    {
        ...
        public PointerType GetPointer(CType baseType)
        {
            ...
            if (pPointer == null)
            {
                ...
                Name namePtr = _BSymmgr.GetNameManager().GetPredefinedName(PredefinedName.PN_PTR);
        ...
        public NullableType GetNullable(CType pUnderlyingType)
        {
            ...
            {
                Name pName = _BSymmgr.GetNameManager().GetPredefinedName(PredefinedName.PN_NUB);
        ...
        {
            Name name = _BSymmgr.GetNameManager().GetPredefinedName(isOut ? PredefinedName.PN_OUTPARAM : PredefinedName.PN_REFPARAM);
