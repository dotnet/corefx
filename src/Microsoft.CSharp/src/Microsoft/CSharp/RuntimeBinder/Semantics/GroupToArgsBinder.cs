...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    ...
    internal partial class ExpressionBinder
    {
        internal class GroupToArgsBinder
        {
            ...
            {
                Debug.Assert(_pGroup.sk == SymbolKind.SK_MethodSymbol || _pGroup.sk == SymbolKind.SK_PropertySymbol && 0 != (_pGroup.flags & EXPRFLAG.EXF_INDEXER));
            ...
            private void ReportErrorsOnSuccess()
            {
                ...
                Debug.Assert(_pGroup.sk == SymbolKind.SK_MethodSymbol || _pGroup.sk == SymbolKind.SK_PropertySymbol && 0 != (_pGroup.flags & EXPRFLAG.EXF_INDEXER));
                Debug.Assert(_pGroup.typeArgs.size == 0 || _pGroup.sk == SymbolKind.SK_MethodSymbol);
                ...
                if (_pGroup.sk == SymbolKind.SK_MethodSymbol)
                {
