...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    ...
    internal partial class CMemberLookupResults
    {
        ...
        public CMethodIterator GetMethodIterator(
            CSemanticChecker pChecker, SymbolLoader pSymLoader, CType pObject, CType pQualifyingType, Declaration pContext, bool allowBogusAndInaccessible, bool allowExtensionMethods, int arity, EXPRFLAG flags, SymbolMask mask)
        {
