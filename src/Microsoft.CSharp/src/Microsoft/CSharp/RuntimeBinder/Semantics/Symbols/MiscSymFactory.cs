...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    internal class MiscSymFactory : SymFactoryBase
    {
        ...
        {
            Scope sym = newBasicSym(SymbolKind.SK_Scope, null, parent).AsScope();
            if (parent != null)
            {
        ...
        {
            IndexerSymbol sym = (IndexerSymbol)newBasicSym(SymbolKind.SK_IndexerSymbol, name, parent);
            sym.setKind(SymbolKind.SK_PropertySymbol);
            sym.isOperator = true;
