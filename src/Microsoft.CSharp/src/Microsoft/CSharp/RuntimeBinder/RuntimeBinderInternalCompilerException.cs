...
namespace Microsoft.CSharp.RuntimeBinder
{
    ...
    {
        /// <summary> Initializes a new instance of the <see cref="RuntimeBinderInternalCompilerException"/> class. </summary>
        public RuntimeBinderInternalCompilerException()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RuntimeBinderInternalCompilerException"/> class with a specified error message. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="RuntimeBinderInternalCompilerException"/> class with serialized data. </summary>
