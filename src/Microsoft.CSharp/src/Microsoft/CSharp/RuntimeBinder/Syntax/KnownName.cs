...
namespace Microsoft.CSharp.RuntimeBinder.Syntax
{
    ...
    {
        private static readonly Name[] s_predefinedNames = new Name[(int)PredefinedName.PN_COUNT] {
            new Name(".ctor"),
            new Name("Finalize"),
            new Name(".cctor"),
            new Name("*"),
        ...
        private static readonly Name[] s_otherNames = {
            new Name("true"),
            new Name("false"),
            new Name("null"),
            new Name("base"),
        ...
        private static NameTable GetKnownNames()
        {
            ...
            // add all other names
            foreach (Name name in s_otherNames)
            {
                table.Add(name);
            }
