...
namespace System.Globalization.CalendarsTests
{
    ...
    public class KoreanCalendarGetMonthsInYear
    {
        ...
        public void GetMonthsInYear_Invalid()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() => new KoreanCalendar().GetMonthsInYear(1, 1));
            Assert.Throws<ArgumentOutOfRangeException>(() => new KoreanCalendar().GetMonthsInYear(-1, 1));
            Assert.Throws<ArgumentOutOfRangeException>(() => new KoreanCalendar().GetMonthsInYear(2333, 1));
            Assert.Throws<ArgumentOutOfRangeException>(() => new KoreanCalendar().GetMonthsInYear(12333, 1));
            
            // Era is outside supported range
            Assert.Throws<ArgumentOutOfRangeException>(() => new KoreanCalendar().GetMonthsInYear(2334, -1));
            Assert.Throws<ArgumentOutOfRangeException>(() => new KoreanCalendar().GetMonthsInYear(2334, 2));
        }
    }
}
