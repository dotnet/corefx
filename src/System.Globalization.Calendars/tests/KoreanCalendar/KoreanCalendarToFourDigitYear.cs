...
namespace System.Globalization.CalendarsTests
{
    ...
    public class KoreanCalendarToFourDigitYear
    {
        ...
        public void ToFourDigitYear_Invalid()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() => new KoreanCalendar().ToFourDigitYear(-1));
            Assert.Throws<ArgumentOutOfRangeException>(() => new KoreanCalendar().ToFourDigitYear(100));
            Assert.Throws<ArgumentOutOfRangeException>(() => new KoreanCalendar().ToFourDigitYear(12333));
        }
    }
}
