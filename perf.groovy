		...
		['Windows_NT'].each { os ->
			...
			def newJob = job(Utilities.getFullJobName(project, newJobName, isPR)) {
				...
				steps {
					...
					batchFile("python C:\\tools\\Microsoft.BenchView.JSONFormat.0.1.0-pre015\\tools\\submission-metadata.py --name " + commitName + " --user " + user + " -o C:\\submission-metadata.json")
