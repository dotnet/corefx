...
__UbuntuPackages="build-essential libunwind8-dev gettext symlinks liblttng-ust-dev libicu-dev zlib1g-dev libssl-dev libcurl4-openssl-dev libz-dev libcrypto++-dev"
...
for i in "$@"
    do
        ...
        __UbuntuArch=armhf
        __UbuntuRepo="http://ports.ubuntu.com/"
        __UbuntuPackages="$__UbuntuPackages lldb-3.6-dev"
        __MachineTriple=arm-linux-gnueabihf
        ;;
        arm64)
        __BuildArch=arm64
