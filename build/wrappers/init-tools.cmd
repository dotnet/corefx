...
set REPO_ROOT=%~dp0..\..\
set INIT_TOOLS_LOG=%REPO_ROOT%init-tools.log
if [%PACKAGES_DIR%]==[] set PACKAGES_DIR=%REPO_ROOT%packages\
if [%TOOLRUNTIME_DIR%]==[] set TOOLRUNTIME_DIR=%REPO_ROOT%Tools
set DOTNET_PATH=%TOOLRUNTIME_DIR%\dotnetcli\
if [%DOTNET_CMD%]==[] set DOTNET_CMD=%DOTNET_PATH%dotnet.exe
if [%BUILDTOOLS_SOURCE%]==[] set BUILDTOOLS_SOURCE=https://dotnet.myget.org/F/dotnet-buildtools/api/v3/index.json
set /P BUILDTOOLS_VERSION=< "%REPO_ROOT%build\config\BuildToolsVersion.txt"
