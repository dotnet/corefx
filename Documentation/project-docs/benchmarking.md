...
Make sure to download the .NET Core 2.1 SDK zip archive (https://github.com/dotnet/cli/blob/master/README.md#installers-and-binaries) and extract it somewhere locally, e.g.: `C:\dotnet-nightly\`.
