...
| DNX on .NET Core 5.0 (Executable) | dnxcore50  | netstandardapp1.5 &rarr; netcoreapp1.0 |
| DNX on .NET Core 5.0 (Portable Library) | dnxcore50  | dotnet &rarr; dotnet5.4 &rarr; netstandard1.3 |
