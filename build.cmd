...
:build
%_buildprefix% %_msbuildexe% "%~dp0build.proj" /nologo /maxcpucount /verbosity:minimal /nodeReuse:false /fileloggerparameters:Verbosity=diag;LogFile="%~dp0msbuild.log";Append /p:SkipTestAssemblies="System.Threading.Tasks.Dataflow.Tests" %* %_buildpostfix%
goto :eof